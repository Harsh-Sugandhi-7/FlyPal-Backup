<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfComplyCompMonitorServiceStatusListShowValues_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfComplyCompMonitorServiceStatusListShowValues_Ajax" %>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="btnAddNewTop" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                                            Text="Add New" ToolTip="Click to Add Service" ValidationGroup="1" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnPrintTop" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                                            Visible="false" TabIndex="0" Text="Print" ToolTip="Click to print List of Component Service" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnBackTop" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                                            TabIndex="0" Text="Close" ToolTip="Click to close List of Component Service Status screen" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ContentTemplate>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:GridView ID="dgDueMonitoringList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                    DataKeyNames="ID" PageSize="5" ShowHeaderWhenEmpty="true" CssClass="clsGrid">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="PartMonitorServiceCode_Desc" HeaderText="Code/Form No./Description"
                                                                            SortExpression="PartMonitorServiceCode_Desc" HtmlEncode="false">
                                                                            <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                        </asp:BoundField>
