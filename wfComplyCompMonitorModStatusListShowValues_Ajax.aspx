<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfComplyCompMonitorModStatusListShowValues_Ajax.aspx.vb"
    Inherits="Flypal.wfComplyCompMonitorModStatusListShowValues_Ajax" %>
...
<head id="Head1" runat="server">
    ...
    <title>Component Mod Status List</title>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="cmbMonitorType" runat="server" CssClass="clsComboBox3_Ajax"
                                                                        DataTextField="PartMonitorModTypeName" DataValueField="ID" Width="250px">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td>
                                                                </td>
                                                        ...
                                                        <asp:UpdatePanel ID="upnlFindNow" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:Button ID="btnFindNow" TabIndex="0" runat="server" CssClass="clsButton_Ajax"
                                                                    ToolTip="Click to find list of Mod as per searching criteria" Text="Find Now"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="btnAddNewTop" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                                            Text="Add New" ToolTip="Click to Add Mod" ValidationGroup="1" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnPrintTop" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                                            Visible="false" TabIndex="0" Text="Print" ToolTip="Click to print List of Component Mod" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnBackTop" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                                            TabIndex="0" Text="Close" ToolTip="Click to close List of Component Mod Status screen" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ContentTemplate>
                                                                    ...
                                                                    <ContentTemplate>
                                                                        <asp:GridView ID="dgDueMonitoringList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="PartMonitorModCode_Desc" HeaderText="Code/Form No./Description"
                                                                                    SortExpression="PartMonitorModCode_Desc" HtmlEncode="false">
                                                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                                </asp:BoundField>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnAddNew" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                        ValidationGroup="1" Text="Add New" ToolTip="Click to Add Mod" />
                                                </td>
                                                <td>
