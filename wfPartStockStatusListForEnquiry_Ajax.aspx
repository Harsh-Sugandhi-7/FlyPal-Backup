<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfPartStockStatusListForEnquiry_Ajax.aspx.vb"
    Inherits="Flypal.wfPartStockStatusListForEnquiry_Ajax" %>
                                ...
                                <asp:UpdatePanel ID="upnlDetails" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <asp:GridView ID="dgPartStockStatusList" runat="server" CssClass="clsGridNewStyle" GridLines="Horizontal" CellPadding="5" PageSize="25"
