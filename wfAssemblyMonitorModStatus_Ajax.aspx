<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAssemblyMonitorModStatus_Ajax.aspx.vb"
	Inherits="Flypal.wfAssemblyMonitorModStatus_Ajax" %>
									...
									<fieldset id="fdsMonitoringDetails" class="clsFieldSet" style="border-width: 1px;">
										...
										<table width="100%">
											...
											<tr>
												...
												<td>
													<asp:TextBox ID="txtModNumber" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Directive No."
														Text="<%# mAssemblyMonitorModStatus.ModelMonitorMod.Number %>" ReadOnly="True"
														BackColor="#E0E0E0">
													</asp:TextBox>
												</td>
											</tr>
											...
											<fieldset id="fdsDoneOnDetails" class="clsFieldSet" style="border-width: 1px;">
												...
												<table width="100%">
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtWorkOrdNo" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Work Order Number"
																Text="<%# mAssemblyMonitorModStatus.DoneWONo %>" MaxLength="100">
															</asp:TextBox>
														</td>
													</tr>
													<tr>
																		...
																		<tr>
																			<td>
																				...
																				<cc2:AutoCompleteExtender ClientIDMode="Static" ID="txtLicenceNo_Autocomplete" runat="server"
																					...
																					CompletionInterval="1" ServicePath="wfAssemblyMonitorModStatus_Ajax.aspx" ServiceMethod="GetLicenseNoList"
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtRequiredManHours" runat="server" CssClass="clsTextBoxSmall_Ajax"
																Text="<%# mAssemblyMonitorModStatus.TotalReqManHrs1 %>" Enabled="<%# mAssemblyMonitorModStatus.MaintenanceDoneByEmployees.Count <= 1 %>"
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" Width="250px"
																ToolTip="Enter Remark" Text="<%# mAssemblyMonitorModStatus.DoneRemark %>"
																ReadOnly="<%# mAssemblyMonitorModStatus.ModelMonitorMod.ID.Equals(Guid.Empty) %>"
																TextMode="MultiLine">
															</asp:TextBox>
														</td>
													</tr>
										...
										<ContentTemplate>
											<fieldset id="fdsDoneOnValue" class="clsFieldSet" style="border-width: 1px;">
												...
												<table>
																	...
																	<asp:TemplateField HeaderText="Done On/Starts">
																		...
																		<ItemTemplate>
																			<asp:TextBox ID="txtDoneOnValue" runat="server" CssClass="clsTextBoxRightAlignSmall_Ajax"
																				ClientIDMode="Static" AutoPostBack="true" OnTextChanged="txtDoneOnValue_TextChanged"
																	...
																	<asp:TemplateField HeaderText="Extn">
																		...
																		<ItemTemplate>
																			<asp:TextBox ID="txtExtensionValue" runat="server" CssClass="clsTextBoxMegaSmall_Ajax"
																				...
																				ToolTip="Enter the Extension Value." Enabled="<%# iif(mAssemblyMonitorModStatus.ModelMonitorMod.MonitorTypeID=3,false,true) %>">
																			</asp:TextBox>
													...
													<tr>
														<td>
															<asp:Label ID="lblNote1" runat="server" CssClass="clsLabelHeader" Width="500">
																Please Note: Started On/Current Values/Due On values for Days/Months/Years will be in Dates. 
																Extension Value for Calendar period should be entered in Days only.
															</asp:Label>
														</td>
													</tr>
												</table>
									...
									<asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
										<ContentTemplate>
											<table border="0" id="Table1" cellspacing="0">
												<tr>
													<td>
														<asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" 
															ToolTip="Click to save Assembly Directives"
															Text="Save"></asp:Button>
													</td>
													<td>
														<asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" 
															ToolTip="Click to print Assembly Directives"
															Text="Print" CausesValidation="False"></asp:Button>
													</td>
													<td>
														<asp:Button ID="btnBack" runat="server" CssClass="clsButton_Ajax" 
