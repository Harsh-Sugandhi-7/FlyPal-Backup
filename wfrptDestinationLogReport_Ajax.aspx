<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptDestinationLogReport_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfrptDestinationLogReport_Ajax" %>
...
<meta http-equiv="x-ua-compatible" content="IE=7,8,9" />
    <title>Destination Log Report</title>
                    ...
                    <table class="clstablelistin" id="tblInner">
                        <tr>
                            <td colspan="5" class="clsFormHeader1Newstyle">
                                <span id="lbltitle" class="clstitle1">Destination Log Report</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">
                        ...
                        <tr>
                            <td align="left" colspan="5">
                                <span id="lblStep2" class="clsLabelHeader">Step II. Selection of Departure From</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="left">
                                <span id="lblDepartureFrom" class="clsLabelAuto">Departure From</span>
                            </td>
                            <td align="left" colspan="3">
                                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbDepartureFrom" runat="server"
                                    DataValueField="ID" EnableViewState="false" DataTextField="Name">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="5">
                                <span id="Label1" class="clsLabelHeader">Step III. Selection of Arrival To</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="left">
                                <asp:Label ID="lblArrivalTo" runat="server" CssClass="clsLabelAuto">Arrival To</asp:Label>
                            </td>
                            <td align="left" colspan="3">
                                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbArrivalTo" runat="server" DataValueField="ID"
                                    ...
                                    <ContentTemplate>
                                        <table border="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:Label ID="lblDeparture" runat="server" CssClass="clsLabelAuto" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:Label ID="lblArrival" runat="server" CssClass="clsLabelAuto" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button CssClass="clsbtnH clsinfoH1" ID="btnClose" runat="server" CausesValidation="False"
                                                        ToolTip="Click to Close Destination Log Report screen" Text="Close"></asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
