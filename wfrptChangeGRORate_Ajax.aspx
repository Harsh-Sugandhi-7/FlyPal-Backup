<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptChangeGRORate_Ajax.aspx.vb"
	EnableEventValidation="false" Inherits="Flypal.wfrptChangeGRORate_Ajax" %>
...
<body bottommargin="5" leftmargin="0" topmargin="5" rightmargin="5" ms_positioning="GridLayout">
	<form id="wfgroup" method="post" runat="server">
								...
								<tr>
									<td colspan="2" class="clsFormHeader1Newstyle">
										<table width="100%">
											<tr>
												<td>
													<span class="clsFormHeader">Change Part GRO Rate</span>
												</td>
												<td align="right">
									...
									<td align="left">
										<table id="Table1" class="clsTable1">
											<tr>
												...
												<td>
													<asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="upnlSearchCriteria">
														<ContentTemplate>
															<asp:DropDownList ID="cmbRecText" runat="server" CssClass="clsTextBoxTagSearchComboSmall" AutoPostBack="true" Visible="False"
																DataTextField="Text" DataValueField="Text" ClientIDMode="Static">
															</asp:DropDownList>
															<asp:DropDownList ID="cmbIssueText" runat="server" CssClass="clsTextBoxTagSearchComboSmall" Visible="False" AutoPostBack="True"
																DataTextField="Text" DataValueField="Text" ClientIDMode="Static">
															</asp:DropDownList>
															<asp:Label ID="lblNo" runat="server" CssClass="clsLabel" Width="32px" Visible="False">No.</asp:Label>
										...
										<table id="Table4">
											<tr>
												<td>
													...
													<asp:ImageButton ID="btnFindNow" runat="server" ImageUrl="~/images/Search2.png" CssClass="clsSearch2btn" ToolTip="Click to find as per criteria." ValidationGroup="1" CausesValidation="true" />
												</td>
											</tr>
										</table>
									</td>
									...
									<td colspan="2" align="left">
										<asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="upnlGrid">
											<ContentTemplate>
												...
												<div style="width: 100%">
													<asp:GridView ID="dgPartSearch" runat="server" ClientIDMode="Static" PageSize="25"
														ShowHeaderWhenEmpty="true" AutoGenerateColumns="False"
														CssClass="clsGridNewStyle" AllowPaging="True" AllowSorting="false" CellPadding="5" ForeColor="Black" GridLines="Horizontal">
														...
														<Columns>
															...
															<asp:BoundField DataField="GROCRate" SortExpression="GROCRate" HeaderText="GRO Rate"
															...
															<asp:ButtonField Text="Change GRO Rate" HeaderText="Change GRO Rate" CommandName="ChangeGRORate">
																<HeaderStyle Wrap="False" HorizontalAlign="Left"></HeaderStyle>
		...
		<div style="display: none">
			<asp:Button runat="server" ID="btnDummyGRORate" Text="Dummy GRORate" />
		</div>
		<asp:Panel runat="server" ID="pnlChangeGRORate" Style="display: none">
			<asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="upnlChangeGRORate">
				<ContentTemplate>
					<asp:Panel runat="server" ID="pnlGRORate" Visible="false">
							...
							<tr>
								<td>
									<table class="clstablelistin" id="Table6">
										<tr>
											<td colspan="3" class="clsFormHeader1Newstyle">
												<table width="100%">
													<tr>
														<td>
															<asp:Label ID="lblTitle" CssClass="clsFormHeader" runat="server">Change GRO Rate</asp:Label>
														</td>
														<td align="right">
															<asp:Button ID="btnGRORateOk" runat="server" CssClass="clsbtnH clsinfoH" 
																ValidationGroup="GROrate" Text="Ok" 
																ToolTip="Click to Add New GRO Rate">
															</asp:Button>
															<asp:Button ID="btnGRORateClose" TabIndex="0" runat="server" 
										...
										<tr>
											<td colspan="3">
												<asp:ValidationSummary ID="ValidationSummary2" ValidationGroup="GROrate" runat="server"
													CssClass="clsValidationSummary"></asp:ValidationSummary>
												<asp:RequiredFieldValidator ID="rfvCR" runat="server" ValidationGroup="GROrate" CssClass="clsLabelAuto"
													ControlToValidate="txtChangeGRORate" ErrorMessage="Enter Change GRO Rate" Display="None"></asp:RequiredFieldValidator>
											</td>
										</tr>
										<tr>
											<td></td>
											<td>
												<span id="lblCurrentLocation" class="clsLabel">Current GRO Rate </span>
											</td>
											<td align="left" colspan="1">
												<asp:TextBox ID="txtCurrentGRORate" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
													BackColor="#E0E0E0" MaxLength="12" ReadOnly="True" Width="100px"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td>
												<span id="lblChangeGRORate1" class="clsLabelStar">*</span>
											</td>
											<td>
												<span id="lblChangeRat" class="clsLabel">Change GRO Rate</span>
											</td>
											<td align="left">
												<asp:TextBox ID="txtChangeGRORate" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
													onkeypress="return validateText('D',1,event)" MaxLength="12" Width="100px"></asp:TextBox>
											</td>
										</tr>
									</table>
								</td>
		...
		<cc2:ModalPopupExtender ID="mdlPopUpChangeGRORate" runat="server" TargetControlID="btnDummyGRORate"
			PopupControlID="pnlChangeGRORate" BackgroundCssClass="clsModalPopupBG">
		...
		<script type="text/javascript">
			...
			function BeginRequestHandler(sender, args) {
				...
				if (element.id == "btnGRORateOk") {
					hideRowHighlight = true;
					$("#gridrowaction").val('GROrate');
				}
				//any of change popup close button event occur 
				else if (element.id == "btnGRORateClose") {
					hideRowHighlight = true;
