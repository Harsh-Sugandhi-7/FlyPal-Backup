<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfQuotationCharge_Ajax.aspx.vb" Inherits="Flypal.wfQuotationCharge_Ajax" %>
    ...
    <form id="form1" runat="server">
                                ...
                                <tr>
                                    <td class="clsFormHeader1Newstyle">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblTitle" CssClass="clsFormHeader" runat="server">Quotation Charge</asp:Label>
                                                </td>
                                                <td align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPercentage" runat="server" CssClass="clsTextBoxTagSearch"
                                                                ToolTip="Enter Percentage" Text="<%# mQuotation.Quotationcharges.currentItem.Percentage %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtChargeAmount" runat="server" CssClass="clsTextBoxTagSearch"
                                                                ToolTip="Enter Charge Amount" Text="<%# mQuotation.Quotationcharges.CurrentItem.CChargeAmount %>"
                                                                MaxLength="12" BackColor="#E0E0E0" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                        <td>&nbsp;
                                                        </td>
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForQuotationCharge();
                return false;
            }
        </script>
        <%--End--%>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            $(document).ready(function () {
                SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameQuotationChargeStateComplete();
                }
            });
    <% End if %>
