<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfManualSubscriptionDueList_Ajax.aspx.vb"
    Inherits="Flypal.wfManualSubscriptionDueList_Ajax" %>
...
<head runat="server">
    <title>Manual Subscription Due Report</title>
                                ...
                                <ContentTemplate>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <td>
                                                                <asp:DropDownList ID="cmbRange" runat="server" Width="168px" CssClass="clsTextBoxTagSearchComboNewstyle"
                                                                    Height="24px">
                                            ...
                                            <td align="right">
                                                <%--<asp:Button ID="btnSearch" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to find list as per searching criteria"
                                                    Text="Find Now"></asp:Button>--%>

                                                <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/images/Search2.png" CssClass="clsSearch2btn" ToolTip="Click to find list as per searching criteria" />
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
                                                ...
                                                <asp:GridView ID="dgManualRevList" runat="server" CssClass="clsGridNewStyle" ShowHeaderWhenEmpty="true"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="ManualName" HeaderText="Manual Name">
                                                         ...
                                                         <asp:BoundField DataField="ManualNo" HeaderText="Manual No.">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="ManualDescription" HeaderText="Description">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="ManualCategory" HeaderText="Category">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
