<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptSearchOrderHistory_Ajax.aspx.vb"
    Inherits="Flypal.wfrptSearchOrderHistory_Ajax" %>
                                ...
                                <tr>
                                    ...
                                    <td class="clsFormHeader1">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <span id="lbltitle" class="clsFormHeader">Order History</span>
                                                </td>
                                                <td align="right">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="upnlDateRange" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table width="100%">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbDateRange" runat="server" AutoPostBack="True" onchange="showTextField(this);">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="upnlSupplierSelection" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <span id="lblSelectionofOrderType" class="clsLabelHeader">Step IV. Selection of Order Type</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="96px">
                                                            <span id="lblOrderType" class="clsLabel">Order Type</span>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbOrderType" runat="server" AutoPostBack="True" onchange="showTextField(this);">
                                                                <asp:ListItem Value="0">(All)</asp:ListItem>
