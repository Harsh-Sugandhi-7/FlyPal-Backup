<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfTaskCardPartRemoval_Ajax.aspx.vb"
    Inherits="Flypal.wfTaskCardPartRemoval_Ajax" %>
...
<html>
<head runat="server">
    <title>Part Removal Detail</title>
...
<body>
    <form id="form1" runat="server" defaultfocus="txtItemList">
                               ...
                               <td class="clsFormHeader1" colspan="3">
                                <table width="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblTitle" runat="server" CssClass="clsFormHeader"> Task Card Part Removal Detail</asp:Label>
                                            </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Button ID="btnOK" runat="server" CssClass="clsbtnH clsinfoH" CausesValidation="True"
                                                                        ValidationGroup="a" Text="OK" ToolTip="Click to Add Part Removal"></asp:Button>
                                                                </td>
                                                                <td>
                                    ...
                                    <asp:UpdatePanel ID="upnlSpareDetail" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <fieldset id="fdswodetail" style="padding: 0px 4px 0px 0px; width: auto; z-index: 10000;">
                                                <legend id="ldwodetail" class="clsFieldSet1" runat="server"><b>Part Removal Details</b></legend>
                                                <table>
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%--<asp:DropDownList ID="cmbItemList" runat="server" CssClass="clsComboBox_Ajax" SelectedValue="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.ItemID %>"
                                                            DataTextField="Name" DataValueField="ID"  EnableViewState="true" AutoPostBack="True">
                                                        </asp:DropDownList>--%>
                                                            <asp:TextBox ID="txtItemList" autocomplete="off" runat="server" CssClass="clsTextBoxTagSearch"
                                                                ValidationGroup="a" Width="320px" AutoPostBack="True" onchange="SetPartIdonChange(this,'txtItemList_AutoCompleteExtender')"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="left">
                                                            <asp:TextBox ID="txtPartNo" runat="server" CssClass="clsTextBoxTagSearch" Text="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.PartNo %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxTagSearchMultilineNewStyleLong" Text="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.Description %>"
                                                                BackColor="White" TextMode="MultiLine" MaxLength="200" ToolTip="Description" Width="400px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtReqQty" runat="server" CssClass="clsTextBoxRightAlignQty_Ajax"
                                                                Text="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.RequiredQty %>" MaxLength="5"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtOffSerialNo" runat="server" CssClass="clsTextBoxTagSearch" Text="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.OffSerialNo %>"
                                                                BackColor="White" MaxLength="200" ToolTip="Enter Off Serial No."></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtOnSerialNo" runat="server" CssClass="clsTextBoxTagSearch" Text="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.OnSerialNo %>"
                                                                BackColor="White" MaxLength="200" ToolTip="Enter On Serial No."></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label3" runat="server" CssClass="clsLabelAuto">Position</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtPosition" runat="server" CssClass="clsTextBoxTagSearch" Text="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.Position %>"
                                                                BackColor="White" MaxLength="25" ToolTip="Position"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxTagSearchMultilineNewStyleLong"
                                                                Text="<%# mTaskCard.TaskCardPartRemovals.CurrentItem.Remark %>" TextMode="MultiLine"
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForTaskCardPartRemoval();
                return false;
            }
        </script>
        <%--End--%>
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
                $(document).ready(function () {
                    SetPageLayout();
                    if ($.browser.msie) {
                        parent.IFrameTaskCardPartRemovalStateComplete();
                    }
