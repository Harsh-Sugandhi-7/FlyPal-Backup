<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAssemblyMonitorServiceStatus_Ajax.aspx.vb"
    Inherits="Flypal.wfAssemblyMonitorServiceStatus_Ajax" %>
                    ...
                    <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                        <table id="tblinner" class="clstablelistin">
                            <tr>
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Assembly Service Status [New]</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                            ...
                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:UpdatePanel runat="server" ID="upnlSelectMonitoringService" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Button ID="btnSelectMonitoringService" runat="server" CssClass="clsButtonVeryLong"
                                                                ToolTip="Click to open screen" Text='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Select Monitoring MPD", "Select Monitoring Service") %>'
                                ...
                                <td valign="top">
                                    <asp:UpdatePanel ID="upnlElapsedRemainingValues" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <fieldset id="fdsElapsedRemainingValues" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:GridView ID="dgElapsedRemainingValues" runat="server" CssClass="clsGridLog"
                                                                PageSize="3" ToolTip="Elapsed And Remaining Values of the Assembly" ShowHeaderWhenEmpty="True"
                            ...
                            <tr>
                                            ...
                                            <fieldset id="Fieldset3" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table border="0" id="Table2" cellpadding="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkApplicable" runat="server" CssClass="clsLabelAuto" ToolTip="Check to apply applicable"
                                                                            Text="Applicable" Checked="<%# mAssemblyMonitorServiceStatus.IsApplicable %>"></asp:CheckBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtWorkOrNo" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Work Order No."
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtRequiredManHours" runat="server" CssClass="clsTextBoxSmall_Ajax"
                                                                    Text="<%# mAssemblyMonitorServiceStatus.TotalReqManHrs1 %>" Enabled="<%# mAssemblyMonitorServiceStatus.MaintenanceDoneByEmployees.Count <= 1 %>"
                                ...
                                <td valign="top">
                                    <asp:UpdatePanel ID="upnlAssemblyValues" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <fieldset id="Fieldset4" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:GridView ID="dgAssemblyValues" runat="server" CssClass="clsGridLog" PageSize="3"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Extn">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtExtensionValue" runat="server" CssClass="clsTextBoxMegaSmall_Ajax"
                                                                                ...
                                                                                ToolTip="Enter the Extension Value." Enabled="<%# iif(mAssemblyMonitorServiceStatus.ModelMonitorService.MonitorTypeID = 3, False, True) %>">
                                                                            </asp:TextBox>
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table border="0" id="Table1" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Click to save Maintenance Event", "Click to save Assembly Service") %>'
                                                            Text="Save"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Click to print Maintenance Event", "Click to print Assembly Service") %>' Visible="false"
