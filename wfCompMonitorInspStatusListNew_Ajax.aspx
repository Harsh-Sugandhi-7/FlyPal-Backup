<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompMonitorInspStatusListNew_Ajax.aspx.vb"
    Inherits="Flypal.wfCompMonitorInspStatusListNew_Ajax" %>
...
<head runat="server">
    ...
    <title>Component Inspection status</title>
...
<body bottommargin="5" leftmargin="5" topmargin="5" rightmargin="5" ms_positioning="GridLayout">
                    ...
                    <table class="clsTablelistin" id="tblinner">
                        ...
                        <tr>
                            <td style="width: 610px">
                                <span id="lblServices" class="clsLabelHeader">Select the Issue Date and Select Assembly
                                    from the list and then select Component for that Assembly and then click on OK button
                                    to add Inspection to that Component.</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForCompInspListNew();
            return false;
        }
    </script>
    <%--End--%>
    ...
    <script type="text/javascript">
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            ...
            SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameCompInspListNewStateComplete();
                }
