<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAlternatePOPartList_Ajax.aspx.vb"
    Inherits="Flypal.wfAlternatePOPartList_Ajax" %>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlCreatealternatepart" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table id="Table1" class="clstablebutton" align="right">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnCreatealternatepart" runat="server" class="clsbtnH clsinfoH1"
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlAlternatePartList" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView ID="dgAlternatePartList" runat="server" CssClass="clsGridNewStyle"
                                                AllowPaging="True" EnableViewState="False" AutoGenerateColumns="False" AllowSorting="False"
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlButton" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table id="Table2" class="clstablebutton" align="right">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnClose" runat="server" class="clsbtnH clsinfoH1" Text="Close" ToolTip="Click To Create Alternate Part"
