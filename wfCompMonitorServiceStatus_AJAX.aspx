<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompMonitorServiceStatus_AJAX.aspx.vb"
    Inherits="Flypal.wfCompMonitorServiceStatus_AJAX" %>
...
<body>
    <form id="form1" runat="server">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Component Service Status [New]</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                    ...
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvMonitorServiceType" runat="server" CssClass="clsLabelAuto"
                                                ControlToValidate="txtPartMonitorServiceTypeName" Display="None" ErrorMessage="Service Type Required."></asp:RequiredFieldValidator>
                                    ...
                                    <fieldset id="fdsMonitoringDetails" class="clsFieldSet" style="border-width: 1px;">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td colspan="2" align="left">
                                                    <asp:UpdatePanel ID="upnlMonitoringSelect" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Button ID="btnSelect" runat="server" CssClass="clsButtonVeryLong" ToolTip="Click to open Part Service List screen"
                                                                Width="150px" Text='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Select Monitoring MPD", "Select Monitoring Service") %>'  CausesValidation="False"></asp:Button>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtPartMonitorServiceTypeName" runat="server" CssClass="clsTextBox_Ajax"
                                                        ToolTip='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Task Type", "Service Type") %>' Text="<%# mCompMonitorServiceStatus.PartMonitorService.PartMonitorServiceTypeName %>"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtATAChapter" runat="server" CssClass="clsTextBox_Ajax" ToolTip="ATA Chapter"
                                                        Text="<%# mCompMonitorServiceStatus.PartMonitorService.ATAChapter %>" ReadOnly="True"
                                                        BackColor="#E0E0E0">
                                                    </asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Reference Doc."
                                                        Text="<%# mCompMonitorServiceStatus.PartMonitorService.Reference %>" ReadOnly="True"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                        Width="250px" BackColor="#E0E0E0" Text="<%# mCompMonitorServiceStatus.PartMonitorService.Description %>"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Elapsed" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtElapsedValue" runat="server" CssClass="clsTextBoxRightAlignSmall1_Ajax"
                                                                                ...
                                                                                ReadOnly="<%# mCompMonitorServiceStatus.PartMonitorServiceID.Equals(Guid.Empty) %>"
                                        ...
                                        <ContentTemplate>
                                            <fieldset id="Fieldset3" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table border="0" id="Table2" cellpadding="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkApplicable" runat="server" CssClass="clsLabelAuto" ToolTip="Check to apply applicable"
                                                                            Text="Applicable" Checked="<%# mCompMonitorServiceStatus.IsApplicable %>"></asp:CheckBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtWorkOrderNo" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Work Order No."
                                                                Text="<%# mCompMonitorServiceStatus.DoneWONo %>" ReadOnly="<%# mCompMonitorServiceStatus.PartMonitorService.ID.Equals(Guid.Empty) %>"
                                                                MaxLength="100">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <asp:PlaceHolder ID="phHide" runat="server" Visible='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", False, True) %>'>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtActualManHours" runat="server" CssClass="clsTextBoxSmall_Ajax"
                                                                    ...
                                                                    OnTextChanged="txtActualManHours_TextChanged" AutoPostBack="true" MaxLength="8"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" ToolTip="Enter the Remark"
                                                                Width="250px" Text="<%# mCompMonitorServiceStatus.DoneRemark %>" ReadOnly="<%# mCompMonitorServiceStatus.PartMonitorService.ID.Equals(Guid.Empty) %>"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="chkIsLater" runat="server" CssClass="clsLabelAuto" Text="Calculate Due For Period Whichever Later"
                                                                Enabled="False" Checked="<%# mCompMonitorServiceStatus.IsLater %>"></asp:CheckBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table border="0" id="Table1" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Click to save Maintenance Event", "Click to save Comp Service") %>'
                                                            Text="Save"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Click to print Maintenance Event", "Click to print Comp Service") %>'
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function () {
            if ("<%= mCompMonitorServiceStatus.PartMonitorService.MonitorTypeID = 1 And Not mCompMonitorServiceStatus.DoneOn Is System.DBNull.Value %>" == "True") {
        ...
        <div id="DueAtMessage" style="display: none">
            <asp:Panel ID="Panel2" runat="server" Visible="<%# IIf(mCompMonitorServiceStatus.PartMonitorService.MonitorTypeID = 1 And Not mCompMonitorServiceStatus.DoneOn Is System.DBNull.Value = True, True, False) %>">
                Component Service<br>Status is one time and you have entered Done On date.</br>
            </asp:Panel>
        </div>
