<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptPartIssueHistory_Ajax.aspx.vb" Inherits="Flypal.wfrptPartIssueHistory_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Part Issue History</title>
                        ...
                        <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                            <table id="tblInner" class="clstablelistin">
                                <tr>
                                    ...
                                    <td class="clsFormHeader1" colspan="2">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <span id="lbltitle" class="clsFormHeader">Part Issue History</span>
                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="btnClose" TabIndex="0" runat="server" CssClass="clsbtnH clsinfoH" Text="Close"
                                                                            ToolTip="Click to Close Part Issue History screen" CausesValidation="False"></asp:Button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ContentTemplate>
                                ...
                                <asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible="false">
                                    <tr>
                                        <td colspan="2">
                                            <span id="lblStepI" class="clsLabelHeader">Selection of IsValued Store</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <span id="lblStepII" class="clsLabelHeader">Step I. Selection of Part Number/Description</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <span id="lblStepIII" class="clsLabelHeader">Step II. Display Report</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
