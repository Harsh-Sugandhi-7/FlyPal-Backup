<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptLogParameterReport_Ajax.aspx.vb"
    Inherits="Flypal.wfrptLogParameterReport_Ajax" %>
                        ...
                        <table class="clstablelistin" id="tblInner">
                            <tr>
                                <td colspan="5" class="clsFormHeader1Newstyle">
                                    <span id="lbltitle" class="clsFormHeader">Log Parameter </span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5">
                                    ...
                                    <asp:CustomValidator ID="cvAssembly" runat="server" CssClass="clslabelauto" ErrorMessage="Select the Assembly"
                                        ClientValidationFunction="ClientValidation" Display="None" ControlToValidate="cmbAssembly"></asp:CustomValidator>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5">
                                            ...
                                            <table border="0" width="100%" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbAircraft" runat="server" ClientIDMode="Static"
                                                            DataTextField="RegNo" DataValueField="ID" AutoPostBack="True">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td align="left">
                                                        <asp:RadioButton ID="rdoPortrait" runat="server" CssClass="clsRadioButton" Text="Portrait"
                                                            Checked="True" GroupName="x"></asp:RadioButton>
                                                        <asp:RadioButton ID="rdoLandScape" runat="server" CssClass="clsRadioButton" Text="Landscape"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyleLong" ID="cmbAssembly" runat="server" ClientIDMode="Static"
                                                            DataTextField="ModelSerialNoPostion" DataValueField="ID" AutoPostBack="True"
                                                            Enabled="False">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" colspan="4">
                                                        <span id="lblSelectParameter" class="clsLabelHeader">Step IV. Selection of Parameter</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <asp:CheckBoxList ID="cmbParameter" runat="server" CssClass="clsCheckBox" DataTextField="ParameterName" RepeatDirection="Horizontal" RepeatColumns="3"
                            ...
                            <tr>
                                <td align="left" colspan="5">
                                    <span id="lblStepIV" class="clsLabelHeader">Step V. Display Report</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button CssClass="clsbtnH clsinfoH1" ID="btnClose" TabIndex="0" runat="server" Text="Close"
                                                            ToolTip="Click to close Log Parameter screen" CausesValidation="False"></asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
