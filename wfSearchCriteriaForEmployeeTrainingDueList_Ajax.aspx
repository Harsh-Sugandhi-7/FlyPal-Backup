<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSearchCriteriaForEmployeeTrainingDueList_Ajax.aspx.vb"
    Inherits="Flypal.wfSearchCriteriaForEmployeeTrainingDueList_Ajax" %>
...
<body>
                        ...
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="3" class="clsFormHeader1Newstyle">
                                    <span id="lbltitle" class="clsFormHeader">Employee Training Due Report</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:UpdatePanel runat="server" ID="upnlDate" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:TextBox runat="server" ID="txtAsOnDate" CssClass="clsTextBoxTagSearchDate" onchange="ValidateDateText(this,'AsOnDate_watermarkextender');"></asp:TextBox>
                            ...
                            <tr>
                                <td colspan="3">
                                    <span id="lblStep3" class="clsLabelHeader">Step III. Selection of Training Details</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="cmbTrainningList" runat="server" CssClass="clsTextBoxTagSearchComboNewstyleLong"
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="cmbTrainningOrgList" runat="server" CssClass="clsTextBoxTagSearchComboNewstyleLong"
                                        ...
                                        <ContentTemplate>
                                            <table cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnExpotToExcel" runat="server" ToolTip="Click to Export To Excel Report"
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnShowStatusOnGrid" runat="server" ToolTip="Click to Show Status (with Color)" 
                                                            Text="Show Status (with Color)" CssClass="clsbtnH clsinfoH1"></asp:Button>
                                                    </td>
                                                    <td align="right">
                                                        <asp:Button ID="btnClose" runat="server" Text="Close" ToolTip="Click to close Employee Training Due Report screen"
                                                            CssClass="clsbtnH clsinfoH1"></asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
    ...
    <asp:Panel runat="server" ID="pnlShowStatus" Style="display: none;position:absolute" CssClass="clspanel1" 
        Width="100%" Height="530px" ScrollBars="Both">
