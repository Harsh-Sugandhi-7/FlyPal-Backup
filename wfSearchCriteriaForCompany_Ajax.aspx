<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSearchCriteriaForCompany_Ajax.aspx.vb" Inherits="Flypal.wfSearchCriteriaForCompany_Ajax" %>
...
<head runat="server">
    ...
    <title>Company wise Flying Register</title>
                    ...
                    <table class="clstablelistin" id="tblInner">
                        <tr>
                            <td colspan="5" class="clsFormHeader1Newstyle">
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <span id="lbltitle" class="clsFormHeader">Search criteria for Company wise Flying Register</span>
                                        </td>
                                            ...
                                            <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <table cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <asp:Button CssClass="clsbtnH clsinfoH" ID="btnCurrentSearchCriteria" runat="server" CausesValidation="False" Text="Current Criteria"
                                                                    ToolTip="Click to display Current Searching criterias" />
                                                            </td>
                                                            <td>
                                                                <asp:Button CssClass="clsbtnH clsinfoH" ID="btnDisplay" runat="server" Text="Display" ToolTip="Click to Display Report" />
                                                            </td>
                                                            <td>
                                                                <asp:Button CssClass="clsbtnH clsinfoH" ID="btnClose" runat="server" CausesValidation="False" Text="Close"
                                                                    ToolTip="Click to close Company wise Flying Register screen" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                        ...
                        <tr>
                            <td align="left" colSpan="5">
                                <span ID="lblStep2" Class="clsLabelHeader">Step II. Selection of Company</span>
                            </td>
                        </tr>
                        <tr>
                            <td width="12px"></td>
                            <td align="left">
                                <span ID="lblCompany" Class="clsLabelAuto">Company</span>
                            </td>
                            <td align="left" colspan="3">
                                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbCompany" runat="server" DataValueField="ID"
                                    DataTextField="Name">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colSpan="5">
                                <span ID="Label4" Class="clsLabelHeader">Step III. Selection of Reference Document </span>
                            </td>
                        </tr>
                        <tr>
                            <td width="12px"></td>
                            ...
                            <td align="left" colspan="3">
                                ...
                                <asp:CheckBox ID="chkLogPageNo" runat="server" CssClass="clsCheckBox" 
                                    Text="Log Page No.">
                                </asp:CheckBox>
                                    ...
                                    <ContentTemplate>
                                        <table width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:Label ID="lblCompany1" runat="server" CssClass="clsLabelAuto" Visible="False"></asp:Label>
                                                </td>
                                            </tr>    
                                        </table>
                                    </ContentTemplate>
                                ...
                                <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Button CssClass="clsbtnH clsinfoH1" ID="btnCurrentSearchCriteria" runat="server" CausesValidation="False"  Text="Current Criteria" 
                                                        ToolTip="Click to display Current Searching criterias" />
                                                </td>
                                                <td>
                                                    <asp:Button CssClass="clsbtnH clsinfoH1" ID="btnDisplay" runat="server" Text="Display" ToolTip="Click to Display Report" />
                                                </td>
                                                <td>
                                                    <asp:Button CssClass="clsbtnH clsinfoH1" ID="btnClose" runat="server" CausesValidation="False" Text="Close" 
                                                        ToolTip="Click to close Company wise Flying Register screen" />
                                                </td>
                                            </tr>
                                        </table>    
