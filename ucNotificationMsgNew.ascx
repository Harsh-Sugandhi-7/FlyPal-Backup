<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucNotificationMsgNew.ascx.vb" Inherits="Flypal.NotificationMsgNew" %>
											...
											<tr>
												<td style="width: 95%">
													<span class="clsMsgBoxTitle">
														<asp:Label runat="server" ID="lblNotificationTitle" Text="Change Password"></asp:Label>
													</span>
												</td>
									...
									<div class="clsMsgBoxInnerBody">
										<div style="height: auto; padding: 10px">
											...
											<div class="clsMsgContent" style="padding: 3px">
												<asp:Label runat="server" CssClass="clsMsgText" ID="lblNotification" Text=""></asp:Label>
											</div>
										</div>
									</div>
								</div>
