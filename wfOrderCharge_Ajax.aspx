<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfOrderCharge_Ajax.aspx.vb"
	Inherits="Flypal.wfOrderCharge_Ajax" %>
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtPercentage" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
																ToolTip="Enter Percentage" Text="<%# mOrder.OrderCharges.CurrentItem.Percentage %>"
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtChargeAmount" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
																ToolTip="Enter Charge Amount" Text="<%# mOrder.OrderCharges.CurrentItem.CChargeAmount %>"
																MaxLength="12" BackColor="#E0E0E0" ReadOnly="True"></asp:TextBox>
														</td>
														<td>&nbsp;
														</td>
