<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptPreMatureFailureReport.aspx.vb"
    Inherits="Flypal.wfrptPreMatureFailureReport" %>
...
<head id="Head1" runat="server">
    ...
    <title>Pre-Mature Failure Report</title>
                        ...
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                ...
                                <table width="100%">
                                        <tr>
                                            <td>
                                                <span id="lbltitle" class="clsFormHeader">Pre-Mature Failure Report</span>
                                            </td>
                                            <td align="right">
