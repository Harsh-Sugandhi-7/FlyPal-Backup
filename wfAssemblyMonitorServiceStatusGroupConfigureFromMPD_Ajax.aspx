<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAssemblyMonitorServiceStatusGroupConfigureFromMPD_Ajax.aspx.vb" Inherits="Flypal.wfAssemblyMonitorServiceStatusGroupConfigureFromMPD_Ajax" %>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <cc2:AutoCompleteExtender ClientIDMode="Static" ID="txtLicenceNo_Autocomplete" runat="server"
                                                                                ...
                                                                                CompletionInterval="1" ServicePath="wfAssemblyMonitorServiceStatusGroupConfigureFromMPD_Ajax.aspx"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" Width="250px"
                                                            ToolTip="Enter the Remark for the Assembly Service Status" MaxLength="500"
                                                            TextMode="MultiLine">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <asp:GridView ID="dgDoneOnValue" runat="server" CssClass="clsGridLog" PageSize="3"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="AssemblyCurrentValueFormatted" HeaderText="Current">
                                                                    <HeaderStyle HorizontalAlign="Right" />
                                                                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                                </asp:BoundField>
                                ...
                                <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table border="0" id="Table1" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Assembly Service"
