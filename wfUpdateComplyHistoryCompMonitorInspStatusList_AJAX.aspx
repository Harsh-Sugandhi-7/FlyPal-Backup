<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfUpdateComplyHistoryCompMonitorInspStatusList_AJAX.aspx.vb"
    Inherits="Flypal.wfUpdateComplyHistoryCompMonitorInspStatusList_AJAX" %>
...
<head id="Head1" runat="server">
    ...
    <title>Component Insp Status History</title>
            ...
            <td>
                <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td colspan="1">
                                <span id="lbltitle" class="clstitle1">History for Component Inspection Status</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                                            ...
                                            <asp:UpdatePanel ID="upnlInspInfo" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <fieldset id="Fieldset1" class="clsFieldSet" style="border-width: 1px">
                                                        <legend id="Legend1" style="font-weight: bold"><b>Inspection Information</b></legend>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblFrequency" runat="server" Style="display: none;" CssClass="clsLabelAuto">Frequency</asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtFrequency" runat="server" CssClass="clsTextBox2_Ajax" BackColor="#E0E0E0"
                                                                        ReadOnly="True" Visible="false" TextMode="MultiLine" Height="20px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnSaveNewTop" runat="server" CssClass="clsButton_Ajax" Text="Save"
                                                        ToolTip="Click to Save Inspection"></asp:Button>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnBackTop" runat="server" CssClass="clsButton_Ajax" Text="Close"
                                                        ToolTip="Click to close Component Inspection Status screen" CausesValidation="False">
                                                    </asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <tr>
                            <td colspan="1">
                                <asp:UpdatePanel ID="upnlGrid" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:GridView ID="dgMonitorInspStatusList" runat="server" CssClass="clsGrid" ToolTip="Component Inspection Status History"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField Visible="False" DataField="PartMonitorInspID" HeaderText="PartMonitorInspID">
                                                </asp:BoundField>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnSaveNew" runat="server" CssClass="clsButton_Ajax" Text="Save"
                                                        ToolTip="Click to Save Insp"></asp:Button>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnBack" TabIndex="0" runat="server" CssClass="clsButton_Ajax" Text="Close"
                                                        ToolTip="Click to close Component Insp Status screen" CausesValidation="False">
                                                    </asp:Button>
                                                </td>
                                            </tr>
                                        </table>
