<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSelectDueJobList_Ajax.aspx.vb"
    Inherits="Flypal.wfSelectDueJobList_Ajax" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <script type="text/javascript">
            ...
            Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function () {
                var dgDueJob = document.getElementById("<%=dgDueJob.ClientID %>");
        for (i = 1; i < dgDueJob.rows.length; i++) {
            var Index = dgDueJob.rows[i].innerText.toString().indexOf("Created");
            if (Index !== -1) {
                dgDueJob.rows[i].cells[0].getElementsByTagName("INPUT")[0].disabled = true;
            }
        }
    });
        </script>
                                                            ...
                                                            <tr>
                                                                <td align="right">
                                                                    ...
                                                                    <asp:ImageButton ID="imgFindNow" runat="server" ImageUrl="~/images/Search2.png" CssClass="clsSearch2btn"
                                                                        ToolTip="Click to find as per searching criteria"></asp:ImageButton>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ContentTemplate>
                                                                ...
                                                                <td valign="top">
                                                                    <table id="Table10" border="0" cellpadding="1" cellspacing="1">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtAsOnDate" runat="server" AutoPostBack="True" CssClass="clsTextBoxTagDateSearch"
                                                                                   ></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:GridView ID="dgDuePeriod" runat="server" AutoGenerateColumns="False" CssClass="clsGridNewStyle"
                                                                        ToolTip="Due List." GridLines="Horizontal" CellPadding="5">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Limit" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txtLimit" runat="server" CssClass="clsTextBoxTagSearchRightAlign1" 
                                                    ...
                                                    <td>
                                                        <div style="height: 420px; overflow: auto;">
                                                            <asp:GridView ID="dgDueJob" runat="server" CssClass="clsGridNewStyle" AutoGenerateColumns="False"
                                                                ToolTip="Due Job." PageSize="5" ShowHeaderWhenEmpty="True" GridLines="Horizontal" CellPadding="5">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField Visible="False" DataField="EstimatedDate" HeaderText="Estimated Date">
                                                                       ...
                                                                       <asp:BoundField DataField="PlannedDetails" HeaderText="Planned Details" HtmlEncode="false">
                                                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                                    ...
                                                                    <asp:BoundField DataField="EstimatedHoursforGrid" HeaderText="Estimated Man Hrs."
                                                                     ...
                                                                     <asp:BoundField DataField="Created" HeaderText="Created" HeaderStyle-CssClass="hideGridColumn">
                                                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Wrap="false"></ItemStyle>
                                                                    </asp:BoundField>
        ...
        <!-- End-->
         <script type="text/javascript">
             function CallParentCallback() {
                 parent.ParentCallBackFunctionForDueJobPlanningItem();
                 return false;
             }
         </script>
    </form>
