<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfFileAttachmentAndOtherInfo_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfFileAttachmentAndOtherInfo_Ajax" %>
...
<body>
        ...
        <table class="clstablelistout" id="tblmain">
            <tr>
                <td colspan="4" class="clsFormHeader1">
                    <asp:Label ID="lblTitle" runat="server" CssClass="clsFormHeader">Add Details</asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    <asp:UpdatePanel ID="upnlValidationsummary" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:CustomValidator ID="cvRemark" runat="server" CssClass="clsLabelAuto" ErrorMessage="Max. length of Remark should be 100 char."
                                ControlToValidate="txtRemark" Display="None" OnServerValidate="customvalidate"></asp:CustomValidator>
                            <asp:RequiredFieldValidator ID="rfvRemark" runat="server" Display="None" CssClass="clsLabelAuto"
                            ...
                            <ContentTemplate>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxTagSearchMultilineNewStyleLong" ToolTip="Enter Remark"
    ...
    <div>
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForFileAttachmentAndOtherInfo();
                return false;
            }
        </script>
        <%--End--%>
    ...
    <div>
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            ...
            SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameFileAttachmentAndOtherInfoStateComplete();
                }
        });
        <% End if %>
