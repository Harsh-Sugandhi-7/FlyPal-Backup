<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfWorkInvoiceCharge_Ajax.aspx.vb"
    Inherits="Flypal.wfWorkInvoiceCharge_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Work Invoice Charge</title>
                ...
                <td>
                    <asp:Panel ID="pnlMain" runat="server" CssClass="clsPanel1">
                        <table class="clstablelistin" id="tblLedgerList">
                            <tr>
                                <td>
                                    <asp:Label ID="lblTitle" CssClass="clstitle1" runat="server">Work Invoice Charge</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPercentage" runat="server" CssClass="clsTextBoxRightAlign_Ajax"
                                                            ToolTip="Enter Percentage" Text="<%# mWorkInvoice.WorkInvoicecharges.currentItem.Percentage %>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtChargeAmount" runat="server" CssClass="clsTextBoxRightAlign_Ajax"
                                                            ToolTip="Enter Charge Amount" Text="<%# mWorkInvoice.WorkInvoicecharges.CurrentItem.CChargeAmount %>"
                                                            MaxLength="12" BackColor="#E0E0E0" ReadOnly="True"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                    </td>
