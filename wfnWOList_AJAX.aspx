<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfnWOList_AJAX.aspx.vb"
    Inherits="Flypal.wfnWOList_AJAX" %>
                                                                ...
                                                                <asp:UpdatePanel ID="upnlActionBtnTop" runat="server" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Button ID="btnAddNewTop" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to Add New Work Order"
                                                                                ...
                                                                                <td>
                                                                                    <asp:Button ID="btnPrintTop" runat="server" CssClass="clsbtnH clsinfoH" Visible="False"
                                                                                        ToolTip="Click to Print the list of Work Order " Text="Print" CausesValidation="False"></asp:Button>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:Button ID="btnCloseTop" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to close List of Work Order screen"
                                                                ...
                                                                <asp:UpdatePanel ID="upnlFindNow" runat="server" UpdateMode="Conditional">
                                                                    <ContentTemplate>                                                                      
                                                                        <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/images/Search2.png" 
                                                                            ...
                                                                            ToolTip="Click to find list of Work Order as  per searching criteria" />
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </td>
                                                        </td>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <span id="lblDocStatus" runat="server">Doc status</span>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:DropDownList ID="cmbDocStatus" runat="server" CssClass="clsTextBoxTagSearchComboSmall1" DataTextField="WOText"
                                                                                                    DataValueField="WOText">
                                                                                                    <asp:ListItem Value="0">(ALL)</asp:ListItem>
                                                                                            ...
                                                                                            <asp:PlaceHolder ID="plhCustomer" runat="server" Visible='<%#IIf(AppSettings("ShowAMOOnlyForNewClients") = "True" And mTransTypeID = 88, True, False) %>'>
                                                                                                <td>
                                                                                                    <asp:Label ID="lblCustomer" runat="server" CssClass="clsLabel" Visible="false">Customer</asp:Label>
                                                                                                </td>
                                                                                                <td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan="5">
                                                                                                <asp:DropDownList ID="cmbAssembly" runat="server" 
                                                                                                    CssClass="clsTextBoxTagSearchComboSmall" DataValueField="AssemblyStatusID"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan="7">
                                                                                                <asp:DropDownList ID="cmbComponent" runat="server" 
                                                                                                    CssClass="clsTextBoxTagSearchComboSmall" DataValueField="CompStatusID"
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2">
                                        <asp:UpdatePanel ID="upnlGridView" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="dgWOList" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="5" CssClass="clsGridNewStyle" DataKeyNames="ID" EnableViewState="True" ForeColor="Black" GridLines="Horizontal" PageSize="25" ShowHeaderWhenEmpty="true">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--2--%>
                                                        <asp:BoundField DataField="WONumber" HeaderText="W.O.No." SortExpression="WONumber">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="False" />
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <%--3--%>
                                                        <asp:BoundField DataField="WORemarkForListPageForPassion" HeaderText="W. O. Description" SortExpression="WORemarkForListPageForPassion">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="false" />
                                                            <ItemStyle Wrap="true" />
                                                        </asp:BoundField>
                                                        <%--4--%>
                                                        ...
                                                        <%--6--%>
                                                        <asp:BoundField DataField="Assembly" HeaderText="Component" SortExpression="Component">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="False" />
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <%--7--%>
                                                        ...
                                                        <%--9--%>
                                                        <asp:BoundField DataField="CustomerWONo" HeaderText="Cust.WONo" SortExpression="CustomerWONo">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="False" />
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <%--10--%>
                                                        ...
                                                        <%--11--%>
                                                        <asp:BoundField DataField="WOStartDateFormatted" HeaderText="Start Date" Visible="false">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="False" />
                                                            <ItemStyle Wrap="False" />
                                                            <FooterStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <%--12--%>
                                                        <asp:BoundField DataField="WOBy" HeaderText="Created By" SortExpression="WOBy">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="False" />
                                                             <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <%--13--%>
                                                        <asp:BoundField DataField="StatusName" HeaderStyle-CssClass="hideGridColumn" HeaderText="DOC. Status" ItemStyle-CssClass="hideGridColumn" SortExpression="StatusName">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%--14--%>
                                                        <asp:BoundField DataField="AuthorizedBy" HeaderText="Submitted By" SortExpression="AuthorizedBy">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="False" />
                                                             <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <%--15--%>
                                                        <asp:BoundField DataField="ServiceProviderName" HeaderText="Submitted To" SortExpression="ServiceProviderName">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%--16--%>
                                                        <asp:BoundField DataField="WOStatus" HeaderText="W.O.Status" SortExpression="WOStatus">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%--17--%>
                                                        <asp:BoundField DataField="WOCloseDateFormatted" HeaderText="Closing Date">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" Wrap="False" />
                                                            <ItemStyle Wrap="False" />
                                                            <FooterStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        ...
                                                        <%--19--%>
                                                        <asp:BoundField DataField="WOJobDescription" HeaderText="Task Description" HtmlEncode="false" SortExpression="WOJobDescription">
                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left"  />
                                                            <ItemStyle CssClass="TextBreak" Wrap="true" />
                                                        </asp:BoundField>
                                                        <%--20--%>
                                                        ...
                                                        <%--22--%>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText=" E-Mail Sent" 
                                                            ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Image ID="ImgMailSend" runat="server" ImageUrl="~/images/MailIcon.png" 
                                                                    Style="height: 10px; width: 15px" ToolTip="Mail Sent" Visible='<%#  Eval("IsMailSend")%>' />
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <%--23--%>
                                                        <asp:BoundField DataField="IsMailSend" HeaderStyle-CssClass="hideGridColumn" 
                                                            HeaderText="Mailsend" ItemStyle-CssClass="hideGridColumn" />
                                                        <%--24--%>
                                                        <asp:TemplateField HeaderText="Job Completion">
                                                            <ItemTemplate>
                                                                <div class="progress progress-striped active">
                                                                    <div id="prgbar" runat="server" aria-valuemax="100" 
                                                                        aria-valuemin="0" aria-valuenow="33" class="progress-bar progress-bar-striped bg-success" 
                                                        ...
                                                        <asp:BoundField DataField="TaskCompletionPercentage" 
                                                            HeaderStyle-CssClass="hideGridColumn" HeaderText="TaskCompletionPercentage" 
                                                            ItemStyle-CssClass="hideGridColumn" />
                                                        <%--26--%>
                                                        <asp:TemplateField HeaderText="Job Complied">
                                                            <ItemTemplate>
                                                                <div class="progress progress-striped active">
                                                                    <div id="prgbarCompliance" runat="server" 
                                                                        aria-valuemax="100" aria-valuemin="0" 
                                                                        aria-valuenow="33" class="progress-bar progress-bar-striped bg-success" 
                                                                        role="progressbar" style="width: 50%">
                                                                        <span id="lblCompliancePercentage" runat="server"></span>
                                                                    </div>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <%--27--%>
                                                        <asp:BoundField DataField="TaskCompliancePercentage" HeaderStyle-CssClass="hideGridColumn" HeaderText="TaskCompliancePercentage" ItemStyle-CssClass="hideGridColumn" />
                                                    </Columns>
                                                </asp:GridView>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
