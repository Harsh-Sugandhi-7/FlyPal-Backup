<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfnWOCompletionList.aspx.vb"
    Inherits="Flypal.wfnWOCompletionList" %>
                                                            ...
                                                            <ContentTemplate>
                                                                <table id="Table2">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:CheckBox ID="chkShowCompletedJobs" runat="server" CssClass="clsCheckBox" Text='Show "Completed Work Orders"'  AutoPostBack="true"
                                                                                Visible="true" />
                                                                        </td>
                                                                        <td>
                                        ...
                                        <ContentTemplate>
                                            <asp:GridView ID="dgWOList" runat="server" CssClass="clsGrid" DataKeyNames="ID" ShowHeaderWhenEmpty="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="DoneByName" SortExpression="DoneByName" HeaderText="Completed By">
                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Complete WO." ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="View" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="View" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="ViewRec"
                                                                Visible='<%# Eval("IsAttachmentAdded") %>' Style="height: 20px; width: 13px"
