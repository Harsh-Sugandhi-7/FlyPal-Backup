<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfFileUploadForSeparateTable.aspx.vb"
	Inherits="Flypal.wfFileUploadForSeparateTable" %>
											...
											<tr>
												...
												<td align="right">
													<asp:Button ID="btnupload" runat="server" Text="Attach"
														ToolTip="Attach the selected File(s)"
														CssClass="clsbtnH clsinfoH" />

													<input id="btnClose" type="button" value="Close"
														title="Close the current window without Attaching File(s)"
				...
				<tr>
					<td colspan="3">
						<asp:Label ID="lblMessage" runat="server"
							...
							Visible="false" 
							Text="* Click Close if Attachment is not Required for BER Issue." />
					</td>
				</tr>
			</table>
