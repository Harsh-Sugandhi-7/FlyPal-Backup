<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfModelMonitorMod_Ajax.aspx.vb"
    Inherits="Flypal.wfModelMonitorMod_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Model Directive Details</title>
...
<body>
                ...
                <td>
                    <asp:Panel ID="pnlMain" runat="server" CssClass="clspnl1">
                        <table id="tblinner" class="clsTablelistin">
                            <tr>
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Model Directive [New]</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                ...
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:CustomValidator ID="cvATA" runat="server" Display="None" ControlToValidate="cmbATAChapter"
                                                ErrorMessage="Select ATA Chapter From List" CssClass="clsLabelAuto" OnServerValidate="CustomValidate"></asp:CustomValidator>
                                            <asp:CustomValidator ID="cvModelModType" runat="server" CssClass="clsLabelAuto" Display="None"
                                                ControlToValidate="cmbMonitorModType" ErrorMessage="Select Model Directive Type from List."
                                                OnServerValidate="customvalidate"></asp:CustomValidator>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvIssueDate" runat="server" CssClass="clsLabelAuto"
                                                Display="None" ControlToValidate="calIssueDate" ErrorMessage="Issue Date Required"></asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="rfvModificationNo" runat="server" CssClass="clsLabelAuto"
                                                Display="None" ControlToValidate="txtModificationNo" ErrorMessage="Directive No Required"></asp:RequiredFieldValidator>
                                            <asp:CustomValidator ID="cvLinkAction" runat="server" Display="None" CssClass="clsLabelAuto"
                                                OnServerValidate="CustomValidate3"></asp:CustomValidator>
                            ...
                            <tr>
                                <td valign="top">
                                    <asp:UpdatePanel ID="upnlMonitorDirectiveDetails" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <fieldset id="fdsMonitorDirectiveingDetails" class="clsFieldSet" style="border-width: 1px;">
                                                <legend id="lgdMonitorDirectiveDetails"><b>Directive Details</b></legend>
                                                <table>
                                                    <tr>
                                                        <td>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCode" runat="server" CssClass="clsTextBox_Ajax" Text="<%# mModelMonitorMod.Code %>"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:DropDownList ID="cmbATAChapter" runat="server" CssClass="clsComboBox2_Ajax"
                                                                                                SelectedValue="<%# mModelMonitorMod.ATAID %>" DataTextField="ATAChapter" DataValueField="ID">
                                                                                            </asp:DropDownList>
                                                                                        </td>
                                                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:UpdatePanel ID="upnlMonitorDirectiveType" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="cmbMonitorModType" runat="server" CssClass="clsComboBox2_Ajax"
                                                                        SelectedValue="<%# mModelMonitorMod.ModelMonitorModTypeID %>" DataTextField="CodeType"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span id="lblStarModification" class="clsLabelStar">*</span>
                                                        </td>
                                                        <td>
                                                            <span id="lblModNo" class="clsLabelAuto">Directive No. </span>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtModificationNo" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                MaxLength="150" Text="<%# mModelMonitorMod.Number %>" TextMode="MultiLine" ToolTip="Enter Directive Number"
                                                                Width="250px">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                ClientIDMode="Static" Text="<%# mModelMonitorMod.Description %>" ToolTip="Enter Description"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblReference" runat="server" CssClass="clsLabel">Reference</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                MaxLength="500" Text="<%# mModelMonitorMod.Reference %>" TextMode="MultiLine"
                                                                ToolTip="Enter Reference" Width="250px">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span id="lblStarIssueDate" class="clsLabelStar">*</span>
                                                        </td>
                                                        <td>
                                                            <span id="lblEffectiveDate" class="clsLabel">Issue Date </span>
                                                        </td>
                                                        <td>
													...
													<tr>
														...
														<td>
															<asp:DropDownList ID="cmbIssuingAuthority" runat="server" CssClass="clsComboBox2_Ajax"
																SelectedValue="<%# mModelMonitorMod.IssuingAuthorityID %>" DataTextField="Name"
																DataValueField="ID" AutoPostBack="True" Width="250px">
															</asp:DropDownList>
														</td>
													</tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="lblSupersededByADNumber" class="clsLabelAuto">Superseded AD Number</span>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtSupersededByADNumber" runat="server" CssClass="clsTextBox_Ajax"
                                                                ToolTip="Enter Superseded AD Number" Text="<%# mModelMonitorMod.SupersededByADNumber %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtApplicability" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                ClientIDMode="Static" Text="<%# mModelMonitorMod.Applicability %>" ToolTip="Enter Applicability"
                                                                 TextMode="MultiLine" Width="250px">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="lblComplianceRequirement" class="clsLabel">Compliance Requirement</span>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtComplianceRequirement" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                MaxLength="1000" Text="<%# mModelMonitorMod.ComplianceRequirement %>" ToolTip="Enter Compliance Requirement"
                                                                TextMode="MultiLine" Width="250px">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtZone" runat="server" CssClass="clsTextBox_Ajax" MaxLength="50"
                                                                Text="<%# mModelMonitorMod.Zone %>" ToolTip="Enter Zone" Width="250px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtArea" runat="server" CssClass="clsTextBox_Ajax" MaxLength="50"
                                                                Text="<%# mModelMonitorMod.Area %>" ToolTip="Enter Area" Width="250px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="chkIsRII" runat="server" Checked="<%# mModelMonitorMod.IsRII %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNote" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" MaxLength="1000"
                                                                ClientIDMode="Static" Width="250px" Text="<%# mModelMonitorMod.Note %>" TextMode="MultiLine"
                                                                ToolTip="Enter Note">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRequiredManHours" runat="server" CssClass="clsTextBoxSmall_Ajax"
                                                                MaxLength="8" Text="<%# mModelMonitorMod.RequiredManHours %>" ToolTip="Enter Required Man Hours">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:UpdatePanel ID="upnlPeriods" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <fieldset id="fdsFrequencyofMonitorDirective" class="clsFieldSet" style="border-width: 1px;
                                                            width: auto">
                                                            <legend id="lgdFrequencyofMonitorDirective"><b>Frequency of Directive</b></legend>
                                                            <table>
                                                                <tr>
                                                                    <td valign="top">
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Frequency">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtFrequencyValue" runat="server" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                            MaxLength="8" ReadOnly="<%# iif(mModelMonitorMod.ReadOnlyFrequencyColumn=true,true,false) %>"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkTools" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                        Enabled="<%# Not mModelMonitorMod.IsNew %>" ToolTip="Click to add Tools" Text="Tools (0 records)"></asp:LinkButton>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkSpares" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                        Enabled="<%# Not mModelMonitorMod.IsNew %>" ToolTip="Click to add Spares" Text="Spares (0 records)"></asp:LinkButton>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkTaskCards" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                        Enabled="<%# Not mModelMonitorMod.IsNew %>" ToolTip="Click to add Task Cards"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtRefAttachLink" runat="server" 
                                                                            ...
                                                                            Text="<%# mModelMonitorMod.RefAttachlink %>" TextMode="MultiLine" 
                                    ...
                                    <asp:UpdatePanel ID="upnlLinkMaint" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:HyperLink ID="lnkLinkMaint1" onclick="PanelToggle()" runat="server" CssClass="clsHyperlink1"
                                                Visible='<%# iif(AppSettings("LinkMaintenance")="True",true,false) %>' Enabled="<%# Not mModelMonitorMod.IsNew %>">Click to add Link Maintenance Activity</asp:HyperLink>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table id="Table1" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSaveSelect" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Save and Select Model Directive"
                                                            Text="Save &amp; Select" Visible='<%# not Session("EditMasterRecord") = "True" %>'>
                                                        </asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Model Directive"
                                                            Text="Save"></asp:Button>
                                                    </td>
                                                     <td>
                                                        <asp:Button ID="btnSendMail" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Sendmail Model Directive"
                                                            Text="Send Mail" CausesValidation="False"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to print Model Directive"
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForModelModMaster();
            return false;
        }
    </script>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
       ...
       SetPageLayout();
       if ($.browser.msie) {
             parent.IFrameModelModMasterStateComplete();
         }
    });
