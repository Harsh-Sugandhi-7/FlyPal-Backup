...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfLogDetail_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfLogDetail_Ajax" %>
                                                                                                    ...
                                                                                                    <asp:GridView ID="dgLogAttachment" ToolTip="List of File Attachment(s)" runat="server"
                                                                                                        ...
                                                                                                        <Columns>
                                                                                                            ...
                                                                                                            <asp:BoundField DataField="SrNo" HeaderText="Sr. No.">
                                                                                                                <HeaderStyle CssClass="clsdgHeader" HorizontalAlign="Left" Width="10px"></HeaderStyle>
                                                                                                            </asp:BoundField>
                                                        ...
                                                        <table id="Table20" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Button ID="btnFlightLogClassification" runat="server" CssClass="clsButton_Ajax"
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    ...
                                                                    <asp:Button ID="btnAddPlaces" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Add new Place"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtAirBorneTime" runat="server" CssClass="clsTextBoxMedium_Ajax"
                                                                                        Text="<%# mLog.TimeInAir %>" ReadOnly="<%# mLog.ShowTimeTextBoxes or Not mLog.IsNew %>"
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtGroundRunTime" runat="server" CssClass="clsTextBoxMedium_Ajax"
                                                                                        ...
                                                                                        ReadOnly="<%# mlog.ShowTimeOnGround or Not mLog.IsNew %>" Visible="False" AutoPostBack="True"></asp:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtPercentTimeOnGround" runat="server" CssClass="clsTextBoxMedium_Ajax"
                                                                                        Text="<%# mLog.PercentTimeOnGround %>" ReadOnly="<%# Not mLog.IsNew %>" Visible="False"
                    ...
                    <asp:UpdatePanel ID="upnlButtons" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table id="Table7" border="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <asp:Button ID="btnAddNew" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Save the Log and add New Log"
