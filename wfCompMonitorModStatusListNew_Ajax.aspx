<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompMonitorModStatusListNew_Ajax.aspx.vb"
    Inherits="Flypal.wfCompMonitorModStatusListNew_Ajax" %>
...
<head runat="server">
    ...
    <title>Component Modification status</title>
...
<body bottommargin="5" leftmargin="5" topmargin="5" rightmargin="5" ms_positioning="GridLayout">
                    ...
                    <table class="clsTablelistin" id="tblinner">
                        ...
                        <tr>
                            <td style="width: 610px">
                                <span id="lblServices" class="clsLabelHeader">Select Assembly from the list and then
                                    select Component for that Assembly and then click on OK button to add Modification
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForCompModListNew();
            return false;
        }
    </script>
    <%--End--%>
    ...
    <script type="text/javascript">
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            ...
            SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameCompModListNewStateComplete();
                }
