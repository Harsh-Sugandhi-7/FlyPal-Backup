<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfnIssuedWOTools_AJAX.aspx.vb"
    Inherits="Flypal.wfnIssuedWOTools_AJAX" %>
                                            ...
                                            <tr width="100%">
                                                <td>
                                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Label ID="lblListOrder" runat="server" CssClass="clsFormHeader">Issued Tools</asp:Label>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                                <td align="right">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:UpdatePanel ID="upnlGrid" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="dgIssuedTools" runat="server" CssClass="clsGridNewStyle" AllowSorting="True"
                                                    AutoGenerateColumns="False" PageSize="3" CellPadding="5" ForeColor="Black" GridLines="Horizontal" ShowHeaderWhenEmpty="true">
                                                    ...
                                                    <Columns>
                                                        <%--0--%>
                                                        <asp:BoundField DataField="IDateFormatted" HeaderText="Issued Date"></asp:BoundField>
                                                        <%--1--%>
                                                        <asp:BoundField DataField="IssueNo" SortExpression="IssueNo" HeaderText="Issued No.">
                                                        ...
                                                        <%--5--%>
                                                        <asp:BoundField Visible="False" DataField="RequiredQty" SortExpression="RequiredQty"
                                                            HeaderText="Requested Qty.">
                                                            <HeaderStyle HorizontalAlign="Right" ></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <%--6--%>
                                                        <asp:BoundField DataField="IssuedQty" SortExpression="IssuedQty" HeaderText="Issued Qty.">
                                                            <HeaderStyle HorizontalAlign="Right" ></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <%--7--%>
                                                        <asp:BoundField DataField="LoanQty" SortExpression="LoanQty" HeaderText="Pending to return Qty.">
                                                            <HeaderStyle HorizontalAlign="Right" ></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <%--8--%>
                                                        ...
                                                        <%--9--%>
                                                        <asp:BoundField DataField="CalibrationNextDueDate" HeaderText="Calibration Next Due">
                                                            <HeaderStyle HorizontalAlign="left" ></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="left"></ItemStyle>
                                                        </asp:BoundField>
                                                        <%--10--%>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            ...
            $(document).ready(function () {
                SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameIssuedToolsStateComplete();
                }
            });
          ...
          <% If Not mopenas Is Nothing AndAlso mopenas = "pup" Then %>  
           ...
           <% End if %>
            ...
            function CallParentCallback() {
                parent.ParentCallBackFunctionForIssuedTools();
                return false;
            }
        </script>
        <%--End--%>
