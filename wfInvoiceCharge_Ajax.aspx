<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfInvoiceCharge_Ajax.aspx.vb"
    Inherits="Flypal.wfInvoiceCharge_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Purchase Invoice Charge</title>
                        ...
                        <table class="clstablelistin" id="tblLedgerList">
                            <tr>
                                <td class="clsFormHeaderSmallTD clsFormHeader1">
                                    <asp:Label ID="lblTitle" CssClass="clsFormHeader" runat="server">Invoice Charge</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPercentage" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
                                                            ToolTip="Enter Percentage" Text="<%# mInvoice.Invoicecharges.currentItem.Percentage %>"
                                                            MaxLength="12" BackColor="#E0E0E0" ReadOnly="True" Width="170px"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        &nbsp;
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtChargeAmount" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
                                                            ToolTip="Enter Charge Amount" Text="<%# mInvoice.Invoicecharges.CurrentItem.CChargeAmount %>"
                                                            MaxLength="12" BackColor="#E0E0E0" ReadOnly="True" Width="170px"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        &nbsp;
