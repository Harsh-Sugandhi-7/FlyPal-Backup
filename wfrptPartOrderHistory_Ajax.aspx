<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptPartOrderHistory_Ajax.aspx.vb" Inherits="Flypal.wfrptPartOrderHistory_Ajax" %>
...
<html>
<head runat="server">
    <title>Part Order History</title>
                        ...
                        <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                            <table id="tblInner" class="clstablelistin">
                                ...
                                <table width="100%">
                                            <tr>
                                                <td>
                                                    <span id="lbltitle" class="clsFormHeader">Part Order History</span>
                                                </td>
                                                <td align="right">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <span id="lblStepV" class="clsLabelHeader">Step II. Display Report</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnClose" TabIndex="0" runat="server" CssClass="clsbtnH" Text="Close"
                                                            ToolTip="Click to Close Part Order History Screen" CausesValidation="False">
                                                        </asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
