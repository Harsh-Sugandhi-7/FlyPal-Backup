<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptACAAReliabilityReport.aspx.vb"
    Inherits="Flypal.wfrptACAAReliabilityReport" %>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                            <table id="tblInner" class="clstablelistin" border="0">
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span id="Span1" class="clsLabelHeader">Step III. Selection of various Reliability Section(s)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="2" valign="top">
                                        <table>
                                            <tr>
                                                ...
                                                <td colspan="5">
                                                    <asp:CheckBox ID="chkExecutiveSummary" runat="server" Text="Executive Summary" CssClass="clsCheckBox" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="chkDispatchReliability" runat="server" Text="Dispatch Reliability"
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="ChkRemoval" runat="server" Text="Removal" CssClass="clsCheckBox" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="ChkMAREP" runat="server" Text="MAREP" CssClass="clsCheckBox" />
                                                </td>
                                                <td>
                                                    &nbsp; &nbsp;
                                                </td>
