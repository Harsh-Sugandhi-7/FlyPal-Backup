<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfUpdateComplyHistoryAssemblyMonitorServiceStatusList_Ajax.aspx.vb"
    Inherits="Flypal.wfUpdateComplyHistoryAssemblyMonitorServiceStatusList_Ajax" %>
...
<head runat="server">
    ...
    <title>Assembly Service Status History</title>
    ...
    <form id="frmgroup" method="post" runat="server">
                ...
                <td>
                    <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="5">
                                    <span id="lbltitle" runat="server" class="clstitle1">History for Assembly Service Status</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5">
                                        ...
                                        <ContentTemplate>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <span id="lblServiceInformation" runat="server" class="clsLabelHeader">Service Information</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span id="lblMonitorInfo" runat="server"  class="clsLabelAuto">Monitor Info.</span>
                                                    </td>
                                                    <td>
												...
												<tr>
													<td>
														<asp:Label ID="lblFrequency" runat="server"
															Visible="false" class="clsLabelAuto">
                                                                Threshold
														</asp:Label>
													</td>
													<td>
														<asp:TextBox ID="txtFrequency" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
															BackColor="#E0E0E0" ReadOnly="True" TextMode="MultiLine" Width="225px" Visible="false">
														</asp:TextBox>
													</td>
												</tr>
                                                <tr>
                                                    <td colspan="2"></td>
                                                    <td>
                                                        <asp:Label ID="lblDescription" runat="server" Visible="false" class="clsLabelAuto">
                                                            Description
                                                        </asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
															ReadOnly="True" BackColor="#E0E0E0" TextMode="MultiLine" Width="225px" Visible="false">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>                                                
                                            </table>
                            ...
                            <tr>
                                <td colspan="5">
                                    <asp:UpdatePanel ID="upnlGrid" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgMonitorServiceStatusList" runat="server" CssClass="clsGrid"  DataKeyNames="ID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Work Order No." HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtWONo" runat="server" CssClass="clsTextBox_Ajax" Text='<%# DataBinder.Eval(Container.DataItem, "DoneWONo") %>'
                                                                MaxLength="100">
                                                            </asp:TextBox>
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForServiceHistory();
                return false;
            }
        </script>
        <%--End--%>
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            $(document).ready(function () {
                SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameServiceHistoryStateComplete();
                }
