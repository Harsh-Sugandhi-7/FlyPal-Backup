<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAssemblyMonitorModStatusListNew_Ajax.aspx.vb"
    Inherits="Flypal.wfAssemblyMonitorModStatusListNew_Ajax" %>
...
<head runat="server">
    ...
    <title>Assembly Directive status</title>
...
<body bottommargin="5" leftmargin="5" topmargin="5" rightmargin="5" ms_positioning="GridLayout">
                        ...
                        <tr>
                            <td>
                                <span id="lblModifications" class="clsLabelAuto">Select Assembly from the list and select
                                    the Issue Date and then click on OK button to add Directives to that Assembly</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForAssemblyDirectiveListNew();
            return false;
        }
    </script>
    <%--End--%>
    ...
    <script type="text/javascript">
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            ...
            SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameAssemblyDirectiveListNewStateComplete();
                }
