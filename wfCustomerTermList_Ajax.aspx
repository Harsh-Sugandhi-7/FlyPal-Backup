<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCustomerTermList_Ajax.aspx.vb"
    Inherits="Flypal.wfCustomerTermList_Ajax" %>
...
<body>
                            ...
                            <tr>
                                <td class="clsFormHeader1Newstyle">
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                <span id="lblListOrder" class="clsFormHeader">List Of Customer Terms</span>
                                            </td>
                                            <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:ImageButton ID="imgbtnTerm" runat="server" ImageUrl="~/images/plus1.png" Height="22px"
                                                            Width="24px" ToolTip="Click to Add New Term" CausesValidation="false" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForCustomerTerm();
            return false;
        }
    </script>
    <%--End--%>
    ...
    <script type="text/javascript">
        ...
        SetPageLayout();
            if ($.browser.msie) {
                parent.IFrameCustomerTermStateComplete();
            }
    });
        <% End if %>
        ...
        $(document).ready(function () {
            $("#imgbtnTerm").live("click", function () {
                try {
                    ...
                    $("#iPopupTerm").attr("src", "wfCustomerTerm_Ajax.aspx?Type=pup&OpenFrom=1");
                    if (!$.browser.msie) {
                        $("#btnDummyTerm").click();
                        //                        $get("AjaxLoader").style.visibility = "hidden";
                    }
