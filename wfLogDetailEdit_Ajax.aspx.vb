' Rajnish   07-09-2006
Partial Class wfLogDetailEdit_Ajax
...
#Region " Business Methods "
	...
	Private Sub EnableDisableButton()
		...
		If Not mLog.IsNew Then
			...
			'Commented by Shital on 15-Mar-2022
		...
		'pnlHours
		' txtAirBorneTime.ReadOnly = Not mLog.IsNew     'Commented on 04-Mar-2022 by shital
	...
	Private Sub SetObject()
		With mLog
			...
			'APFT26112018
			If AppSettings("SetBlockTime") = "True" Then
				If Not .DiffTime.Equals(Trim(txtBlockTime.Text)) Then
	...
	Public Sub SetAirFrameGridObject(Optional ByVal isFromDataBindGrid As Boolean = False)  ' For First Grid i.e AirFrame
		Dim txtAirFrameHours, txtAirFrameLandings, txtAirFrameCycles, txtAirFrameStarts, txtAirFrameNGCycles, txtAirFrameNFCycles, txtAirFrameRins, _
	...
	Public Sub SetEngineGridObject(Optional ByVal isFromDataBindGrid As Boolean = False)        ' For Second Grid i.e ENGINE
		Dim txtEngineHours, txtEngineLandings, txtEngineCycles, txtEngineStarts, txtEngineNGCycles, txtEngineNFCycles, txtEngineRins, _
	...
	Public Sub SetAPUGridObject(Optional ByVal isFromDataBindGrid As Boolean = False)        ' For Third Grid i.e APU
		Dim txtAPUHours, txtAPULandings, txtAPUCycles As TextBox, txtAPUStarts, txtAPUNGCycles, txtAPUNFCycles, txtAPURins, txtAPUBleeds, txtAPUImpellerCycles, _
	...
	Public Sub SetCGBGridObject(Optional ByVal isFromDataBindGrid As Boolean = False)         'For 4th Grid i.e CGB
		Dim txtCGBHours, txtCGBLandings, txtCGBCycles As TextBox, txtCGBStarts, txtCGBNGCycles, txtCGBNFCycles, txtCGBRins, txtCGBBleeds, txtCGBImpellerCycles, _
...
#Region " Events "
	...
	Private Sub imgbtnPilot1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnPilot1.Click
		...
		Response.Redirect("wfSearch.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfLogDetailEdit_Ajax.aspx&Type=Pilot")
	End Sub
	Private Sub imgbtnPilot2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnPilot2.Click
		...
		Response.Redirect("wfSearch.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfLogDetailEdit_Ajax.aspx&Type=Pilot&AddType=1")
	End Sub
	Private Sub btnAddPilot_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddPilot.Click
		...
		Response.Redirect("wfPilot.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfLogDetailEdit_Ajax.aspx")
	End Sub
	...
	Private Sub imgbtnArrPlace_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnArrPlace.Click
		...
		Response.Redirect("wfSearch.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfLogDetailEdit_Ajax.aspx&Type=Place&AddType=2")
	End Sub
	Private Sub btnAddArrPlace_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddArrPlace.Click
		' '' ''AJAX- Above methods shifted in one new method"RefreshControlValues"; as above code is repeatedly get called again and again from different locations
		RefreshControlValues(True)
		Response.Redirect("wfPlace_Ajax.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfLogDetailEdit_Ajax.aspx")
	End Sub
	...
	Private Sub imgbtnDepPlace_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnDepPlace.Click
		' '' ''AJAX- Above methods shifted in one new method"RefreshControlValues"; as above code is repeatedly get called again and again from different locations
		RefreshControlValues(True)
		Response.Redirect("wfSearch.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfLogDetailEdit_Ajax.aspx&Type=Place&AddType=3")
	End Sub
	...
	Private Overloads Sub btnFlightLogClassification_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFlightLogClassification.Click
		...
		'SetSession()
		Response.Redirect("wfFlightLogClassification.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfLogDetailEdit_Ajax.aspx")
	End Sub
