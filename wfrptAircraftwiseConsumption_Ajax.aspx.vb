'Created by Utkarsh ON 26-Nov-2013

Imports System.Configuration.ConfigurationManager

Public Class wfrptAircraftwiseConsumption_Ajax
    ...
    Private Sub SetReport(ByVal IsExcel As Boolean, Optional ByVal ByMail As Boolean = False)
        Try
            ...
            If rbGraph.Checked Then
                If StrAircraft.Length = 0 Then
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "OpenScript", MessageBox.Show("Select aircraft(s) from list ", False), True)
                    Exit Sub
                Else
            ...
            If rbDetails.Checked = True Then
                If AppSettings("ClientCode") = "Heligo" Then
                    myReport = New crptAircraftConsumptionForHeligo
                Else
                    myReport = New crptAircraftConsumption
                ...
                End If
            ElseIf rbGraph.Checked = True Then
                myReport = New crptGraphReportForAircraftConsumption
            End If

            rpt = rptAircraftwiseConsumption.GetAircraftConsumption(FromDate, ToDate, StrAircraft, StrCategory, PartNo, Description, chkIsValued.Checked, chkHighValue.Checked, CDec(Val(txtCEffectiveRate.Text)))  'Changed By Vikrant 3-Jan-2012 For ALL13122011-1
            objSearch = rptSearchingCriteria.GetSearchingCriteria(New Guid("{249760E7-93F9-40BD-B4D8-0DD7D4E7C450}"), FromDate, ToDate, PartNo, "", "", StrCategory, "", "", StrAircraft, "", Description, "", 0, "", "", mText, AppSettings("Logo"))   'Changed By Utkarsh For Report Logo.
            ...
            If (ByMail = True And rpt.Count <= 0) Then
                SendMailFile.SendMailFile(, Thread.CurrentPrincipal.Identity.Name, "Aircraftwise Consumption Report", "Aircraftwise Consumption Report", "There is no record for this search criteria.", _
            ...
            MarkLog(Util.Action.Print, "AircraftConsumption", mAircraftwiseConsumptionSearchingCriteria, Util.ErrorType.NoError, Guid.Empty, EventLogID)
            If ByMail = False Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "openTranDetail", "openTranDetail();", True)
            Else
                SendMailFile.SendMailFile(Session("CrystalReport"), Thread.CurrentPrincipal.Identity.Name, "Aircraftwise Consumption Report", "Aircraftwise Consumption Report", " For " + lblDateRangeFrom.Text, "", _
                                          Session("ToSendMailIDs"), Session("CcSendMailIDs"), "", True, Remark:=Session("SendMailRemark"), _
                                          ReportGeneratedBy:=Session("ReportGenratedBy"), _
                    SmtpHost:=mModuleList.Item("AircraftConsumption").SmtpHost, SmtpPort:=mModuleList.Item("AircraftConsumption").SmtpPort, SmtpUser:=mModuleList.Item("AircraftConsumption").SmtpUser, SmtpPassword:=mModuleList.Item("AircraftConsumption").SmtpPassword)
...
#Region "Events"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            'Ajay 08-Nov-2022
            If IsMarkedFavourite(HttpContext.Current.User.Identity.Name, "AircraftConsumption") Then
    ...
    Private Sub hdnBtnMarkFav_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles hdnBtnMarkFav.Click 'Ajay 08-Nov-2022
        MarkFavourite(HttpContext.Current.User.Identity.Name, "AircraftConsumption")
    End Sub
    ...
    Private Sub hdnBtnRemoveFav_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles hdnBtnRemoveFav.Click 'Ajay 08-Nov-2022
        RemoveFavourite(HttpContext.Current.User.Identity.Name, "AircraftConsumption")
    End Sub
    '-----
#End Region
End Class