<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptEngineLLPStatus_Ajax.aspx.vb"
    Inherits="Flypal.wfrptEngineLLPStatus_Ajax" %>
                    ...
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td class="clsFormHeader1Newstyle">
                                <span id="lbltitle" class="clsFormHeader">Engine LLP Status</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:CustomValidator ID="CustomValidator1" runat="server" CssClass="clsLabelAuto"
                                    Display="None" ControlToValidate="cmbAssembly" ErrorMessage="Select Assembly from list"
                                    ...
                                    <ContentTemplate>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyleLong" ID="cmbAircraft" runat="server" AutoPostBack="True"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyleLong" ID="cmbAssembly" runat="server" DataTextField="ModelSerialNoPositionBA"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button CssClass="clsbtnH clsinfoH1" ID="btnClose" TabIndex="0" runat="server"  Text="Close"
                                                        ToolTip="Click to Close Search criteria screen" CausesValidation="False"></asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
