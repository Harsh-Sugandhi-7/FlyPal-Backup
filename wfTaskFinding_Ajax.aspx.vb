...
Public Class wfTaskFinding_Ajax
    Inherits Page
...
#Region " Variable Declaration "
    ...
    Dim mAuditExecutionClone As AuditExecution
...
#Region " Buisness Method And Properties "
    ...
    Private Sub GetSession()
        ...
        mAuditExecutionClone = Session("AuditExecutionClone")
    ...
    Private Function Setobject() As Boolean
        ...
        mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.ExtensionApplied = chkExtensionApplied.Checked
        mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.ExtensioninDays = Val(txtExtensionInDays.Text)
        mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.ExtensionRemark = Trim(txtExtensionRemark.Text)
            ...
            Select Case Result1
                ...
                Case MsgBoxResult.No
                    ...
                    If MSGBoxCtrl.Sender = "Close" Then
                        ...
                        mFileAttach = Nothing
                        If (mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.IsNew) And (Not Session("FindingEdit") Is Nothing And Not Session("FindingEdit") = True) Then mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.Remove(mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem)
                        Session.Remove("FindingEdit")
                        Dim mopenas As String = Request.QueryString("Type")
                        If Not mopenas Is Nothing AndAlso mopenas = "pup" Then
                            ScriptManager.RegisterStartupScript(Me, [GetType], "onclose", "CallParentCallback();", True)
    ...
    Public Sub Customvalidate(s As Object, e As ServerValidateEventArgs)
        ...
        If CustValid.ControlToValidate = "txtExtensionInDays" Then
...
#Region " DataBind Methods "
    ...
    Private Sub ControlEnability()
        ...
        If OpenFrom = 1 Or OpenFrom = 2 Then 'Finding Rectification Form 'Audit Closing Form
            txtFindingNo.Enabled = False
            txtFindingNo.BackColor = Color.Gainsboro
            txtReference.Enabled = False
            txtReference.BackColor = Color.Gainsboro
            txtFinding.Enabled = False
            txtFinding.BackColor = Color.Gainsboro
            cmbPriority.Enabled = False
            txtDeadlineDate.Enabled = False
            txtDeadlineDate.BackColor = Color.Gainsboro
            txtLocation.Enabled = False
            txtLocation.BackColor = Color.Gainsboro
            ...
            txtExtensionRemark.Enabled = Not (mAuditExecution.AuditStatusID = 2)
        ...
        If OpenFrom = 2 Then 'Audit Closing Form
...
#Region " Events "
    ...
    Private Sub Back_Click(sender As Object, e As EventArgs) Handles btnBack.Click
        ...
        If (mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.IsNew) And (Not Session("FindingEdit") Is Nothing And Not Session("FindingEdit") = True) Then
    ...
    Private Sub ExtensionApplied_CheckedChanged(sender As Object, e As EventArgs) Handles chkExtensionApplied.CheckedChanged
        ...
        Else
            ...
            mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.ExtensioninDays = Val(txtExtensionInDays.Text.Trim)
            txtDeadlineDate.Text = mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.NextDeadlineDate
