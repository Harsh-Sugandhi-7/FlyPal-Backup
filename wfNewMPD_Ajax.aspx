<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfNewMPD_Ajax.aspx.vb"
    Inherits="Flypal.wfNewMPD_Ajax" %>
                                    ...
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:CustomValidator ID="cvMonitorSerType" runat="server" Display="None" ControlToValidate="cmbMonitorInspType"
                                                ErrorMessage="Select Inspection Type from List" CssClass="clsLabelAuto" OnServerValidate="CustomValidate"></asp:CustomValidator>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                            Text="<%# mModelMonitorInsp.Reference %>" ToolTip="Enter Reference" MaxLength="100"
