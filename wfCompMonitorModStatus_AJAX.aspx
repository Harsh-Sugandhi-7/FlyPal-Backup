<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompMonitorModStatus_AJAX.aspx.vb"
    Inherits="Flypal.wfCompMonitorModStatus_AJAX" %>
...
<head id="Head1" runat="server">
    ...
    <title>Comply Component Mod Status</title>
...
<body>
    <form id="form1" runat="server">
                                ...
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvMonitorModType" runat="server" CssClass="clsLabelAuto"
                                                ControlToValidate="txtPartMonitorModTypeName" Display="None" ErrorMessage="Mod Type Required."></asp:RequiredFieldValidator>
                                    ...
                                    <fieldset id="fdsMonitoringDetails" class="clsFieldSet" style="border-width: 1px;">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td colspan="2" align="left">
                                                    <asp:UpdatePanel ID="upnlMonitoringSelect" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Button ID="btnSelect" runat="server" CssClass="clsButtonVeryLong" ToolTip="Click to open Part Mod List screen"
                                                                Width="150px" Text="Select Monitoring Mod" CausesValidation="False"></asp:Button>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtPartMonitorModTypeName" runat="server" CssClass="clsTextBox_Ajax"
                                                        ToolTip="Mod Type" Text="<%# mCompMonitorModStatus.PartMonitorMod.PartMonitorModTypeName %>"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Elapsed" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtElapsedValue" runat="server" CssClass="clsTextBoxRightAlignSmall1_Ajax"
                                                                                ...
                                                                                ReadOnly="<%# mCompMonitorModStatus.PartMonitorModID.Equals(Guid.Empty) %>" Width="80px"
                                                                                ToolTip="Enter the Elapsed Value."></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Remaining" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtRemainingValue" runat="server" CssClass="clsTextBoxRightAlignSmall1_Ajax"
                                                                                ...
                                                                                ReadOnly="<%# mCompMonitorModStatus.PartMonitorModID.Equals(Guid.Empty) %>" Width="80px"
                                                                                ToolTip="Enter the Remaining Value."></asp:TextBox>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" Width="50px" />
                                                                        <ItemStyle Width="50px" HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkApplicable" runat="server" CssClass="clsLabelAuto" ToolTip="Check to apply applicable"
                                                                            Text="Applicable" Checked="<%# mCompMonitorModStatus.IsApplicable %>" Enabled="<%# Not(mCompMonitorModStatus.PartMonitorMod.ReadOnlyFrequencyColumn) %>"></asp:CheckBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtWorkOrderNo" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Work Order No."
                                                                Text="<%# mCompMonitorModStatus.DoneWONo %>" Enabled="<%# mCompMonitorModStatus.PartMonitorMod.IsApplicable %>"
                                                                MaxLength="100">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table border="0" id="Table1" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Comp Mod"
                                                            Text="Save"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to print Comp Mod"
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function () {
            if ("<%= mCompMonitorModStatus.PartMonitorMod.MonitorTypeID = 1 And Not mCompMonitorModStatus.DoneOn Is System.DBNull.Value %>" == "True") {
        ...
        <div id="DueAtMessage" style="display: none">
            <asp:Panel ID="Panel2" runat="server" Visible="<%# IIf(mCompMonitorModStatus.PartMonitorMod.MonitorTypeID = 1 And Not mCompMonitorModStatus.DoneOn Is System.DBNull.Value = True, True, False) %>">
                Component Mod<br>Status is one time and you have entered Done On date.</br>
            </asp:Panel>
        </div>
