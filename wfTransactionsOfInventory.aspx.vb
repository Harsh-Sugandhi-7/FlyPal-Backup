Partial Class wfTransactionsOfInventory
...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents pnldgEnquiryList As System.Web.UI.WebControls.Panel
...
#Region " Helper Methods "
    ...
    Private Sub setPeriod(ByVal Index As Int32)
        Select Case Index
            Case 0 ' All   
                txtFromDate.Value = CDate("1-Jan-1900")
                txtToDate.Value = CDate("1-Jan-2200")
            Case 1 'Last 1 Week
                txtFromDate.Value = Today.AddDays(-6).ToShortDateString
                txtToDate.Value = Today.ToShortDateString
            Case 2 'Last 1 Month
                txtFromDate.Value = Today.AddDays(1).AddMonths(-1).ToShortDateString
                txtToDate.Value = Today.ToShortDateString
            Case 3 'Last 1 Quater
                Select Case Today.Month
                    Case 1, 2, 3
                        txtFromDate.Value = CDate("01-Oct-" + CStr(Today.Year - 1)).ToShortDateString
                        txtToDate.Value = CDate("31-Dec-" + CStr(Today.Year - 1)).ToShortDateString
                    Case 4, 5, 6
                        txtFromDate.Value = CDate("01-Jan-" + CStr(Today.Year)).ToShortDateString
                        txtToDate.Value = CDate("31-Mar-" + CStr(Today.Year)).ToShortDateString
                    Case 7, 8, 9
                        txtFromDate.Value = CDate("01-Apr-" + CStr(Today.Year)).ToShortDateString
                        txtToDate.Value = CDate("30-Jun-" + CStr(Today.Year)).ToShortDateString
                    Case 10, 11, 12
                        txtFromDate.Value = CDate("01-Jul-" + CStr(Today.Year)).ToShortDateString
                        txtToDate.Value = CDate("30-Sep-" + CStr(Today.Year)).ToShortDateString
                End Select
            Case 4 'Last 1 Year
                txtFromDate.Value = Today.AddDays(1).AddYears(-1).ToShortDateString
                txtToDate.Value = Today.ToShortDateString
            Case 5 'Current Financial Year
                If Today.Month <= 3 Then  'Jan|Feb|Mar
                    txtFromDate.Value = CDate("01-Apr-" + CStr(Today.AddYears(-1).Year)).ToShortDateString
                Else
                    txtFromDate.Value = CDate("01-Apr-" + CStr(Today.Year)).ToShortDateString
                End If
                txtToDate.Value = Today.ToShortDateString
...
#Region " Events "
    ...
    Private Sub btnFindNow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFindNow.Click
        If IsValid Then
            If cmbDocType.SelectedIndex = 1 Then  'Enqiry
                ...
                mItemEnquiryList = ItemEnquiryList.GetItemEnquiryList(ItemName, txtFromDate.Value.ToString, txtToDate.Value.ToString)
                dgEnquiryList.DataSource = mItemEnquiryList
                dgEnquiryList.DataBind()
                Session("mItemEnquiryList") = mItemEnquiryList
                lblEnquiryList.Text = "List of Enquiry as per criteria :" & mItemEnquiryList.Count & " Record(s) found."
            ...
            ElseIf cmbDocType.SelectedIndex = 2 Then  'Quotation
                ...
                mItemQuotationList = ItemQuotationList.GetItemQuotationList(ItemName, txtFromDate.Value.ToString, txtToDate.Value.ToString)
                dgQuotationList.DataSource = mItemQuotationList
                dgQuotationList.DataBind()
                Session("mItemQuotationList") = mItemQuotationList
                lblQuotationList.Text = "List of Quotation as per criteria :" & mItemQuotationList.Count & " Record(s) found."
            ...
            ElseIf cmbDocType.SelectedIndex = 3 Then  'Purchase Order
                ...
                mItemOrderList = ItemOrderList.GetItemOrderList(ItemName, txtFromDate.Value.ToString, txtToDate.Value.ToString)
                dgOrderList.DataSource = mItemOrderList
                dgOrderList.DataBind()
                Session("mItemOrderList") = mItemOrderList
                lblPurchaseOrderList.Text = "List of Order as per criteria :" & mItemOrderList.Count & " Record(s) found."
            ...
            ElseIf cmbDocType.SelectedIndex = 4 Then  'Receipt
                ...
                mItemReceiptList = ItemReceiptList.GetItemReceiptList(ItemName, txtFromDate.Value.ToString, txtToDate.Value.ToString, SerialNo)
                ...
                lblReceiptList.Text = "List of Receipt as per criteria :" & mItemReceiptList.Count & " Record(s) found."
            ...
            ElseIf cmbDocType.SelectedIndex = 5 Then  'Issue
                ...
                mItemIssueList = ItemIssueList.GetItemIssueList(ItemName, txtFromDate.Value.ToString, txtToDate.Value.ToString)
                dgIssueList.DataSource = mItemIssueList
                dgIssueList.DataBind()
                Session("mItemIssueList") = mItemIssueList
                lblIssueList.Text = "List of Issue as per criteria :" & mItemIssueList.Count & " Record(s) found."
        ...
        End If
    End Sub
    Private Sub dgEnquiryList_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgEnquiryList.PageIndexChanged
        dgEnquiryList.CurrentPageIndex = e.NewPageIndex
        dgEnquiryList.DataSource = mItemEnquiryList
        Session("mItemEnquiryList") = mItemEnquiryList
        dgEnquiryList.DataBind()
    End Sub
    Private Sub dgQuotationList_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgQuotationList.PageIndexChanged
        dgQuotationList.CurrentPageIndex = e.NewPageIndex
        dgQuotationList.DataSource = mItemQuotationList
        Session("mItemQuotationList") = mItemQuotationList
        dgQuotationList.DataBind()
    End Sub
    Private Sub dgOrderList_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgOrderList.PageIndexChanged
        ...
        dgOrderList.DataBind()
    End Sub
    Private Sub dgReceiptCumInvoiceList_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgReceiptCumInvoiceList.PageIndexChanged
        dgReceiptCumInvoiceList.CurrentPageIndex = e.NewPageIndex
        dgReceiptCumInvoiceList.DataSource = mItemReceiptList
        Session("mItemReceiptList") = mItemReceiptList
        dgReceiptCumInvoiceList.DataBind()
    End Sub
    Private Sub dgIssueList_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgIssueList.PageIndexChanged
        dgIssueList.CurrentPageIndex = e.NewPageIndex
        dgIssueList.DataSource = mItemIssueList
        Session("mItemIssueList") = mItemIssueList
        dgIssueList.DataBind()
    End Sub
