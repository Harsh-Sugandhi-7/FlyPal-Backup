<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfDiscrepancyRemovalInstallation_Ajax.aspx.vb"
    Inherits="Flypal.wfDiscrepancyRemovalInstallation_Ajax" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForDiscrepancyRemovalInstallation();
                return false;
            }
        </script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                SetPageLayout();
                parent.IFrameDiscrepancyRemovalInstallationStateComplete();
              });
