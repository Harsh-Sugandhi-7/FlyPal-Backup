<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfNewCompADSB_Ajax.aspx.vb"
    Inherits="Flypal.wfNewCompADSB_Ajax" %>
...
<html>
<head runat="server">
    <title>Part Modification Details</title>
...
<body>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Part Modification [New]</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                    ...
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:CustomValidator ID="cvMonitorSerType" runat="server" Display="None" ControlToValidate="cmbMonitorModType"
                                                ErrorMessage="Select Modification Type from List" CssClass="clsLabelAuto" ClientValidationFunction="validateSelection"></asp:CustomValidator>
                                            <asp:RequiredFieldValidator ID="rfvModNo" runat="server" Display="None" ControlToValidate="txtModificationNo"
                                                ErrorMessage="Modification No. Required" CssClass="clsLabelAuto"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td valign="top">
                                                <asp:UpdatePanel ID="upnlMonitorModificationDetails" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <fieldset id="fdsMonitorModificationDetails" class="clsFieldSet" style="border-width: 1px;">
                                                            <legend id="lgdMonitorModificationDetails"><b>Modification Details</b></legend>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                            Text="<%# mPartMonitorMod.Reference %>" ToolTip="Enter Reference" MaxLength="100"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span id="lblMonitorModificationType" class="clsLabelAuto">Modification Type</span>
                                                                    </td>
                                                                    <td>
                                                                        <asp:UpdatePanel ID="upnlMonitorModificationType" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox runat="server" ID="calIssueDate" CssClass="clsTextBox_Ajax" Width="100px"
                                                                            ClientIDMode="Static" AutoPostBack="true" onchange="ValidateDateText(this,'DoneOnDate_watermarkextender');"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblComplianceRequirement" runat="server" CssClass="clsLabelAuto">Method of Compliance</asp:Label>
                                                                    </td>
                                                                    <td>
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table id="Table1" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Part Modification"
                                                            Text="Save"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to print Part Modification"
    ...
    <!-- End-->
    <!--Modification History Popup Window -->
    <div style="display: none">
    ...
    <script type="text/javascript">
        ...
        function OpenModificationHistoryWindow() {
            try {
