<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCopyServices_Ajax.aspx.vb"
	Inherits="Flypal.wfCopyServices_Ajax" %>
				...
				<tr>
					<td>
						<asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
							<asp:UpdatePanel ID="upnlCopyCriteria" runat="server" UpdateMode="Conditional">
								<ContentTemplate>
									<table class="clstablelistin" id="tblInner">
										<tr>
											<td colspan="6" class="clsFormHeader1Newstyle">
												<table width="100%">
													<tr>
														<td>
															<asp:Label ID="lblTitle" TabIndex="1" runat="server" CssClass="clsFormHeader">Copy Services</asp:Label>
														</td>
														<td align="right">
															...
															<asp:Button ID="btnCopyTop" runat="server" CssClass="clsbtnH clsinfoH" Text="Copy"
																ToolTip="Click to Copy" Enabled="<%# cmbAssemblyType.SelectedIndex%>"></asp:Button>
										...
										<tr>
											<td colspan="5">
												<asp:Label ID="Label1" runat="server" CssClass="clsLabelHeader">Copy Service Details</asp:Label>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td></td>
											<td>
												<asp:Label ID="lblServiceType" runat="server" CssClass="clsLabelAuto">Service Type</asp:Label>
											</td>
											<td>
												<asp:DropDownList ID="cmbServiceType" runat="server" CssClass="clsTextBoxTagSearchComboNewstyleLong"
										...
										<tr>
											<td colspan="6">
												<asp:Label ID="Label4" runat="server" CssClass="clsLabelHeader">List of Duplicate Services</asp:Label>
											</td>
										</tr>
										<tr>
											<td colspan="6">
												<asp:TextBox ID="txtListError" runat="server" CssClass="clsTextBoxTagSearchMultilineNewstyle"
													TextMode="MultiLine" ReadOnly="True" Style="width: 702px; height: 62px;"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td colspan="3">
												<asp:Label ID="lblModelServiceList" runat="server" CssClass="clsLabelHeader"></asp:Label>
											</td>
										</tr>
										<tr>
											<td colspan="6">
												<asp:GridView ID="dgModelServiceList" runat="server" AutoGenerateColumns="False"
													...
													<Columns>
														...
														<asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Action" ItemStyle-HorizontalAlign="Center">
															...
															<ItemTemplate>
																<asp:ImageButton ID="viewICN" style="height:25px;cursor:pointer;" runat="server"
																	CommandArgument='<%# CType(Container, GridViewRow).RowIndex %>'
																	ToolTip="Click to View Attachment" CausesValidation="False"
										...
										<tr>
											<td align="right" colspan="6">
												<table>
													<tr>
														<td>
															<asp:Button ID="btnCopy" runat="server" CssClass="clsbtnH clsinfoH"
																Enabled="<%# cmbAssemblyType.SelectedIndex>0 %>"
																ToolTip="Click to Copy" Text="Copy" Visible="False"></asp:Button>
														</td>
														<td>
															<asp:Button ID="btnSaveLog" runat="server" CssClass="clsbtnH clsinfoH" CausesValidation="False"
																ToolTip="Click to go back to the previous page" Text="Save Log File" Visible="False"></asp:Button>
														</td>
														<td>
															<asp:Button ID="btnClose" runat="server" CssClass="clsbtnH clsinfoH" CausesValidation="False"
																ToolTip="Click to go back to the previous page" Text="Close" Visible="False"></asp:Button>
														</td>
													</tr>
												</table>
											</td>
