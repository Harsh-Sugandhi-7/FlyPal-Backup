<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfDailyStatusLogReport_Ajax.aspx.vb"
    Inherits="Flypal.wfDailyStatusLogReport_Ajax" %>
                                ...
                                <tr>
                                    <td class="clsFormHeader1">
                                        <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:Label ID="lblLedgerList" runat="server" CssClass="clstitle1">Daily Status</asp:Label>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
                                            ...
                                            <ContentTemplate>
                                                <table width="100%">
                                                                ...
                                                                <ContentTemplate>
                                                                    <table cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtToDate" CssClass="clsTextBoxTagDateSearch" Width="100px" onchange="ValidateDateText(this,'ToDate_watermarkextender');"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyleLong" ID="cmbAircraft" runat="server" AutoPostBack="False"
                                            ...
                                            <ContentTemplate>
                                                <table cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button CssClass="clsbtnH" ID="btnDisplay" TabIndex="0" runat="server" CausesValidation="True"
                                                        ...
                                                        <td>
                                                            <asp:Button CssClass="clsbtnH" ID="btnByExcel" runat="server" TabIndex="25"
                                                                CausesValidation="True" Text="Export to Excel" ToolTip="Click to Export to Excel" Visible="<%$AppSettings:ShowExportToExcelButton%>"
                                                                ValidationGroup="1" />
                                                        </td>
                                                        <td>
