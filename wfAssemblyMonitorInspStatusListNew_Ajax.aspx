<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAssemblyMonitorInspStatusListNew_Ajax.aspx.vb"
    Inherits="Flypal.wfAssemblyMonitorInspStatusListNew_Ajax" %>
    ...
    <script type="text/javascript">
     ...
     <style type="text/css">
        ...
        .loading
        {
            ...
            z-index: 999;
            background-image:"~/images/Loader.gif";
        }
    </style>
...
<body bottommargin="5" leftmargin="5" topmargin="5" rightmargin="5" ms_positioning="GridLayout">
            ...
            <td>
                <asp:Panel ID="pnlMain" runat="server" CssClass="clspnl1">
                    <table class="clsTablelistin" id="tblinner">
                        ...
                        <tr>
                            <td>
                                <span id="lblModifications" class="clsLabelAuto">Select Assembly from the list and select
                                    the Issue Date and then click on OK button to add Inspections to that Assembly</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table id="Table1">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnAdd" runat="server" CssClass="clsButton_Ajax" Text="OK" ToolTip="Click to Continue"    OnClientClick="ShowProgress()">
                                                    </asp:Button>
                                                </td>
                                                <td>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForAssemblyInspectionListNew();
            return false;
        }
    </script>
    <%--End--%>
    ...
    <script type="text/javascript">
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            ...
            SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameAssemblyInspectionListNewStateComplete();
                }
