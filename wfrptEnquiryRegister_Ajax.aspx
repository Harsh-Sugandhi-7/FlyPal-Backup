<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptEnquiryRegister_Ajax.aspx.vb"
    Inherits="Flypal.wfrptEnquiryRegister_Ajax" %>
...
<body>
                ...
                <td>
                    <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td class="clsFormHeader1Newstyle">
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lbltitle" CssClass="clsFormHeader" runat="server">Enquiry Register</asp:Label>
                                            </td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblStep1" runat="server" CssClass="clsLabelHeader">Step I. Selection of Enquiry Type  </asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td width="80px">
                                                <asp:Label ID="lblEnquiryType1" runat="server" CssClass="clsLabel">Enquiry Type</asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbEnquiryType" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblStep3" runat="server" CssClass="clsLabelHeader">Step III. Selection of Enquiry  & It's No.</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblOrderTextNo" runat="server" CssClass="clsLabelAuto">Enquiry No.</asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="clsTextBoxTagSearch" ID="txtEnquiryText" runat="server"
                                                    ClientIDMode="Static"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="clsTextBoxTagSearchSmall" ID="txtOrderNo" runat="server" MaxLength="6"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <asp:UpdatePanel ID="upnlDisplaySearchCriteria" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Label ID="lblEnquiryType" runat="server" CssClass="clsLabelAuto" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Label ID="lblEnquiryNo" runat="server" CssClass="clsLabelAuto" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
    ...
    <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function () {
            ...
            $("#<%=txtEnquiryText.ClientID%>").autocomplete('wfAutoInventoryList.aspx?Type=Text&TextType=7', {
                width: 187,
                autoFill: false,
                matchContains: true,
                mustMatch: true,
