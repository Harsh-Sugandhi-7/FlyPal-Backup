<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfPaymentAdviceList_Ajax.aspx.vb"
    Inherits="Flypal.wfPaymentAdviceList_Ajax" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:UpdatePanel runat="server" ID="upnltitle" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Label ID="lbltitle" TabIndex="1" runat="server" CssClass="clstitle1">List of Payment Advice</asp:Label>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                                ...
                                <asp:UpdatePanel ID="upnlFindNow" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table id="Table3" border="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnFindNow" runat="server" CssClass="clsButton_Ajax" ClientIDMode="Static"
                                                        Text="Find Now" ToolTip="Click to Find records" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                        ...
                                        <asp:Panel ID="pnlAdvancedSearch" runat="server" Style="max-height: 200px; overflow-y: auto;
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:CheckBox ID="ChkIsPaymentDone" Text="Payment Done" runat="server" CssClass="clsCheckBox" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:UpdatePanel ID="upnlResult" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Label ID="lblResult" runat="server" CssClass="clsLabelHeader">List of Payment Advice as per criteria : Record(s) found</asp:Label>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                                <td align="right">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="btnAddNewTop" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                                            ValidationGroup="1" Text="Add New" ToolTip="Click to Add Payment Advice" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" TabIndex="0" Text="Print"
                                                                            ToolTip="Click to Print Register Report" />
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <ContentTemplate>
                                                                        <asp:GridView ID="dgPaymentAdviceList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="PaymentNo" HeaderText="Number" SortExpression="PaymentNo">
                                                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                                    <ItemStyle Wrap="false" />
                                                                                </asp:BoundField>
                                                                                ...
                                                                                <asp:BoundField DataField="CTotalAmount" HeaderText="Total Amount" SortExpression="CTotalAmount"
                                                                                ...
                                                                                <asp:BoundField DataField="PaymentStatus" HeaderText="Payment Done" SortExpression="PaymentStatus">
                                                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                                </asp:BoundField>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnBottomAdd" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                        Visible="false" ValidationGroup="1" Text="Add New" ToolTip="Click to Add Payment Advice" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnBottomClose" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                        Visible="false" TabIndex="0" Text="Close" ToolTip="Click to close List of Payment Advice List screen" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
