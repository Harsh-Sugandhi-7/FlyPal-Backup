<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptPartsPurchaseStatementList_Ajax.aspx.vb"
    Inherits="Flypal.wfrptPartsPurchaseStatementList_Ajax" %>
...
<body bottommargin="5" leftmargin="0" rightmargin="0" topmargin="5" ms_positioning="GridLayout">
    ...
    <table id="tblmain" class="clstablelistout">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td colspan="2" class="clsFormHeader1Newstyle">
                                            <span id="lbltitle" class="clsFormHeader" style="width: 100%">Part Purchase Statement</span>
                                        </td>
        ...
        <tr>
            <td width="70px">
                <span id="Span1" class="clsLabel">Date Range</span>
            </td>
            <td>
        ...
        <tr>
            <td colspan="2" align="left">
                <span id="Span4" class="clsLabelHeader">Step III . Selection Of Receipt Type</span>
            </td>
        </tr>
        <tr>
            <td align="left">
                <span id="Span5" class="clsLabel">Type</span>
            </td>
            <td>
                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbReceiptType" runat="server" >
                    ...
                    <asp:ListItem Value="3">Supplier Loan Taken</asp:ListItem>
                    <asp:ListItem Value="4">Rental/Lease</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td align="left" colspan="2">
                <span id="Label1" class="clsLabelHeader">Step IV . Selection Of Base,Landing,Commercial</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="left">
                <span id="Span3" class="clsLabelHeader">Step V . Selection of Model</span>
            </td>
        </tr>
        <tr>
            <td align="left" width="70px">
            ...
            <td align="left">
                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbModelType" runat="server" DataValueField="ID"
        ...
        <tr>
            <td colspan="2" align="left">
                <span id="Span6" class="clsLabelHeader">Step VI . Selection of Store</span>
            </td>
        </tr>
        <tr>
            <td width="70px">
        ...
        <tr>
            <td colspan="2" align="left">
                <span id="Span7" class="clsLabelHeader">Step VII . Selection of Supplier</span>
            </td>
        </tr>
        <tr>
            <td align="left" width="70px">
                <span id="Span8" class="clsLabelAuto">Supplier</span>
            </td>
            <td align="left">
                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyleLong" ID="cmbSupplier" runat="server" DataValueField="ID"
                    DataTextField="Name">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="left">
                <span id="Span2" class="clsLabelHeader">Step VIII . Selection Of Part No./Description</span>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="2" align="left">
                <span id="lblStep7" class="clsLabelHeader">Step IX. Display Report</span>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="left">
                ...
                <asp:UpdatePanel ID="upnlCurrentCriteria" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <table>
                            ...
                            <tr>
                                <td align="left">
                                    <asp:Label ID="lblReceiptType" runat="server" CssClass="clsLabelAuto" Visible="False"
                                        Width="700px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <ContentTemplate>
                        <table border="0" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <asp:Button CssClass="clsbtnH clsinfoH1" ID="btnClose" runat="server" ToolTip="Click to close Part Purchase statement screen"
