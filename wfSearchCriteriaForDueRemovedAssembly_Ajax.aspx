<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSearchCriteriaForDueRemovedAssembly_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfSearchCriteriaForDueRemovedAssembly_Ajax" %>
                            ...
                            <tr>
                                <td class="clsFormHeader1">
                                    <asp:UpdatePanel runat="server" ID="upnlTitle" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lbltitle" runat="server" CssClass="clsFormHeader">Removed Assemblies Due Report</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlValidations" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:CustomValidator ID="cvSelection" runat="server" CssClass="clsLabelAuto" Display="None"
                                                ControlToValidate="cmbAssembly" ErrorMessage="Please select at least One Service,Inspection or Directive"
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlDetails" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <span id="lblStep2" class="clsLabelHeader">Step II. Selection of Assembly</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                        <asp:Label ID="lblAircraft" runat="server" CssClass="clsLabelAuto">Assembly</asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:DropDownList ID="cmbAssembly" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle" AutoPostBack="True"
                                                            DataTextField="ModelSerialNo" DataValueField="AssemblyStatusID">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
