<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfnWOSelectDueJobListForSparedAssemblies_AJAX.aspx.vb"
    Inherits="Flypal.wfnWOSelectDueJobListForSparedAssemblies_AJAX" %>
                    ...
                    <table class="clsTablelistin" id="tblinner">
                        <tr>
                            <td colspan="2" align="left">
                                <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Due Job(s)</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                            ...
                                            <asp:UpdatePanel ID="UpnlFindNow" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <table id="Table5" cellpadding="1" cellspacing="1">
                                                        <tr>
                                                            <td align="right">
                                                                <asp:Button ID="btnFindNow" runat="server" CssClass="clsButton" Text="Find Now" ToolTip="Click to find as per searching criteria" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                                                            ...
                                                            <td valign="top">
                                                                <table id="Table10" border="0" cellpadding="1" cellspacing="1">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtAsOnDate" runat="server" AutoPostBack="True" CssClass="clsTextBox_Ajax"
                                            ...
                                            <asp:UpdatePanel ID="UpnlDuePeriodList" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <table id="Table16" cellpadding="1" cellspacing="1" width="100%">
                                                        <tr>
                                                            <td>
                                                                <asp:GridView ID="dgDuePeriod" runat="server" AutoGenerateColumns="False" CssClass="clsGrid"
                                                                    ToolTip="Due List.">
                                                            ...
                                                            <td valign="top">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <span id="lblNote" class="clsLabel">Note/Interval</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtNote" runat="server" CssClass="clsTextBox_Ajax"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                ...
                                <asp:UpdatePanel ID="UpnlDone" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table id="Table2" border="0" cellpadding="1" cellspacing="1">
                                            <tr>
                                                <td align="right">
                                                    <asp:Button ID="btnDoneTop" runat="server" CssClass="clsButton" Text="Done" ToolTip="Click to add checked records"
                                                        Enabled="<%# mSelectDueJobs.Count > 0 %>" Visible="False" />
                                                </td>
                                                <td align="right">
                                                    <asp:Button ID="btnBackTop" runat="server" CssClass="clsButton" Text="Back" Visible="False" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="dgDueJob" runat="server" CssClass="clsGrid" AutoGenerateColumns="False"
                                                        ToolTip="Due Job." PageSize="5" ShowHeaderWhenEmpty="True">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="LogBook" HeaderText="Assembly Info." Visible="false">
                                                                <HeaderStyle CssClass="clsdgHeader" HorizontalAlign="Left"></HeaderStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="ATAChapter" HeaderText="ATA Chapter">
                                                                <HeaderStyle CssClass="clsdgHeader" HorizontalAlign="Left"></HeaderStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="OnAssemblyOrComponent" HeaderText="On Assembly / Component">
                                                                <HeaderStyle CssClass="clsdgHeader" HorizontalAlign="Left"></HeaderStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="CodeType" HeaderText="Data Type">
                                                                <HeaderStyle CssClass="clsdgHeader" HorizontalAlign="Left"></HeaderStyle>
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="Freq3ForGrid" HeaderText="Frequency" HtmlEncode="false">
                                                                <HeaderStyle CssClass="clsdgHeader" HorizontalAlign="Right" Width="70px"></HeaderStyle>
                                                            ...
                                                            <asp:BoundField DataField="DueAsOf2ForGrid" HeaderText="Due As Of" HtmlEncode="false">
                                                                <HeaderStyle CssClass="clsdgHeader" HorizontalAlign="Right"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Right" Wrap="false"></ItemStyle>
                                                            </asp:BoundField>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Button ID="btnDone" runat="server" CssClass="clsButton" ToolTip="Click to add checked records"
                                                        Enabled="<%# mSelectDueJobs.Count > 0 %>" Text="Done"></asp:Button>
                                                </td>
                                                <td align="right">
