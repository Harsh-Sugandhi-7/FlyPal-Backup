<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfConditionCheckItemList_Ajax.aspx.vb" EnableEventValidation="false" 
    Inherits="Flypal.wfConditionCheckItemList_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Condition Check/Serviced Inspected Item List</title>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:UpdatePanel runat="server" ID="upnlTitle" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:Label ID="lblConditionCheckItemList" runat="server" CssClass="clsFormHeader">Condition Check Item List</asp:Label>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="upnTopButtons" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <table>
                                                            <tr>
                                                                <td align="right">
                                                                    <asp:Button ID="btnAddNewTop" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to Add New Equipment Maintenance"
                                                                        Text="Add New" CausesValidation="False"></asp:Button>
                                                                </td>
                                                                <td>
                                                                    <asp:Button ID="btnPrintTop" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to Condition Check Item"
                                                                        Text="Print" CausesValidation="False"></asp:Button>
                                                                </td>
                                                                <td align="right">
                                                                    <asp:Button ID="btnCloseTop" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to close Condition Check Item List"
                                        ...
                                        <ContentTemplate>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtItemName" runat="server" CssClass="clsTextBoxTagSearch" MaxLength="100"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtSerialNo" runat="server" CssClass="clsTextBoxTagSearch" MaxLength="100"
                                                            AutoPostBack="true"></asp:TextBox>
                                                    </td>
                                                    <%--<td>
                                                        <span id="lblConditionCheckServicedInspected" class="clsLabel">Condition Check/Serviced
                                                            Inspected</span>
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="cmbConditionCheckServicedInspected" runat="server" CssClass="clsComboBox_Ajax"
                                                            AutoPostBack="True">
                                                            <asp:ListItem Value="0" Selected="True">All</asp:ListItem>
                                                            <asp:ListItem Value="1">Condition Check</asp:ListItem>
                                                            <asp:ListItem Value="2">Serviced/Inspected</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>--%>
                                                </tr>
                                            </table>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlGridView" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblResult" runat="server" CssClass="clsLabelAuto" Font-Bold="True">Condition Check Item List as per criteria : Record(s) found</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnBottomButtons" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table>
                                                <tr>
                                                    <td align="right">
                                                        <asp:Button ID="btnBottomAddNew" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to Add New Purchase Order"
                                                            Text="Add New" CausesValidation="False" Visible="false"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnBottomPrint" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to Print Purchase Order List"
                                                            Text="Print" CausesValidation="False" Visible="false"></asp:Button>
                                                    </td>
                                                    <td align="right">
                                                        <asp:Button ID="btnBottomClose" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to close List of Purchase Order screen."
    ...
    <script type="text/javascript">
        ...
        function OpenConditionCheckItemWindow() {
            try {
                ...
                $("#IframeConditionCheckItem").attr("src", "wfConditionCheckItem_Ajax.aspx?Type=pup");
    ...
    <script type="text/javascript">
        ...
        function OpenConditionCheckItemComplyWindow() {
            try {
                ...
                $get("AjaxLoader").style.visibility = 'visible';
                $("#IframeConditionCheckItemComply").attr("src", "wfConditionCheckItemComply_Ajax.aspx?Type=pup");
