<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfConditionCheckDueReport_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfConditionCheckDueReport_Ajax" %>
...
<head runat="server">
    ...
    <title>Condition Check Due Report</title>
                        ...
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="5" class="clsFormHeader1Newstyle">
                                    <span id="lbltitle" class="clsFormHeader">Condition Check Due Report</span>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <ContentTemplate>
                                            <table border="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnExport" runat="server" CssClass="clsbtnH clsinfoH1" Text="Export to Excel"  Visible="<%$AppSettings:ShowExportToExcelButton%>"
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnClose" runat="server" CssClass="clsbtnH clsinfoH1" Text="Close" ToolTip="Click to Close Condition Check Due Report screen"
