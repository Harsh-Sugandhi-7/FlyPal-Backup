<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptSearchPendingPayment_Ajax.aspx.vb"
    Inherits="Flypal.wfrptSearchPendingPayment_Ajax" %>
...
<body bottommargin="5" leftmargin="0" topmargin="5" ms_positioning="GridLayout">
            ...
            <td>
                <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                    <table class="clstablelistin" id="tblInner">
                        <tr>
                            <td colspan="2">
                                <span id="lbltitle" class="clstitle1">Pending Payment</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                    ...
                                    <ContentTemplate>
                                        <table border="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="cmbDateRange" ClientIDMode="Static" runat="server" CssClass="clsComboBox_Ajax" AutoPostBack="True">
                        ...
                        <tr>
                            <td align="left" colspan="2">
                                <span id="lblStep3" class="clsLabelHeader">Step III. Selection of Supplier Invoice No.</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtVendorInvoiceNo" runat="server" CssClass="clsTextBox_Ajax" MaxLength="50"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="upnlCriteria">
                                    <ContentTemplate>
                                        <table border="0" cellspacing="0">
                                            <tr>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:Label ID="lblVendorInvNoName" runat="server" CssClass="clsLabelAuto" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnClose" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                        TabIndex="0" Text="Close" ToolTip="Click to close Pending Payment screen" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
