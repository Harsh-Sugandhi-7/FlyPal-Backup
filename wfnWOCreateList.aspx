<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfnWOCreateList.aspx.vb"
    Inherits="Flypal.wfnWOCreateList" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .clsTextBoxTagSearch
        {
            ...
            border-bottom-right-radius: 5px; /* background: #F1F1F1  no-repeat; url(images/TagSearch.png)*/
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td >
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                                                <ContentTemplate>
                                                                                    <asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible='<%# iif(mTransTypeID = 89 Or mTransTypeID = 91,True,False) %>'>
                                                                                        <asp:DropDownList ID="cmbAircraft" runat="server" CssClass="clsComboBox1_Ajax" DataTextField="RegNo"
                                                                                            DataValueField="RegNo" AutoPostBack="True">
                                                                                            <asp:ListItem Value="0">(ALL)</asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </asp:PlaceHolder>
                                                                                    <asp:PlaceHolder ID="PlaceHolder2" runat="server" Visible='<%# iif(mTransTypeID = 88 Or mTransTypeID = 90,True,False) %>'>
                                                                                        <asp:TextBox ID="txtRegNo" TabIndex="26" runat="server" CssClass="clsTextBox_Ajax"
                                                                                        ...
                                                                                        <cc2:autocompleteextender clientidmode="Static" id="AutoCompleteExtender1" runat="server"
                                                                                            ...
                                                                                            servicepath="wfnWOCreateList.aspx" servicemethod="GetRegTextList" targetcontrolid="txtRegNo"
                                                                        ...
                                                                        <td>
                                                                            <asp:UpdatePanel ID="upnlModel" runat="server" UpdateMode="Conditional">
                                                                                <ContentTemplate>
                                                                                    <asp:PlaceHolder ID="PlaceHolder4" runat="server" Visible='<%# iif(mTransTypeID = 89 Or mTransTypeID = 91,True,False) %>'>
                                                                                        <asp:DropDownList ID="cmbModel" runat="server" CssClass="clsComboBox1_Ajax" DataTextField="Name"
                                                                                            DataValueField="Name">
                                                                                        </asp:DropDownList>
                                                                                    </asp:PlaceHolder>
                                                                                    <asp:PlaceHolder ID="PlaceHolder3" runat="server" Visible='<%# iif(mTransTypeID = 88 Or mTransTypeID = 90,True,False) %>'>
                                                                                        <asp:TextBox ID="txtModelNo" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Model No.">
                                                                                        </asp:TextBox>
                                                                        ...
                                                                        <td>
                                                                          <asp:CheckBox ID="chkShowOJSWO" runat="server" CssClass="clsCheckBox" Text='Show "OJS W.O"'
                                                                           AutoPostBack="true" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtnTop" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table>
                                                <tr>
                                                <td>
                                                <asp:Label ID="lblWo" runat="server"  CssClass="clsLabel" Text="W.O.Type"></asp:Label>
                                                </td>
                                                <td>
                                                
                                                    <asp:DropDownList ID="cmbWOType" runat="server" CssClass="clsComboBox_Ajax">
                                                        <asp:ListItem Text="New" Value="0"></asp:ListItem>
                                                        <asp:ListItem Text="OJS" Value="1"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnPrintTop" runat="server" CssClass="clsButton_Ajax" Visible="False"
                                        ...
                                        <ContentTemplate>
                                            <asp:GridView ID="dgWOList" runat="server" CssClass="clsGrid" DataKeyNames="ID" ShowHeaderWhenEmpty="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="WOJobDescription" SortExpression="WOJobDescription" HeaderText="Task Description"
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="EditRec" runat="server" CommandArgument='<%# Eval("ID") %>'
                                                                CommandName="EditRec" Style="height: 15px; width: 15px" Enabled='<%# Eval("WOStatusID")=1 Or Eval("WOStatusID")=7  %>'
                                                    ...
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Delete" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Delete" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="DeleteRec"
                                                                Enabled='<%# Eval("WOStatusID")=1 Or Eval("WOStatusID")=7  %>' Style="height: 20px;
