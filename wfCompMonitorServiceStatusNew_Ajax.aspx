<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompMonitorServiceStatusNew_Ajax.aspx.vb"
    Inherits="Flypal.wfCompMonitorServiceStatusNew_Ajax" %>
                                            ...
                                            <tr>
                                                <td colspan="2" align="left">
                                                    <asp:UpdatePanel runat="server" ID="upnlSelectMonitoringService" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Button ID="btnSelect" runat="server" CssClass="clsButtonVeryLong" ToolTip='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", "Click to open MPD List screen", "Click to open Part Service List screen") %>' 
                                        ...
                                        <ContentTemplate>
                                            <table border="0" id="Table1" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to print"
