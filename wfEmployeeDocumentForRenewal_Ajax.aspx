<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfEmployeeDocumentForRenewal_Ajax.aspx.vb"
    Inherits="Flypal.wfEmployeeDocumentForRenewal_Ajax" EnableEventValidation="false" %>
...
<head runat="server">   
    ...
    <title>Employee Document For Renewal</title>
...
<body bottommargin="5" leftmargin="0" rightmargin="0" topmargin="0" ms_positioning="GridLayout">
                        ...
                        <tr>
                            <td class="clsFormHeader1Newstyle"> 
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <span id="lbltitle" class="clsFormHeader">Employee Document Renewal</span>
                                        </td>
                                            ...
                                            <asp:UpdatePanel ID="upnlClose" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:Button ID="btnClose" runat="server" CssClass="clsbtnH clsinfoH" Text="Close" CausesValidation="False"
                                                        ToolTip="CLick to close Employee Document Renewal screen"></asp:Button>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr>
                                        ...
                                        <td align="left">
                                            <table id="Table2" border="0" cellspacing="1" cellpadding="1">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:CheckBox ID="chkNotApplicable" runat="server" CssClass="clsCheckBox" Text="Show Only Not Applicable Document(s)">
                                                        </asp:CheckBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <asp:GridView ID="dgDocumentList" runat="server" AutoGenerateColumns="False"
                                                        DataKeyNames="ID,EmployeeID" ShowHeaderWhenEmpty="true" AllowPaging="true" PageSize="25"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="DesignationName" HeaderText="Designation" ItemStyle-Width="200px" HeaderStyle-Width="200px">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="DocumentName" HeaderText="Document">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="DocNo" HeaderText="Doc No" ItemStyle-Width="60px" HeaderStyle-Width="60px">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="PlaceOfIssue" HeaderText="Place of Issue" ItemStyle-Width="150px" HeaderStyle-Width="150px">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="DocumentValidityInName" HeaderText="Validity In" ItemStyle-Width="90px" HeaderStyle-Width="90px">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="IssuingAuthority" HeaderText="Issuing Authority" ItemStyle-Width="200px" HeaderStyle-Width="200px">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="ApplicabilityRemark" HeaderText="Not Applicable Remark">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
    ...
    <!-- End-->
    <!-- javascript function to set combobox selected value to appropriate hidden field for Employee-->
    <script type="text/javascript">
