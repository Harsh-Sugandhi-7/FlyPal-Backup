<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptPendingToIssueForExchangeRepairOverhaulOrder_Ajax.aspx.vb"
    Inherits="Flypal.wfrptPendingToIssueForExchangeRepairOverhaulOrder_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Pending To Issue For Exchange Repair Overhaul</title>
                ...
                <td>
                    <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="2">
                                    <span id="lbltitle" class="clstitle1">Pending To Issue For Exchange Repair Overhaul
                                        (Core Unit Return)</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    <span id="lblStepII" class="clsLabelHeader">Step II. Selection of Supplier</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <span id="lblStepIII" class="clsLabelHeader">Step III. Selection of Part Number Or Description</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <span id="lblSerialNoStep" class="clsLabelHeader">Step IV. Enter Serial No.</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <span id="Span1" class="clsLabelHeader">Step V. Selection of Order Type</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:DropDownList ID="cmbOrderType" runat="server" CssClass="clsComboBox_Ajax">
                                        ...
                                        <asp:ListItem Value="3">Overhul</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <span id="lblStepV" class="clsLabelHeader">Step VI. Display Report</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnClose" TabIndex="0" runat="server" CssClass="clsButton_Ajax" Text="Close"
                                                            ToolTip="Click to Close Pending To Issue For Exchange Repair Overhaul (Core Unit Return) screen"
