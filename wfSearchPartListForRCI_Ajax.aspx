<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSearchPartListForRCI_Ajax.aspx.vb"
    Inherits="Flypal.wfSearchPartListForRCI_Ajax" %>
                                                            ...
                                                            <div style="width: 100%;">
                                                                <table border="0" cellpadding="2" cellspacing="1" align="right">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <asp:Button ID="btnGridPaging" CssClass="clsbtnH clsinfoH" runat="server" Text="Go" />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
