<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptTransitDamageItemList_Ajax.aspx.vb"
    Inherits="Flypal.wfrptTransitDamageItemList_Ajax" %>
...
<head id="Head1" runat="server">
    ...
    <title>Transit Damage Item List</title>
                    ...
                    <table class="clstablelistin" id="tblInner" >
                        <tr>
                            <td class="clsFormHeader1">
                                <span class="clsFormHeader" id="lbltitle" >Transit Damage Item List</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
