<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfComplyCompMonitorInspStatusListShowValues_Ajax.aspx.vb"
    Inherits="Flypal.wfComplyCompMonitorInspStatusListShowValues_Ajax" %>
...
<head id="Head1" runat="server">
    ...
    <title>Component Insp Status List</title>
            ...
            <td>
                <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td>
                                <asp:Label ID="lbltitle" TabIndex="1" runat="server" CssClass="clstitle1">List of Component Insp Status</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 200px">
                                                                    <asp:DropDownList ID="cmbMonitorType" runat="server" CssClass="clsComboBox3_Ajax"
                                                                        Width="185px" DataTextField="PartMonitorInspTypeName" DataValueField="ID">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td style="width: 80px">
                                                                ...
                                                                <td>
                                                                    <asp:CheckBox ID="chkApplicable" runat="server" CssClass="clsLabelAuto" ToolTip='Check to see only "NOT APPLICABLE"  records'
                                                                        Text='Show ONLY "NOT  APPLICABLE" records'></asp:CheckBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <asp:UpdatePanel ID="upnlFindNow" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:Button ID="btnFindNow" TabIndex="0" runat="server" CssClass="clsButton_Ajax"
                                                                    ToolTip="Click to find list of Insp as per searching criteria" Text="Find Now"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="btnAddNewTop" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                                            Text="Add New" ToolTip="Click to Add Insp" ValidationGroup="1" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnPrintTop" runat="server" CausesValidation="False" CssClass="clsButton_Ajax" Visible="false"
                                                                             TabIndex="0" Text="Print" ToolTip="Click to print List of Component Insp" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnBackTop" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                                            TabIndex="0" Text="Close" ToolTip="Click to close List of Component Insp Status screen" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ContentTemplate>
                                                                    ...
                                                                    <ContentTemplate>
                                                                        <asp:GridView ID="dgDueMonitoringList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="PartNo" HtmlEncode="false" HeaderText="PartNo" SortExpression="PartNo"
                                                                                    HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                                                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                                </asp:BoundField>
                                                                                <asp:BoundField DataField="CompSerialNo" HtmlEncode="false" HeaderText="CompSerialNo"
                                                                                    SortExpression="CompSerialNo" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                                                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                                </asp:BoundField>
                                                                                <asp:BoundField DataField="AssemblyID" HeaderText="AssemblyID" SortExpression="ID"
                                                                                    HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                                                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                                </asp:BoundField>
                                                                                ...
                                                                                <asp:BoundField DataField="PartMonitorInspCode_Desc" HeaderText="Code/Form No./Description"
                                                                                    SortExpression="PartMonitorInspCode_Desc" HtmlEncode="false">
                                                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                                                                                </asp:BoundField>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Frequency" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblFreqValues" runat="server" CssClass="clsLabelAuto" >View Values</asp:Label>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Effective From/DoneOn Value" ItemStyle-HorizontalAlign="Center"
                                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblDoneOnValues" runat="server" CssClass="clsLabelAuto" >View Values</asp:Label>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Current" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblCurrentValues" runat="server" CssClass="clsLabelAuto" >View Values</asp:Label>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Elapsed" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblElapsedValues" runat="server" CssClass="clsLabelAuto" >View Values</asp:Label>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Extension" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblExtensionValues" runat="server" CssClass="clsLabelAuto">View Values</asp:Label>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Due At." ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblDueAtValues" runat="server" CssClass="clsLabelAuto" >View Values</asp:Label>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Due At Airframe" ItemStyle-HorizontalAlign="Center"
                                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblDueAtAirframeValues" runat="server" CssClass="clsLabelAuto" >View Values</asp:Label>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnAddNew" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                        ValidationGroup="1" Text="Add New" ToolTip="Click to Add Insp" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnPrint" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                        Visible="false" TabIndex="0" Text="Print" ToolTip="Click to print List of Component Insp" />
                                                </td>
                                                <td>
                        ...
                        <tr style="height: 0px;">
                            <td style="height: 0px;">
                                <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel2">
                                    <ContentTemplate>
                                        <asp:Button ID="hdnBtnCompInspHistory" ClientIDMode="Static" runat="server" Text="Add"
