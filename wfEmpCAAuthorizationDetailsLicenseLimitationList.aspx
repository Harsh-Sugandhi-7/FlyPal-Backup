<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfEmpCAAuthorizationDetailsLicenseLimitationList.aspx.vb" Inherits="Flypal.wfEmpCAAuthorizationDetailsLicenseLimitationList" %>
                ...
                <td>
                    <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                        <table class="clstablelistin" id="tblInner">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:Label ID="lbltitle" CssClass="clsFormHeader" runat="server">LICENSE LIMITATION</asp:Label>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </td>
                                                    <td align="right">
                                                        ...
                                                        <asp:Button ID="btnSave" CssClass="clsbtnH clsinfoH" runat="server" Text="Done" ToolTip="Click to add the License Limitation Information"
                                                            ValidationGroup="1"></asp:Button>
                                                        <asp:Button ID="btnBack" runat="server" CausesValidation="False" CssClass="clsbtnH clsinfoH"
                                                            TabIndex="0" Text="Close" ToolTip="Click to Close License Limitation Screen" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
                            ...
                            <tr>
                                <td>
                                    <asp:UpdatePanel ID="upnlLicenseLimitation" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div style="height: 65vh; overflow: auto;">
                                                                                <asp:GridView ID="dgLimitationList" runat="server" CssClass="clsGridNewStyle" ShowHeaderWhenEmpty="True" DataKeyNames="ID"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <%--2--%>
                                                                                        <asp:BoundField DataField="LimitationCode" HeaderText="Limitation Code">
        ...
        <div>
            ...
            <script type="text/javascript">
                function CallParentCallback() {
                    parent.ParentCallBackFunctionForAuthorizationDetailLimitation();
                }
            </script>
            <%--End--%>
