<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfWorkInvoiceTerm_Ajax.aspx.vb"
    Inherits="Flypal.wfWorkInvoiceTerm_Ajax" %>
...
<head id="Head1" runat="server">
    <title>List of Work Invoice Terms</title>
                ...
                <td>
                    <asp:Panel ID="pnlMain" runat="server" CssClass="clsPanel1">
                        <table class="clstablelistin" id="tblLedgerList">
                            <tr>
                                <td>
                                    <span id="lblListQuotation" class="clstitle1">List Of Work Invoice Terms</span>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlTerm" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgTerm" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                                CssClass="clsGrid" PageSize="25" ShowHeaderWhenEmpty="True">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#imgbtnTerm").live("click", function () {
                try {
                    $("#iPopupTerm").attr("src", "wfTerm_Ajax.aspx?Type=pup&OpenFrom=6");
                    if (!$.browser.msie) {
                        $("#btnDummyTerm").click();
                    }
