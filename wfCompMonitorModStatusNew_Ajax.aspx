<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompMonitorModStatusNew_Ajax.aspx.vb"
    Inherits="Flypal.wfCompMonitorModStatusNew_Ajax" %>
...
<head runat="server">
    ...
    <title>Comply Component Modification Status</title>
...
<body>
    <form id="form1" runat="server">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Component Modification Status [New]</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td colspan="2" align="left">
                                                    <asp:UpdatePanel runat="server" ID="upnlSelectMonitoringModification" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Button ID="btnSelect" runat="server" CssClass="clsButtonVeryLong" ToolTip="Click to open Part Modification List screen"
                                                                Width="180px" Text="Select Monitoring Modification" CausesValidation="False"></asp:Button>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtMonitorModType" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Modification Type"
                                                        Text="<%# mCompMonitorModStatus.PartMonitorMod.PartMonitorModTypeName %>" ReadOnly="True"
                                                        BackColor="#E0E0E0">
                                                    </asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtATAChapter" runat="server" CssClass="clsTextBox_Ajax" ToolTip="ATA Chapter"
                                                        Text="<%# mCompMonitorModStatus.PartMonitorMod.ATAChapter %>" ReadOnly="True"
                                                        BackColor="#E0E0E0">
                                                    </asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Reference"
                                                        Text="<%# mCompMonitorModStatus.PartMonitorMod.Reference %>" ReadOnly="True"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                        Width="250px" BackColor="#E0E0E0" Text="<%# mCompMonitorModStatus.PartMonitorMod.Description %>"
                                        ...
                                        <ContentTemplate>
                                            <fieldset id="fdsElapsedRemainingValues" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:GridView ID="dgCurrentValue" runat="server" CssClass="clsGridLog" PageSize="3"
                                                                ToolTip="Elapsed And Remaining Values of the Modification" ShowHeaderWhenEmpty="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Elapsed" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtElapsedValue" runat="server" CssClass="clsTextBoxRightAlignSmall1_Ajax"
                                                                                ...
                                                                                ReadOnly="<%# mCompMonitorModStatus.PartMonitorModID.Equals(Guid.Empty) %>" Visible="<%# iif(mCompMonitorModStatus.PartMonitorMod.MonitorTypeID=3,false,true) %>"
                                                                                Width="80px" ToolTip="Enter the Elapsed Value."></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Remaining" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span id="lblNote" class="clsLabelHeader">Please Note : Elapsed / Remaining values for
                                                            Days/Months/Years will be in days.</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </fieldset>
                                            ...
                                            <fieldset id="Fieldset3" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table border="0" id="Table2" cellpadding="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <cc2:CalendarExtender ID="calDoneOn_CalendarExtender" runat="server" CssClass="cal_Theme1"
                                                                            Enabled="true" Format="<%$AppSettings:DateFormat%>" TargetControlID="calDoneOn"></cc2:CalendarExtender>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkApplicable" runat="server" CssClass="clsLabelAuto" ToolTip="Check to apply applicable"
                                                                            Text="Applicable" Checked="<%# mCompMonitorModStatus.IsApplicable %>"></asp:CheckBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtWorkOrdNo" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Work Order No."
                                                                Text="<%# mCompMonitorModStatus.DoneWONo %>" ReadOnly="<%# mCompMonitorModStatus.PartMonitorMod.ID.Equals(Guid.Empty) %>"
                                                                MaxLength="100">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDoneBy" runat="server" CssClass="clsTextBox_Ajax" Text="<%# mCompMonitorModStatus.DoneBy %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPlace" runat="server" CssClass="clsTextBox_Ajax" MaxLength="25"
                                                                Text="<%# mCompMonitorModStatus.Place %>" ToolTip="Enter Place">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtMethodOfCompliance" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" ToolTip="Enter the Remark for the Comp Mod Status"
                                                                Width="250px" Text="<%# mCompMonitorModStatus.MethodOfCompliance %>" ReadOnly="<%# mCompMonitorModStatus.PartMonitorMod.ID.Equals(Guid.Empty) %>"
                                                                TextMode="MultiLine">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" ToolTip="Enter the Remark for the Comp Mod Status"
                                                                Width="250px" Text="<%# mCompMonitorModStatus.DoneRemark %>" ReadOnly="<%# mCompMonitorModStatus.PartMonitorMod.ID.Equals(Guid.Empty) %>"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="chkIsLater" runat="server" CssClass="clsLabelAuto" Text="Calculate Due For Period Whichever Later"
                                                                Enabled="False" Checked="<%# mCompMonitorModStatus.IsLater %>"></asp:CheckBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Current">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtDoneOnValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CurrentValueFormatted") %>'
                                                                                AutoPostBack="true" OnTextChanged="txtDoneOnValue_TextChanged" CssClass="clsTextBoxRightAlignSmall_Ajax">
                                                                            </asp:TextBox>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Due At">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtDueOnValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DueOnValueFormatted") %>'
                                                                                AutoPostBack="true" OnTextChanged="txtDueOnValue_TextChanged" CssClass="clsTextBoxRightAlignSmall_Ajax">
                                                                            </asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtSourceDoc" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                Width="250px" MaxLength="500" Text="<%# mCompMonitorModStatus.SourceDoc %>" TextMode="MultiLine"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtApprovalRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                MaxLength="500" Text="<%# mCompMonitorModStatus.ApprovalRemark %>" TextMode="MultiLine"
        ...
        <div id="DueAtMessage" style="display: none">
            <asp:Panel ID="Panel2" runat="server" Visible="<%# IIf(mCompMonitorModStatus.PartMonitorMod.MonitorTypeID = 1 And Not mCompMonitorModStatus.DoneOn Is System.DBNull.Value = True, True, False) %>">
                Component Modification<br>Status is one time and you have entered Done On date.</br>
            </asp:Panel>
        </div>
