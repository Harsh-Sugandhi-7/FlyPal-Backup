<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptPendingReceiptsOfRentalLease_AJAX.aspx.vb"
    Inherits="Flypal.wfrptPendingReceiptsOfRentalLease_AJAX" %>
...
<head runat="server">
    <title>Pending To Issue, Supplier As Rental/Lease</title>
                ...
                <td>
                    <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td>
                                    <asp:Label ID="lbltitle" CssClass="clstitle1" runat="server">Pending To Issue, Supplier As Rental/Lease</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td align="left" width="67px">
                                                        <span id="lblSupplier" runat="server" class="clsLabel">Supplier</span>
                                                    </td>
                                                    <td align="left">
                                                ...
                                                <tr>
                                                    <td colspan="2" align="left">
                                                        <span id="lblStep2" runat="server" class="clsLabelHeader">Step III. Selection of Store</span>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td width="96px">
                                                ...
                                                <tr>
                                                    <td style="height: 13px">
                                                        <span id="lblFromStore" runat="server" class="clsLabel">Store</span>
                                                    </td>
                                                    <td style="height: 13px">
                                                ...
                                                <tr>
                                                    <td colspan="2" align="left">
                                                        <span id="lblStep3" runat="server" class="clsLabelHeader">Step IV. Selection of Part
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnClose" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                            TabIndex="0" Text="Close" ToolTip="Click to Close Pending To Issue, Supplier As Rental/Lease" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
