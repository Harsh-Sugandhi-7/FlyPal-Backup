<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptAircraftServiceabilityReport_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfrptAircraftServiceabilityReport_Ajax" %>
                ...
                <td>
                    <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="5">
                                    <span id="lbltitle" class="clstitle1">Aircraft Serviceability Report</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5">
                                        ...
                                        <ContentTemplate>
                                            <table cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnExport" runat="server" ClientIDMode="Static" CssClass="clsButton_Ajax" Visible="<%$AppSettings:ShowExportToExcelButton%>"
                                                            TabIndex="0" Text="Export to Excel" ToolTip="Click to Export report" Width="100px" />
                                                    </td>
                                                    <td>
