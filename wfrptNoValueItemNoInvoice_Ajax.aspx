<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptNoValueItemNoInvoice_Ajax.aspx.vb" Inherits="Flypal.wfrptNoValueItemNoInvoice_Ajax" %>
...
<head id="Head1" runat="server">
    <title>No-Value-Item/No-Invoice Report</title>
                ...
                <td>
                    <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="2">
                                    <span id="lbltitle" class="clstitle1">No-Value-Item/No-Invoice Report</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <span id="lblStepI" class="clsLabelHeader">Step I. Selection of Supplier</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <span id="lblStepII" class="clsLabelHeader">Step II. Selection of Store</span>
                                </td>
                            </tr>
                            <tr>
                                                    <td width="96px">
                            ...
                            <tr>
                                <td colspan="2">
                                    <span id="lblStep3" class="clsLabelHeader">Step III. Selection of Part Number Or Description</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnClose" TabIndex="0" runat="server" CssClass="clsButton_Ajax" Text="Close"
                                                            ToolTip="Click to Close No-Value-Item/No-Invoice Report screen" CausesValidation="False">
                                                        </asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
