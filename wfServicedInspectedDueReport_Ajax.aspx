<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfServicedInspectedDueReport_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfServicedInspectedDueReport_Ajax" %>
...
<head runat="server">
    ...
    <title>Equipment Maintenance Due Report</title>
                        ...
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="5" class="clsFormHeader1Newstyle">
                                    <span id="lbltitle" class="clsFormHeader">Equipment Maintenance Due Report</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="5" align="left">
                                    <span id="Label3" class="clsLabelHeader">Step I. Selection of Date</span>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                            ...
                            <tr>
                                <td colspan="5">
                                    <span id="Span1" class="clsLabelHeader">Step III. Selection of Service Inspections</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList ID="cmbListOfItemServiceInspections" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle"
                                        DataValueField="ID" DataTextField="ServiceInspectionName">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5" align="left">
                                    <span id="lblStep3" class="clsLabelHeader">Step III.Selection of Part Number/Description</span>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                        ...
                                        <ContentTemplate>
                                            <table border="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnClose" runat="server" CssClass="clsbtnH clsinfoH1" Text="Close" ToolTip="Click to Close Equipment Maintenance Due Report screen"
