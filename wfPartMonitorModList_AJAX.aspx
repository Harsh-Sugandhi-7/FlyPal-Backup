<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfPartMonitorModList_AJAX.aspx.vb"
    Inherits="Flypal.wfPartMonitorModList_AJAX" %>
...
<head runat="server">
    <title>Part Modification List</title>
...
<body>
            ...
            <td>
                <asp:Panel ID="pnlMain" CssClass="clsPanel1" runat="server">
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td>
                                <asp:Label ID="lblList" runat="server" CssClass="clstitle1">Part Modification List</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                                        ...
                                        <td align="left">
                                            <asp:UpdatePanel ID="upnldgGrid" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:GridView ID="dgPartMonitorMod" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="TypeCode" SortExpression="TypeCode" HeaderText="Type">
                                                              ...
                                                              <asp:BoundField DataField="IssueDateFormatted" SortExpression="IssueDateFormatted" HeaderText="Issue Date">
                                                                <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                            </asp:BoundField>
                                            ...
                                            <asp:UpdatePanel ID="upnlButtons" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <table cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="btnAddNew" runat="server" CssClass="clsButton_Ajax" ToolTip="Add New Part Mod"
                                                                    CausesValidation="False" Text="Add New"></asp:Button>
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Print the list of Part Mods."
                                                                    CausesValidation="False" Text="Print "></asp:Button>
                                                            </td>
                                                            <td>
    ...
    <div>
        ...
        <script type="text/javascript">
            ...
            function OpenModMasterWindow(GChildPageTmp) {
                try {

                    $get("AjaxLoader").style.visibility = 'visible';
                    //$("#IframeModMaster").attr("src", "wfPartMonitorMod_AJAX.aspx?Type=pup&GChildPage4=wfInstallComp_AJAX.aspx");
                    $("#IframeModMaster").attr("src", "wfPartMonitorMod_AJAX.aspx?Type=pup&GChildPage2=wfInstallAssembly_Ajax.aspx&GChildPage4=" + GChildPageTmp);
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForPartMonitorModList();
            return false;
        }
    </script>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
       ...
       SetPageLayout();
       if ($.browser.msie) {
             parent.IframePartMonitorModList();
         }
    });
