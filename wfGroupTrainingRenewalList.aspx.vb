...
Public Class wfGroupTrainingRenewalList
...
#Region " Business Methods "
    ...
    Private Sub ClearAll()
        If Session("MiddleFrame") <> "wfGroupTrainingRenewalList.aspx" Then
    ...
    Private Sub ControlVisibility()
        For j As Integer = 0 To dgTrainingList.Rows.Count - 1
            ...
            P = CType(Me.dgTrainingList.Rows(j).Cells(6).Text, Boolean)
            If P = False Then
                dgTrainingList.Rows.Item(j).Cells(5).Enabled = False
            End If
...
#Region " Data Binding "
    Private Sub DataFieldBind()
        mTrainingListForEmployeeGrouping = TrainingListForEmployeeGrouping.GetTrainingListForEmployeeGrouping(, , , , False) 'Only Recurring Trainings
...
#Region " Events "
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            Session("MiddleFrame") = "wfGroupTrainingRenewalList.aspx"
            DataFieldBind()
        End If
        SetSession()
        ControlVisibility()
    ...
    Private Sub btnFindNow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFindNow.Click
        If cmbSearchType.SelectedValue = 0 Then
            mTrainingListForEmployeeGrouping = TrainingListForEmployeeGrouping.GetTrainingListForEmployeeGrouping(, , , , False)
        ElseIf cmbSearchType.SelectedValue = 1 Then
            mTrainingListForEmployeeGrouping = TrainingListForEmployeeGrouping.GetTrainingListForEmployeeGrouping(, Trim(txtFor.Text), , , False)
        ElseIf cmbSearchType.SelectedValue = 2 Then
            mTrainingListForEmployeeGrouping = TrainingListForEmployeeGrouping.GetTrainingListForEmployeeGrouping(, , txtFor.Text, , False)
        End If
        dgTrainingList.DataSource = mTrainingListForEmployeeGrouping
        dgTrainingList.DataBind()
        Session("mTrainingListForEmployeeGrouping") = mTrainingListForEmployeeGrouping
    ...
    Private Sub dgTrainingList_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles dgTrainingList.RowCommand
        Select Case e.CommandName
            Case "Renew"
                ...
                Dim str As String
                str = "openledgersame('wfGroupTrainingRenewal.aspx?" & "');"
