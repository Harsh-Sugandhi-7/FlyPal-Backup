<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfTaskCardStepSpares_Ajax.aspx.vb" Inherits="Flypal.wfTaskCardStepSpares_Ajax" %>
...
<html>
<head runat="server">
    <title>TaskCard Step Spares</title>
    ...
    <form id="form1" runat="server">
                ...
                <tr>
                    <td colspan="5">
                        <table id="Table2" class="clstablelistin" border="0" cellspacing="1" cellpadding="1">
                            <tr>
                                ...
                                <td class="clsFormHeader1" colspan="2">
                                    <table width ="100%">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblTitle" runat="server" CssClass="clsFormHeader"> Task Card Spares Detail</asp:Label>
                                            </td>
                                            <td  align="right">
                                                <asp:UpdatePanel ID="upnlButtons" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <table id="Table3" border="0" cellspacing="1" cellpadding="1">
                                                            <tr>
                                                                <td>
                                                                    <asp:Button ID="btnOK" runat="server" CssClass="clsbtnH clsinfoH" CausesValidation="True" ValidationGroup="a"
                                                                        Text="OK" ToolTip="Click to Add Additional Work Spare"></asp:Button>
                                                                </td>
                                                                <td>
                                    ...
                                    <asp:UpdatePanel ID="upnlValidationsummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:CustomValidator ID="cvPart" runat="server" CssClass="clsLabelAuto" ErrorMessage="Select Part"
                                                ControlToValidate="txtItemList" Display="None"
                                                OnServerValidate="customvalidate" ValidationGroup="a"></asp:CustomValidator><asp:CustomValidator
                                                    ID="cvDescription" runat="server" CssClass="clsLabelAuto" ErrorMessage="Description must not be greater than 150 characters."
                                                    ControlToValidate="txtDescription" Display="None" OnServerValidate="customvalidate" ValidationGroup="a"></asp:CustomValidator><asp:CustomValidator
                                                        ID="cvReqty" runat="server" CssClass="clsLabelAuto" ErrorMessage="Qty.Required"
                                                        ControlToValidate="txtReqQty" Display="None" OnServerValidate="customvalidate" ValidationGroup="a"></asp:CustomValidator>
                                            <asp:CustomValidator ID="cvRemark" runat="server" CssClass="clsLabelAuto" OnServerValidate="customvalidate" Display="None" ControlToValidate="txtRemark" ErrorMessage="Remark required" ValidationGroup="a"></asp:CustomValidator>
                            ...
                            <tr>
                                <td>
                                    <asp:UpdatePanel ID="upnlSpareDetail" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <fieldset id="fdswodetail" style="padding: 0px 4px 0px 0px; width: auto; z-index: 10000;">
                                                <legend id="ldwodetail" class="clsFieldSet1" runat="server"><b>Spare Details</b></legend>
                                                <table>
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%--<asp:DropDownList ID="cmbItemList" runat="server" CssClass="clsComboBox_Ajax" SelectedValue="<%#  mTaskCard.TaskCardStepsSpares.CurrentItem.ItemID %>"
                                                            DataTextField="Name" DataValueField="ID" AutoPostBack="True">
                                                        </asp:DropDownList>--%>
                                                            <asp:TextBox ID="txtItemList" autocomplete="off" runat="server" CssClass="clsTextBoxTagSearch" ValidationGroup="a" Width="320px"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="left">
                                                            <asp:TextBox ID="txtPartNo" runat="server" CssClass="clsTextBoxTagSearch" Text="<%# mTaskCard.TaskCardStepsSpares.CurrentItem.PartNo %>"
                                                                Enabled="False"></asp:TextBox>
                                                            <asp:Label ID="Label1" runat="server" CssClass="clsLabelAuto">(Type Here If Part No. does not exist in above list)</asp:Label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="margin-left: 40px">
                                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxTagSearchMultilineNewStyleLong"
                                                                Text="<%#  mTaskCard.TaskCardStepsSpares.CurrentItem.Description %>" BackColor="White"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtReqQty" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
                                                                Text="<%# mTaskCard.TaskCardStepsSpares.CurrentItem.RequiredQty %>" MaxLength="5"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblOffSerialNo" runat="server" CssClass="clsLabelAuto">Off Serial No.</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtOffSerialNo" runat="server" CssClass="clsTextBoxTagSearch"
                                                                Text="<%# mTaskCard.TaskCardStepsSpares.CurrentItem.OffSerialNo %>" BackColor="White"
                                                                MaxLength="200" ToolTip="Enter Off Serial No."></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblOnSerialNo" runat="server" CssClass="clsLabelAuto">On Serial No.</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtOnSerialNo" runat="server" CssClass="clsTextBoxTagSearch"
                                                                Text="<%# mTaskCard.TaskCardStepsSpares.CurrentItem.OnSerialNo  %>" BackColor="White"
                                                                MaxLength="200" ToolTip="Enter On Serial No."></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxTagSearchMultilineNewStyleLong"
                                                                Text="<%# mTaskCard.TaskCardStepsSpares.CurrentItem.Remark %>" TextMode="MultiLine"
                                ...
                                <asp:UpdatePanel ID="upnlButtons" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table id="Table3" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnOK" runat="server" CssClass="clsButton_Ajax" CausesValidation="True" ValidationGroup="a"
                                                        Text="OK" ToolTip="Click to Add Additional Work Spare"></asp:Button>
                                                </td>
                                                <td>
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForTaskCardStepsSpare();
                return false;
            }
        </script>
        <%--End--%>
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
                $(document).ready(function () {
                    SetPageLayout();
                    if ($.browser.msie) {
                        parent.IFrameTaskCardStepsSpareStateComplete();
                    }
