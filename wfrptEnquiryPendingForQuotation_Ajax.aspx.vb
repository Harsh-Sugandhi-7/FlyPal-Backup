Public Class wfrptEnquiryPendingForQuotation_Ajax
...
#Region " Helper Methods "
    ...
    Private Sub SetReport()
        ...
        Dim rpt As EnquiryPendingForQuotation
        Dim mCompanyDetail As New CompanyDetail
        Dim da As New CSLA.Data.ObjectAdapter
        Dim SearchStrin3 As String = ""
        SetValues()
        Dim ds As New dsEnquiryPendingForQuotation
        myReport = New crptEnquiryPendingForQuotation
        rpt = EnquiryPendingForQuotation.GetEnquiryPendingForQuotationList(FromDate, ToDate, PartNo, Description)
        If rpt.Count <= 0 Then
        ...
        Dim Report As New ReportData(mCompanyDetail.CompanyName, mCompanyDetail.Address, _
                           ...
                           mCompanyDetail.WebSite, "Enquiry Pending For Quotation", SearchStr1:=New SmartDate(FromDate).FormattedText, _
                           SearchStr2:=New SmartDate(ToDate).FormattedText, SearchStr3:=PartNo, SearchStr4:=Description, SearchStr5:="", _
...
#Region " Events "
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            Session("MiddleFrame") = "wfrptEnquiryPendingForQuotation_Ajax.aspx?"
