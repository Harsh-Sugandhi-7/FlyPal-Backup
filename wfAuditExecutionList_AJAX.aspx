<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAuditExecutionList_AJAX.aspx.vb"
    Inherits="Flypal.wfAuditExecutionList_AJAX" %>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <span id="lblAuditExecutionList" class="clsFormHeader">Audit Compliance List</span>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                            <td align="right">
                                                <asp:UpdatePanel ID="upnlActionBtnTop" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:Button ID="btnAddTop" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to Add New Audit Compliance "
                                                                        Text="Add New"></asp:Button>
                                                                </td>
                                                                <td align="right">
                                                                    <asp:Button ID="btnCloseTop" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to close Audit Compliance List screen"
                                            ...
                                            <%--<fieldset id="Fieldset1" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                                            <table id="Table1" cellspacing="0">
                                                                <tr>
                                                                    <td></td>
                                                                    <td>
                                                                        <asp:DropDownList ID="cmbSearch" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle" Width="170px" CausesValidation="true" ValidationGroup="b"
                                                                            AutoPostBack="True">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtSearchText" runat="server" CssClass="clsTextBoxTagSearch" ToolTip="Enter Search Text" CausesValidation="true" ValidationGroup="b"
                                                        ...
                                                        <td align="right">
                                                            <asp:Button ID="btnFindNow" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to find Audit Compliance List as per searching criteria"
                                    ...
                                    <asp:UpdatePanel ID="upnlGrid" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblResult" runat="server" CssClass="clsLabelHeader">List of Audit Compliance as per criteria :   Record(s) found.</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:GridView ID="dgAuditExecution" runat="server" CssClass="clsGridNewStyle" AllowSorting="True"
                                                            ShowHeaderWhenEmpty="true" PageSize="25" AllowPaging="True" AutoGenerateColumns="False" CellPadding="10" GridLines="Horizontal">
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnAdd" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Add New Audit Compliance"
                                                            Text="Add New" Visible="false"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnClose" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to close Audit Compliance List screen"
