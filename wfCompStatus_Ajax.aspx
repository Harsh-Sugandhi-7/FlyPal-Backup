<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompStatus_Ajax.aspx.vb"
    Inherits="Flypal.wfCompStatus_Ajax" %>
...
<body bottommargin="5" leftmargin="5" topmargin="5" ms_positioning="GridLayout">
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table width="100%" style="background: #4A63A0;">
                                <tr>
                                    <td>
                                        <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Component Status Details</asp:Label>
                                    </td>
                                    <td align="right" style="padding: 0px;">
                                        <asp:ImageButton runat="server" ImageUrl="~/images/home.png" ID="imgHome" Height="17px"
                                            Width="20px" ToolTip="Click to return to Machine Detail Page" Visible="false"
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="upnlContainer" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <cc2:TabContainer ID="TbContInst" runat="server" AutoPostBack="true" ActiveTabIndex="3">
                                        ...
                                        <asp:UpdatePanel ID="upnlComponentDetails" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table border="0" class="clsTablelistin" id="tblinner" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <td colspan="2">
                                                            <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <asp:CustomValidator ID="cvinstalleddate" runat="server" CssClass="clsLabelAuto"
                                                                        ErrorMessage="Installation date should be prior to As on date." ControlToValidate="txtInstalledOnDate"
                                                                        Display="None" OnServerValidate="CustomValidate"></asp:CustomValidator>
                                                                    <asp:CustomValidator ID="cvInstallationReasonLen" runat="server" ErrorMessage="Max length of Installation Remark should be 1000."
                                                                        ControlToValidate="txtInstallationReason" Display="None" OnServerValidate="customvalidate"
                                                                        CssClass="clsLabelAuto"></asp:CustomValidator>
                                                                    ...
                                                                    <fieldset id="Fieldset4" class="clsFieldSet" style="border-width: 1px;">
                                                                        ...
                                                                        <table>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <asp:TextBox ID="txtPartDescription" autocomplete="off" runat="server" CssClass="clsTextBox1_Ajax"
                                                                                                            Text="<%# mCompStatus.Comp.PartName %>" Width="220px" AutoPostBack="True" onfocus="SetContextKey()"></asp:TextBox>
                                                                                                        <cc2:AutoCompleteExtender ID="txtPartDescription_Autocomplete" runat="server" ClientIDMode="Static"
                                                                                                            ...
                                                                                                            ServicePath="wfCompStatus_Ajax.aspx" TargetControlID="txtPartDescription" UseContextKey="True"
                                                                                                            ContextKey="">
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <asp:CheckBox ID="chkByModel" runat="server" AutoPostBack="True" CssClass="clsCheckBox"
                                                                                                            ...
                                                                                                            Enabled="<%# mCompStatus.IsPartEnabled %>"></asp:CheckBox>
                                                                                                        <script type="text/javascript">
                                                                                                            function SetContextKey() {
                                                                                                                var autoComplete = $find('txtPartDescription_Autocomplete');
                                                                                                                var IsModelChecked = $get("chkByModel").checked;
                                                                                                                var str = 'IsByModel=' + IsModelChecked + '¿ModelID=<%=mAssemblyStatus.Assembly.ModelID%>';
                                                                            ...
                                                                            <tr>
                                                                                <td></td>
                                                                                <td>
                                                                                    <span id="lblPosition" class="clsLabelAuto">Position</span>
                                                                                </td>
                                                                                <td></td>
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtPostion" runat="server" CssClass="clsTextBox2_Ajax" ToolTip="Enter Position"
                                                                                        Text="<%# mCompStatus.Position %>" MaxLength="50" Width="225px"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td></td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" colspan="3" style="height: 40px">
                                                                                    <asp:UpdatePanel ID="upnlHistoryCard" runat="server" UpdateMode="Conditional" Visible="<%# Not mCompStatus.IsNew %>">
                                                                                        <ContentTemplate>
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <td></td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="right">
                                                                                                        <img wwidth="25px" height="25px" style="border: 0" alt="" src="images/HistoryCard.png" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </ContentTemplate>
                                                                            ...
                                                                            <tr>
                                                                                <td></td>
                                                                                <td>
                                                                                    <asp:Label ID="lblACF" runat="server" CssClass="clsLabelAuto" Visible="False">ACF </asp:Label>
                                                                                </td>
                                                                                <td></td>
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtACF" runat="server" ToolTip="Enter Position" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                        ClientIDMode="Static" Text="<%# mCompStatus.Comp.ACF %>" MaxLength="25" Visible="False">
                                                                                    </asp:TextBox>&nbsp;&nbsp;&nbsp; &nbsp;
                                                                                <asp:Label ID="lblECF" runat="server" CssClass="clsLabelAuto" Visible="False">ECF</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <asp:TextBox ID="txtECF" runat="server" ToolTip="Enter Position" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                    ClientIDMode="Static" Text="<%# mCompStatus.Comp.ECF %>" MaxLength="25" Visible="False">
                                                                                </asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td></td>
                                                                                <td>
                                                                                    <asp:Label ID="lblFCF" runat="server" CssClass="clsLabelAuto" Visible="False">FCF</asp:Label>
                                                                                </td>
                                                                                <td></td>
                                                                                <td align="left">
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:TextBox ID="txtFCF" runat="server" ToolTip="Enter Position" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                    ClientIDMode="Static" Text="<%# mCompStatus.Comp.FCF %>" MaxLength="25" Visible="False">
                                                                                                </asp:TextBox>
                                                                                            </td>
                                                                                            <td>&nbsp;&nbsp;&nbsp;</td>
                                                                                            <td>
                                                                                                <asp:Label ID="lblRTCF" runat="server" CssClass="clsLabelAuto" Visible="False">RTCF</asp:Label>&nbsp;&nbsp;&nbsp;
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:TextBox ID="txtRTCF" runat="server" ToolTip="Enter RTCF" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                    ClientIDMode="Static" Text="<%# mCompStatus.Comp.RTCF %>" MaxLength="25" Visible="False">
                                                                                                </asp:TextBox>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <asp:UpdatePanel ID="upnlIsThrustCompOuter" runat="server" UpdateMode="Conditional">
                                                                                                    <ContentTemplate>
                                                                                                        <asp:UpdatePanel ID="upnlIsThrustComp" runat="server" UpdateMode="Conditional">
                                                                                                            <ContentTemplate>
                                                                                                                <asp:Panel ID="pnlThrustyComponentOnOFF" runat="server" ClientIDMode="Static">
                                                                                            ...
                                                                                            <td align="right" style="width: 55%">
                                                                                                <asp:UpdatePanel ID="upnlThrustyComponentDet" runat="server" UpdateMode="Conditional">
                                                                                                    <ContentTemplate>
                                                                                                        <asp:Panel ID="pnlThrustyComponentDet" runat="server" ClientIDMode="Static">
                                                                                                            <div class="dropdown">
                                                                                                                        ...
                                                                                                                        <div>
                                                                                                                            <table class="clsGrid">
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td class="clsdgHeader" style="font-style: italic; font-size: 9pt" align="center">
                                                                                                                                        <span id="Span4" class="clsLabelHeaderForCollapse" style="height: 40px" runat="server">Monitor with </span>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                    ...
                                                                                                                                    <td align="center">
                                                                                                                                        <asp:TextBox ID="txtB22Current" runat="server" Height="20px" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                                                            ClientIDMode="Static" Text="<%# mCompStatus.B22CurrentValue %>"></asp:TextBox>
                                                                                                                                    </td>
                                                                                                                                    <td align="center">
                                                                                                                                        <asp:TextBox ID="txtB22LifeLimit" runat="server" Height="20px" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                                                            onchange="setattr(this);" ClientIDMode="Static" Text="<%# mCompStatus.B22LifeLimit %>"></asp:TextBox>
                                                                                                                                    </td>
                                                                                                                                    <td align="center">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td align="center">
                                                                                                                                        <asp:TextBox ID="txtB24Current" runat="server" Height="20px" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                                                            ClientIDMode="Static" Text="<%# mCompStatus.B24CurrentValue %>"></asp:TextBox>
                                                                                                                                    </td>
                                                                                                                                    <td align="center">
                                                                                                                                        <asp:TextBox ID="txtB24LifeLimit" runat="server" Height="20px" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                                                            onchange="setattr(this);" ClientIDMode="Static" Text="<%# mCompStatus.B24LifeLimit %>"></asp:TextBox>
                                                                                                                                    </td>
                                                                                                                                    <td align="center">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td align="center">
                                                                                                                                        <asp:TextBox ID="txtB26Current" runat="server" Height="20px" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                                                            ClientIDMode="Static" Text="<%# mCompStatus.B26CurrentValue %>"></asp:TextBox>
                                                                                                                                    </td>
                                                                                                                                    <td align="center">
                                                                                                                                        <asp:TextBox ID="txtB26LifeLimit" runat="server" Height="20px" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                                                                            onchange="setattr(this);" ClientIDMode="Static" Text="<%# mCompStatus.B26LifeLimit %>"></asp:TextBox>
                                                                                                                                    </td>
                                                                                                                                    <td align="center">
                                                                                ...
                                                                                <td valign="top">
                                                                                    <asp:GridView ID="dgCurrentCompValue" runat="server" CssClass="clsGridLog" AutoGenerateColumns="False"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundField DataField="AssemblyCurrentValueFormatted" HeaderText="Assembly">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtFanBladePosition" runat="server" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                        ClientIDMode="Static" Text="<%# mCompStatus.FanBladePosition %>"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <span id="Span6" class="clsLabel" runat="server">Moment Weight </span>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtMomentWeight" runat="server" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                        onchange="setattr(this);" ClientIDMode="Static" Text="<%# mCompStatus.MomentWeight %>"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <span id="Span7" class="clsLabel" runat="server">Balance Screw </span>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtBalanceScrew" runat="server" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                        onchange="setattr(this);" ClientIDMode="Static" Text="<%# mCompStatus.BalanceScrew %>"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </fieldset>
                                                            ...
                                                            <asp:UpdatePanel ID="upnlInstallationInfo" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <fieldset id="Fieldset1" class="clsFieldSet" style="border-width: 1px;">
                                                                        <legend id="lblInstallationCaption" style="font-weight: bold;">Installation Information
                                                                        of Component</legend>
                                                                        <table>
                                                                            <tr>
                                                                                <td style="width: 8px;"></td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox runat="server" ID="txtInstalledOnDate" CssClass="clsTextBox_Ajax" Width="100px"
                                                                                        AutoPostBack="true" onchange="ValidateDateText(this,'InstalledOnDate_watermarkextender','false');"></asp:TextBox>
                                                                            ...
                                                                            <tr>
                                                                                <td></td>
                                                                                <td>
                                                                                    <span id="lblInstallationReason" class="clsLabelAuto">Installation Remark</span>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtInstallationReason" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                                        Width="223px" ToolTip="Enter Installation Remark" Text="<%# mCompStatus.InstallationReason %>"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtWorkOrderNo" runat="server" CssClass="clsTextBox2_Ajax" ToolTip="Enter Work Order Number"
                                                                                        Text="<%# mCompStatus.InstallationWONo %>" MaxLength="25" Width="225px"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td></td>
                                                            ...
                                                            <asp:UpdatePanel ID="upnlInstallationValues" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <fieldset id="Fieldset2" class="clsFieldSet" style="border-width: 1px;">
                                                                        <legend id="lblAssemblyValues" style="font-weight: bold;">Values at
                                                                        <asp:DropDownList ID="cmbInstallationStatus" runat="server" AutoPostBack="true" Width="130px"
                                                                            DataTextField="Name" DataValueField="ID" CssClass="clsComboBox_Ajax" SelectedValue="<%# mCompStatus.InstallationStatusID %>">
                                                                        </asp:DropDownList>
                                                                        </legend>
                                                                        <asp:GridView ID="dgInstallationValues" runat="server" CssClass="clsGridLog" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Component" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtCompInstallationValue" runat="server" ToolTip="Enter Current Values for Component"
                                                                                            CausesValidation="false" ClientIDMode="Static" AutoPostBack="true" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                            Text='<%# DataBinder.Eval(Container.DataItem, "CompInstallationValueFormatted") %>'
                                                                                            MaxLength="50" OnTextChanged="txtCompInstallationValue_TextChanged">
                                                                                        </asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Assembly">
                                                                                    ...
                                                                                    <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtAssemblyInstallationValue" runat="server" ToolTip="Enter Current Values for Component"
                                                                                            CausesValidation="false" ClientIDMode="Static" AutoPostBack="true" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                            Text='<%# DataBinder.Eval(Container.DataItem, "AssemblyInstallationValueFormatted") %>'
                                                                                            OnTextChanged="txtAssemblyInstallationValue_TextChanged" MaxLength="50">
                                                                                        </asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <fieldset id="fdsDocumentStatusDetails" class="clsFieldSet" style="border-width: 1px">
                                                                <legend id="lblDocumentStatusDetails" style="font-weight: bold"><b>Document Details</b></legend>
                                                                <table width="100%">
                                                                    <tr>
                                                                        <td style="width: 8px;"></td>
                                                                        <td style="width: 115px;">
                                                                            <span id="lblSourceDoc" class="clsLabelAuto">Source Doc.</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtSourceDoc" runat="server" ToolTip="Enter Source Doc." CssClass="clsTextBoxMultiLine1_Ajax"
                                                                                Width="222px" Text="<%# mCompStatus.SourceDoc %>" TextMode="MultiLine" MaxLength="1000"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <span id="lblRevisionNo" class="clsLabelAuto">Revision No.</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtRevisionNo" runat="server" ToolTip="Enter Revision No." CssClass="clsTextBox2_Ajax"
                                                                                Text="<%# mCompStatus.RevisionNo %>" MaxLength="50">
                                                                            </asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td></td>
                                                                        <td>
                                                                            <span id="lblBookNo" class="clsLabelAuto">Book No.</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtBookNo" runat="server" ToolTip="Enter Book No." CssClass="clsTextBox2_Ajax"
                                                                                Text="<%# mCompStatus.BookNo %>" MaxLength="25" Width="225px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <span id="lblPageNo" class="clsLabel">Page No.</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtPageNo" runat="server" ToolTip="Enter Page No." CssClass="clsTextBox2_Ajax"
                                                                                Text="<%# mCompStatus.PageNo %>" MaxLength="25">
                                                                            </asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <table border="0" id="Table1" cellspacing="0">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Save the page."
                                                                                    Text="Save"></asp:Button>
                                                                            </td>
                                                                            <td>
                                                                                <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax"  Visible ="false" ToolTip="Click to Print the page."
                                                    ...
                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="cmbLookInService" runat="server" CssClass="clsComboBox_Ajax"
                                                                         ...
                                                                         <%--   <asp:ListItem Value="2">Task Type</asp:ListItem>--%>
                                                        ...
                                                        <td align="right">
                                                            <table>
                                                                <tr>
                                                                    <td align="right">
                                                                        <asp:Button ID="btnFindNowService" runat="server" ToolTip="Click to Find the list as per searching criteria."
                                                            ...
                                                            <asp:UpdatePanel ID="upnlActionBtnServiceTop" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <table id="Table4" cellspacing="0">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Button ID="btnAddNewTopService" TabIndex="0" runat="server" ToolTip="Click to Add new"
                                                                                    CssClass="clsButton_Ajax" CausesValidation="False" Text="Add New"></asp:Button>
                                                                            </td>
                                                                            <td>
                                                                                <asp:Button ID="btnPrintTopService" TabIndex="0" runat="server" ToolTip="Click to Print the List"
                                                            ...
                                                            <asp:GridView ID="dgMonitorServiceStatusList" runat="server" CssClass="clsGrid" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="TaskNo" SortExpression="TaskNo" HeaderText="Task No.">
                                                                      ...
                                                                      <asp:BoundField DataField="ServiceTypeCode" SortExpression="ServiceTypeCode" HeaderText="Task Type">
                                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Reference" SortExpression="Reference" HeaderText="Reference Doc.">
                                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                                    </asp:BoundField>                                                                                                                                                                                                      
                                                                    <asp:BoundField DataField="DoneOnFormatted" HeaderText="Compliance Date">
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    ...
                                                                    <asp:BoundField DataField="DoneOnValueFormatted" HeaderText="Compliance At " HtmlEncode="false">
                                                            ...
                                                            <asp:UpdatePanel ID="upnlActionBtnService" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <table id="Table5" cellspacing="0">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Button ID="btnAddNewService" runat="server" ToolTip="Click to Add New"
                                                                                    CssClass="clsButton_Ajax" CausesValidation="False" Text="Add New"></asp:Button>
                                                                            </td>
                                                                            <td>
                                                                                <asp:Button ID="btnPrintService" runat="server" ToolTip="Click to Print the List"
                                                                                    CssClass="clsButton_Ajax" CausesValidation="False" Text="Print"></asp:Button>
                                                                            </td>
                                                                            <td>
                                        ...
                                        <asp:UpdatePanel ID="upnlInspection" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table id="Table3" class="clsTablelistin">
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="lblInfoInspection" runat="server" CssClass="clsLabelAuto">List of all the Inspections on the Component as of Date: [As of Date]. All the values of all the Inspections will be as of Date: [As on Date]</asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Directive Number" ItemStyle-Width="30">
                                                                        <ItemTemplate>
                                                                            <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" NavigateUrl='<%# Eval("RefAttachlink") %>'
                                                                                Text='<%# Eval("ModNumber") %>' ToolTip='<%# Eval("RefAttachlink") %>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Reference" SortExpression="Reference" HeaderText="Reference">
                                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
        ...
        <script type="text/javascript">
            ...
            function OpenSeriviceMasterWindow() {
                try {
                    ...
                    $("#IframeSeriviceMaster").attr("src", "wfPartMonitorService_AJAX.aspx?Type=pup&GChildPage4=wfCompStatus_Ajax.aspx&GChildPage2=" + GChildPage2);
        ...
        <script type="text/javascript">
            ...
            function OpenInspMasterWindow() {
                try {
                    ...
                    $get("AjaxLoader").style.visibility = 'visible';
                    var GChildPage2 = window.location.search.split('GChildPage2')[1].split('=')[1];
                    $("#IframeInspMaster").attr("src", "wfPartMonitorInsp_AJAX.aspx?Type=pup&GChildPage4=wfCompStatus_AJAX.aspx&GChildPage2=" + GChildPage2);
        ...
        <script type="text/javascript">
            ...
            function OpenModMasterWindow() {
                try {
                    ...
                    $get("AjaxLoader").style.visibility = 'visible';
                    var GChildPage2 = window.location.search.split('GChildPage2')[1].split('=')[1];
                    $("#IframeModMaster").attr("src", "wfPartMonitorMod_AJAX.aspx?Type=pup&GChildPage4=wfCompStatus_AJAX.aspx&GChildPage2=" + GChildPage2);
    ...
    <script type="text/javascript">
        ...
        //        $('.ui.toggle.checkbox').checkbox('setting', 'onChange', function () {
        //            alert("Changed");
        //        });
