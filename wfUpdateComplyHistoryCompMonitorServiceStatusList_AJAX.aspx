<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfUpdateComplyHistoryCompMonitorServiceStatusList_AJAX.aspx.vb"
    Inherits="Flypal.wfUpdateComplyHistoryCompMonitorServiceStatusList_AJAX" %>
...
<head id="Head1" runat="server">
    ...
    <title>Component Service Status History</title>
    ...
    <form id="frmgroup" method="post" runat="server">
                ...
                <td>
                    <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td colspan="1">
                                    <span id="lbltitle" runat ="server"  class="clstitle1">History for Component Service Status</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="1">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBox2_Ajax" ReadOnly="True"
                                                                            BackColor="#E0E0E0" TextMode="MultiLine" Height="20px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="style1">
                                                ...
                                                <asp:UpdatePanel ID="upnlServiceInfo" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <fieldset id="Fieldset1" class="clsFieldSet" style="border-width: 1px">
                                                            <legend id="lblServiceInformation" runat="server" style="font-weight: bold"><b>Service Information</b></legend>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <asp:PlaceHolder ID="PlaceHolder2" runat="server" Visible='<%#IIf(AppSettings("ShowMaintenanceForNewClients") = "True", True, False) %>'>
                                                                        <td>
                                                                            <span id="lblTaskNo" class="clsLabelAuto">Task No.</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtTaskNo" runat="server" CssClass="clsTextBox_Ajax" BackColor="#E0E0E0"
                                                                                ReadOnly="True" Width="225px"></asp:TextBox>
                                                                        </td>
                                                                    </asp:PlaceHolder>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtMonitorInfo" runat="server" CssClass="clsTextBox1_Ajax" BackColor="#E0E0E0"
                                                                            ReadOnly="True" Width="225px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="style1">
                                                                        <asp:Label ID="lblReference" runat="server" CssClass="clsLabelAuto">Reference Doc.</asp:Label>
                                                                    </td>
                                                                    <td class="style1">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="lblFrequency" runat="server" Style="display: none;" CssClass="clsLabelAuto">Threshold</asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtFrequency" runat="server" Visible="false" CssClass="clsTextBox2_Ajax"
                                                                            BackColor="#E0E0E0" ReadOnly="True" TextMode="MultiLine" Height="20px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </fieldset>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSaveNewTop" runat="server" CssClass="clsButton_Ajax" Text="Save"
                                                            ToolTip="Click to Save Service"></asp:Button>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnBackTop" runat="server" CssClass="clsButton_Ajax" Text="Close"
                                                            ToolTip="Click to close Component Service Status screen" CausesValidation="False"></asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
                            ...
                            <tr>
                                <td colspan="1">
                                    <asp:UpdatePanel ID="upnlGrid" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgMonitorServiceStatusList" runat="server" CssClass="clsGrid" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField Visible="False" DataField="PartMonitorServiceID" HeaderText="PartMonitorServiceID"></asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="DoneOnValueFormatted" HeaderText="Compliance Value" HtmlEncode="False">
                                                        <ItemStyle Wrap="False" />
                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Actual Man Hours" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRequiredManHours" runat="server" CssClass="clsTextBoxRightAlignSmall1_Ajax"
                                                                Enabled="false" ToolTip="Enter Required Man Hours" Text='<%# DataBinder.Eval(Container.DataItem, "TotalRequiredManHoursFormatted") %>'
                                                                MaxLength="8">
                                                            </asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSaveNew" runat="server" CssClass="clsButton_Ajax" Text="Save"
                                                            ToolTip="Click to Save"></asp:Button>
                                                    </td>
                                                    <td>
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForCompServiceHistory();
                return false;
            }
        </script>
        <%--End--%>
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
                $(document).ready(function () {
                    SetPageLayout();
                    if ($.browser.msie) {
                        parent.IFrameCompServiceHistoryStateComplete();
                    }
