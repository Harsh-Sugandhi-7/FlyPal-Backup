'Created By Saylee On 24-May-2019

Public Class wfnWOPlannedList
...
#Region " Variable Declaration "
	...
	Dim IsPlannedTicked As Boolean
...
#Region " Business Methods "
	...
	Private Sub GetSession()
		...
		IsPlannedTicked = Session("IsPlannedTicked")
	...
	Private Sub SetSession()
		...
		Session("IsPlannedTicked") = IsPlannedTicked
	...
	Private Sub RemoveSession()
		...
		Session.Remove("mWOPlanningList")
		...
		Session.Remove("IsPlannedTicked")
	...
	Private Sub ClearAll()
		...
		If InStr(Session("MiddleFrame"), "wfnWOPlannedList.aspx?") <= 0 Then
			RemoveSession()
			Session.Remove("WOPlannedList")
		End If
	End Sub
	...
	Private Sub SetTitle()
		...
		lblTitle.Text = "List of Planning Work Order" ' [Total No of Record(s):-" + totcnt.ToString() + "]"
	End Sub
	...
	Private Sub setVariables()
		...
		No = txtNo.Text.Trim
		IsPlannedTicked = chkShowPlannedWO.Checked
	...
	Private Sub SetToolTip()
		If (AppSettings("ClientCode") IsNot Nothing) AndAlso (AppSettings("ClientCode") = "TAAL" Or AppSettings("ClientCode") = "GlobalJet") Then
			lblTitle.Text = "List of Planning Engineering Order"
		...
		Else
			lblTitle.Text = "List of Planning Work Order"
	...
	Private Sub SetControl()
		...
		txtNo.Text = No
		chkShowPlannedWO.Checked = IsPlannedTicked
		...
		If (AppSettings("ClientCode") IsNot Nothing) AndAlso (AppSettings("ClientCode") = "TAAL" Or AppSettings("ClientCode") = "GlobalJet") Then
			...
			dgWOList.DataBind()
			lblResult.Text = "List for Engineering Order as per criteria :" & mWOList.Count & " Record(s) found."
		Else
			dgWOList.Columns(2).HeaderText = "W.O. No."
			dgWOList.Columns(11).HeaderText = "W.O. Status"

			dgWOList.DataBind()
			lblResult.Text = "List for Work Order as per criteria :" & mWOList.Count & " Record(s) found."
		End If
		GridColumnsVisibility()
	End Sub
	...
	Private Sub FindNow(Optional ByVal Text As String = "", Optional ByVal No As Int32 = 0, Optional ByVal FromDate As String = "", Optional ByVal ToDate As String = "", Optional ByVal RegNo As String = "", Optional ByVal ModelName As String = "", Optional ByVal WOStatusID As Integer = 0, Optional ByVal StatusID As Integer = 0, Optional ByVal AddTopItem As String = "")
		...
		If IsPlannedTicked = True Then WOStatusID = 4
		...
		Else
			dgWOList.Columns(15).HeaderText = "Plan"
		End If

		mWOList = nWOList.GetWOList(Text, No, FromDate, ToDate, RegNo, ModelName, StatusID, WOStatusID, AddTopItem, , mTransTypeID)
	...
	Private Sub CallFindNow(ByVal Index As Integer)
		...
		'End Select
		FindNow(WOText, CInt(Val(No)), txtFromDate.Text.ToString, txtToDate.Text.ToString, RegNo:=RegNo, ModelName:=ModelName, WOStatusID:=1, StatusID:=2)
	End Sub
	...
	Private Sub ControlVisibility(Optional ByVal index As Int32 = 0)
		...
		If chkShowPlannedWO.Checked Then  'Added by Saylee on 14-Jan-2020
			chkShowAllWOs.Checked = False
			phStatus.Visible = False
		ElseIf chkShowAllWOs.Checked = True Then
			chkShowPlannedWO.Checked = False
...
#Region "DataFieldBind"
	...
	Private Sub SetGrid()
		...
		For j As Integer = 0 To dgWOList.Rows.Count - 1
			...
			' img = dgWOList.Rows.Item(j).Cells(18).FindControl("View")
...
#Region "Events"
	Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		...
		If Not IsPostBack Then
			Session("MiddleFrame") = "wfnWOPlannedList.aspx?"
			DataFieldBind()
			SetControl()
		Else
			dgWOList.DataSource = mWOList
	...
	Private Sub dgWOList_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles dgWOList.RowCommand
		Select Case e.CommandName
			Case "EditRec"
				...
				Dim mDate As String = mWOList(mID).WODateFormatted
				Dim mWorkOrderNo As String = mWOList(mID).WONumber
				Dim mCreatedBy As String = mWOList(mID).WOBy
				Dim mRegNo As String = IIf(mWOList(mID).RegNo = "", "", mWOList(mID).RegNo)
				Dim mModel As String = IIf(mWOList(mID).ModelName = "", "", mWOList(mID).ModelName)
				Dim mSerialNo As String = mWOList(mID).SerialNo
				...
				If chkShowAllWOs.Checked And Not (cmbStatus.SelectedIndex = 2 Or cmbStatus.SelectedIndex = 4) Then  'Added by Saylee on 14-Jan-2020
				...
				Else
					...
					If mFileAttach.Size > 0 Then
						...
						If File.Exists(AppSettings("DOCPath")) = False Then
							...
							MarkLog(Util.Action.View, "Work Order", Detail, Util.ErrorType.HandledError, mWOList(Idx).ID, EventLogID)
						End If
					End If
				End If
		End Select
	...
	End Sub
	Private Sub chkShowPlannedWO_CheckedChanged(sender As Object, e As System.EventArgs) Handles chkShowPlannedWO.CheckedChanged  'Added by Saylee on 14-Jan-2020
		chkShowAllWOs.Checked = False
		phStatus.Visible = False
		cmbStatus.SelectedIndex = 0
	End Sub
