<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCompMonitorServiceStatusGroupConfigureFromMPD_Ajax.aspx.vb" Inherits="Flypal.wfCompMonitorServiceStatusGroupConfigureFromMPD_Ajax" %>
...
<body>
            ...
            <td>
                <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                    <table id="tblinner" class="clstablelistin">
                        <tr>
                            <td colspan="2">
                                <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">MPD Configuration</asp:Label>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                                ...
                                <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:CustomValidator ID="CustomValidator1" runat="server" CssClass="clsLabelAuto"
                                            OnServerValidate="customvalidate" ErrorMessage="Remark too long." Display="None"
                            ...
                            <td valign="top">
                                <fieldset id="fdsMonitoringDetails" class="clsFieldSet" style="border-width: 1px;">
                                    ...
                                    <table border="0" id="Table3" class="clsTable1" cellpadding="0" width="100%">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="upnlSelectMonitoringService" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:Button ID="btnSelectMonitoringService" runat="server" CssClass="clsButtonVeryLong"
                                                            CausesValidation="False" Text="Select Monitoring Inpsection" ToolTip="Click to open Model Service List screen">
                                                        </asp:Button>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="125px">
                                                <span id="lblMonitorServiceType" class="clsLabelAuto">Service. Type</span>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtMonitorServiceType" runat="server" CssClass="clsTextBox_Ajax"
                                                    Text="<%# mAssemblyMonitorServiceStatus.ModelMonitorService.ModelMonitorServiceTypeName %>"
                                                    ToolTip="Enter Service Type" ReadOnly="True" BackColor="#E0E0E0">
                                                </asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:CheckBox ID="chkApplicable" runat="server" CssClass="clsLabelAuto" ToolTip="Check to apply applicable"
                                                                        Checked="true" Text="Applicable"></asp:CheckBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <cc2:AutoCompleteExtender ClientIDMode="Static" ID="txtLicenceNo_Autocomplete" runat="server"
                                                                                ...
                                                                                CompletionInterval="1" ServicePath="wfCompMonitorServiceStatusGroupConfigureFromMPD_Ajax.aspx"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" Width="250px"
                                                            ToolTip="Enter the Remark for the Component Service Status" MaxLength="500"
                                                            TextMode="MultiLine">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="dgDoneOnValue" runat="server" CssClass="clsGridLog" PageSize="3"
                                                            DataKeyNames="PeriodID" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                                                            <AlternatingRowStyle CssClass="clsdgAltItem" />
                                                            <RowStyle CssClass="clsdgItem" />
                                                            <HeaderStyle CssClass="clsdgHeader" />
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="CompCurrentValueFormatted" HeaderText="Current">
                                                                    <HeaderStyle HorizontalAlign="Right" />
                                                                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                                </asp:BoundField>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtRevisionNo" runat="server" CssClass="clsTextBox_Ajax" MaxLength="50"
                                                            ToolTip="Enter Revision No."></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtSourceDoc" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                            Width="250px" MaxLength="500" TextMode="MultiLine" ToolTip="Enter Source Doc.">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtApprovalRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                            MaxLength="500" TextMode="MultiLine" ToolTip="Enter Approval Remark"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
                            ...
                            <td align="left">
                                <asp:UpdatePanel ID="upnlRedLabel" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:Label ID="lblInfo" runat="server" Text="Complied one time Service record"
                                ...
                                <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table border="0" id="Table1" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Component Service"
                        ...
                        <tr>
                            <td colspan="2">
                                <span class="clsLabelHeader">Following MPD(s) will be configured on Save </span>
                            </td>
                        </tr>
                        <tr>
    ...
    <!-- End -->
    <!-- Component Service Maintenance Done By Employee Dialog-->
    <div style="display: none">
