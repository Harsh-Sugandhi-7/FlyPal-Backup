Public Class APPNotificationRequisitionDet
...
#Region "Variable Declaration"
    ...
    Public mApp_RequisitionNew As RequisitionNew
    Dim RequisitionID As Guid
#End Region
...
#Region "Helper Method"
    ...
    Private Sub GetSession()
        ...
        mApp_RequisitionNew = Session("mApp_RequisitionNew")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                RequisitionID = New Guid(Request.QueryString("ModuleID"))

                Dim mAPP_UserNotification As APP_UserNotification = APP_UserNotification.GetAPP_UserNotification(NotificationID)

                Dim mApp_RequisitionNew As RequisitionNew = RequisitionNew.GetRequisition(RequisitionID)

                Session("mApp_RequisitionNew") = mApp_RequisitionNew

                Session("APPNotificationFlightDet.NotificationID") = NotificationID

                lblTotalrecordCount.Text = "Parts(s) has been requested by " + mApp_RequisitionNew.UserName + " in Requisition " + mApp_RequisitionNew.RequisitionNo + " ,Created on " + mApp_RequisitionNew.ReqDateFormatted

                grdRequisitionList.DataSource = mApp_RequisitionNew.RequisitionItemsNew
