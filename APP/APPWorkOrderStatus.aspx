<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPWorkOrderStatus.aspx.vb"
    Inherits="Flypal.APPWorkOrderStatus" %>
...
<head id="Head1" runat="server">
    ...
    <title>Aircraft Work Order Status</title>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Work Order Status</a>--%>    
        ...
        <div class="info">
            <div class="row">
                <div class="col s6 m6 l3">
                    <div class="icon-block block-small center circle z-depth-1" style="background: #7d5c7c;">
                        <div class="icon  primary-text">
                            <i class="mdi mdi-image-outline"></i>
                        </div>
                        <div class="title">
                            <span class="headline" style="color: white;">Open</span></div>
                        <div class="tagline">
                            <span class="headline" style="color: white;">
                                <%= mnWOStatusCountDashboard.OpenCnt %></span>
                        </div>
                    </div>
                </div>
                <div class="col s6 m6 l3">
                    <div class="icon-block block-small center circle z-depth-1" style="background: #d934d1;">
                        <div class="icon  primary-text">
                            <i class="mdi mdi-image-outline"></i>
                        </div>
                        <div class="title">
                            <span class="headline" style="color: white;">Authorized</span></div>
                        <div class="tagline">
                            <span class="headline" style="color: white;">
                                <%= mnWOStatusCountDashboard.AuthorizedCnt %></span>
                        </div>
                    </div>
                </div>
               <%-- <div class="col s6 m6 l3">
                    <div class="icon-block block-small center circle z-depth-1" style="background: #ccc62b;">
                        <div class="icon  primary-text">
                            <i class="mdi mdi-image-outline"></i>
                        </div>
                        <div class="title">
                            <span class="headline" style="color: white;">Planned</span></div>
                        <div class="tagline">
                            <span class="headline" style="color: white;">
                                <%= mnWOStatusCountDashboard.PlannedCnt%></span>
                        </div>
                    </div>
                </div>--%>
                <div class="col s6 m6 l3">
                    <div class="icon-block block-small center circle z-depth-1" style="background: #014501;">
                        <div class="icon  primary-text">
                            <i class="mdi mdi-image-outline"></i>
                        </div>
                        <div class="title">
                            <span class="headline" style="color: white;">Completed</span></div>
                        <div class="tagline">
                            <span class="headline" style="color: white;">
                                <%= mnWOStatusCountDashboard.CompletionCnt%></span>
                        </div>
                    </div>
                </div>
                   <div class="col s6 m6 l3">
                    <div class="icon-block block-small center circle z-depth-1" style="background: #014501;">
                        ...
                        <div class="title">
                            <span class="headline" style="color: white;">Cancelled</span></div>
                        <div class="tagline">
                            <span class="headline" style="color: white;">
                                <%= mnWOStatusCountDashboard.CancelCnt%></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col s12 m18 20">
                    <div class="icon-block block center circle z-depth-1">
