<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPMenu.aspx.vb" Inherits="Flypal.APPMenu" %>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
 ...
 <i class="mdi mdi-arrow-left" data-page=""></i></a>
    ...
    <div id="divNotification" runat="server" style="padding-top:12px;position:absolute;">

     <asp:LinkButton ID="lnkNotification" runat="server" class="waves-effect waves-circle navicon show-on-large" ><i class="mdi mdi-bell-outline" ></i></asp:LinkButton>
    ...
    <div class="container">
        <div class="section">
            <div class="row settings-row">
                <div class="col s4" id="PartAvailabilityNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPPartAvailabilityList.aspx"><i id="iPartAvailability" runat="server" class="mdi mdi-screwdriver z-depth-1"
                            style="line-height: 50px; height: 50px; width: 50px;"></i>
                            <h7>&nbsp Part Availability</h7>
                        </a>
                    </div>
                </div>
                <div class="col s4" id="CalibrationStatusNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPCalibrationStatus.aspx"><i id="iCalibrationStatus" runat="server" class="mdi mdi-toolbox-outline z-depth-1"
                            style="line-height: 50px; height: 50px; width: 50px;"></i>
                            <h7>Calibration Status</h7>
                        </a>
                    </div>
                </div>
                <div class="col s4" id="ExpiryStatusNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPExpiryStatus.aspx"><i id="iExpiryStatus" runat="server" class="mdi mdi-lock-clock z-depth-1"
                            style="line-height: 50px; height: 50px; width: 50px;"></i>
                            <h7>Expiry Status</h7>
                        </a>
                    </div>
            ...
            <div class="row settings-row">
                <div class="col s4" id="AircraftCurrentStatusNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPAircraftCurrentStatus.aspx"><i id="iAircraftCurrentStatus" runat="server"
                            class="mdi mdi-airplane z-depth-1" style="line-height: 50px; height: 50px; width: 50px;">
                        </i>
                            <h7>Aircraft Current</h7>
                        </a>
                    </div>
                </div>
                <div class="col s4" id="AircraftDuetStatusNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPAircraftDueStatus.aspx"><i id="iAircraftDuetStatusNode" runat="server"
                            class="mdi mdi-file-document z-depth-2" style="line-height: 50px; height: 50px;
                            width: 50px;"></i>
                            <h7>Aircraft Due</h7>
                        </a>
                    </div>
                </div>
                <div class="col s4" id="APPWorkOrderStatusNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPWorkOrderStatus.aspx"><i id="iAPPWorkOrderStatusNode" runat="server"
                            class="mdi mdi-file-document z-depth-1" style="line-height: 50px; height: 50px;
                            width: 50px;"></i>
                            <h7>Work Order</h7>
                        </a>
                    </div>
            ...
            <div class="row settings-row">
                <div class="col s4" id="EmployeeDocumentStatusNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPEmployeeDocumentStatus.aspx"><i id="iEmployeeDocumentStatus" runat="server"
                            class="mdi mdi-file-document z-depth-1" style="line-height: 50px; height: 50px;
                            width: 50px;"></i>
                            <h7>Employee Document</h7>
                        </a>
                    </div>
                </div>
                <div class="col s4" id="EmployeeTrainingStatusNode" runat="server">
                    <div class="setting-box z-depth-2 center">
                        <a href="APPEmployeeTrainingStatus.aspx"><i id="iEmployeeTrainingStatus" runat="server"
                            class="mdi mdi-account-multiple z-depth-1" style="line-height: 50px; height: 50px;
                            width: 50px;"></i>
                            <h7>Employee Training</h7>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="setting-box z-depth-1 center">
      <a href="ui-app-wallet-payment.html">
        <i class="mdi mdi-food-variant z-depth-1"></i>
        <h6>Grocery Bill</h6>
      </a>
    </div>
  </div>
    ...
    <div class="setting-box z-depth-1 center">
      <a href="ui-app-wallet-payment.html">
        <i class="mdi mdi-desktop-mac z-depth-1"></i>
        <h6>Dish Recharge</h6>
      </a>
    </div>
  </div>
    ...
    <div class="setting-box z-depth-1 center">
      <a href="ui-app-wallet-payment.html">
        <i class="mdi mdi-desk-lamp z-depth-1"></i>
    ...
    <div class="setting-box z-depth-1 center">
      <a href="ui-app-wallet-payment.html">
        <i class="mdi mdi-home-modern z-depth-1"></i>
        <h6>House Tax</h6>
      </a>
    </div>
  </div>
    ...
    <div class="setting-box z-depth-1 center">
      <a href="ui-app-wallet-payment.html">
        <i class="mdi mdi-wallet z-depth-1"></i>
        <h6>Travel</h6>
      </a>
    </div>
  </div>
