...
Imports System.Linq
Public Class APPEmployeeDocumentStatus
    Inherits System.Web.UI.Page

#Region "Variable Declaration"
    Dim mUser As System.Security.Principal.IPrincipal
    Dim mGBUser As SI.UTILITY.User
    Dim mAPPEmployeeDocumentDueList As EmployeeDocumentDueList
...
#Region "Data Bind"
    Private Sub BindGrid()
        Try
            ...
            mAPPEmployeeDocumentDueList = EmployeeDocumentDueList.GetEmployeeDocumentDueList(New Guid(cmbEmployeeList.SelectedValue.ToString), _
                                                                                          Guid.Empty, "", Today.Date.ToString, 0)

            Dim DocumentDueList = (From res In mAPPEmployeeDocumentDueList).ToList.Take(10)
            grdEmployeeDocumentDueList.DataSource = DocumentDueList
            grdEmployeeDocumentDueList.DataBind()

            'Session("APPRosterList.App_CrewRosterList") = mApp_CrewRosterList
            If grdEmployeeDocumentDueList.Rows.Count = 10 Then
                lblTotalrecordCount.Text = "Top 10 Records displayed, "
            Else
                lblTotalrecordCount.Text = "Total records found: " + grdEmployeeDocumentDueList.Rows.Count.ToString + ", "
            End If
