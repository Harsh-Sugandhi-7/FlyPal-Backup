<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPEmployeeTrainingStatus.aspx.vb"
    Inherits="Flypal.APPEmployeeTrainingStatus" %>
...
<head id="Head1" runat="server">
    ...
    <title>Employee Training Due</title>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Employee Training Due</a>--%>    
        ...
        <div class="section">
                ...
                <div class="input-field col s10">
                    <div class="section ui-select" style="height: 40px;">
                        <div style="margin-top: -18px;">
                            <asp:DropDownList ID="cmbEmployeeList" runat="server" DataValueField="ID" DataTextField="EmpNoName">
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
            ...
            <asp:UpdatePanel ID="upnlRosterList" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                            ...
                            <div class="col s8">
                                <div>
                                    <span id="Span1" class="new badge" data-badge-caption="" style="background: Yellow;
                                        color: Yellow" runat="server"></span><span style="font-size: xx-small">Approching for
                                            due</span>
                                </div>
                            </div>
                            <div class="col s8">
                    ...
                    <br />
                    <ul class="events">
                        <asp:GridView ID="grdEmployeeTrainingDueList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <ItemTemplate>
                                        <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;
                                            ...
                                            <div class="info">
                                                ...
                                                <span id="Span4" class="new badge" data-badge-caption="" style="background: red;
                                                    color: red;" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"RemainingDays")<0 %>'>
                                                </span><span id="Span1" class="new badge" data-badge-caption="" style="background: Yellow;
                                                    color: Yellow" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"RemainingDays")>0 %>'>
                                                </span>
                                            </div>
                                        </li>
                                        <br />
