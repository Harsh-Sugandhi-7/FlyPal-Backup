<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPPartAvailabilityList.aspx.vb"
    Inherits="Flypal.APPPartAvailabilityList" %>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Part Availability</a>--%>    
    ...
    <div class="container">
                    ...
                    <div class="section ui-select" style="height: 40px;">
                        <div style="margin-top: -18px;">
                            ...
                            <cc2:AutoCompleteExtender ClientIDMode="Static" ID="txtSearch_Autocomplete" runat="server"
                                ...
                                CompletionInterval="1" ServicePath="APPPartAvailabilityList.aspx" ServiceMethod="GetPartNoDescriptionList"
        ...
        <asp:UpdatePanel ID="upnlRosterList" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <br />
                <ul class="events">
                    <asp:GridView ID="grdRosterList" runat="server" AutoGenerateColumns="False" EmptyDataText="No data found."
                                ...
                                <ItemTemplate>
                                    <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="time">
                                                Total Stock:
                                                <%#Eval("ToalStockBalanceQty")%></div>
                                            <div class="time">
                                                Serviceable Stock:
                                                <%#Eval("ServiceablePartStockBalanceQty")%></div>
                                            <div class="time">
                                                UnServiceable Stock:<%#Eval("UnServiceablePartStockBalanceQty")%>
                                            </div>
                                            <p>
                                            </p>
                                            <%--<span class="new badge" data-badge-caption="">Roster</span>--%>
                                            <!--
                                                <div class="actions">
                                                    <a href="ui-app-event-edit.html"><i class="mdi mdi-square-edit-outline"></i></a>
                                                    <a href="#!.html"><i class="mdi mdi-delete"></i></a>
                                                </div>
                                                -->
                                        </div>
                                    </li>
