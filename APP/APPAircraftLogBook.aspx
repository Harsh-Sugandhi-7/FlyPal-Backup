<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPAircraftLogBook.aspx.vb"
    Inherits="Flypal.APPAircraftLogBook_aspx" %>
                ...
                <div class="input-field col s11">
                    <div class="section ui-select" style="height: 40px;">
                        <div style="margin-top: -18px;">
                            <asp:DropDownList ID="cmbAircraft" runat="server" DataValueField="MachineID" DataTextField="RegNo">
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
