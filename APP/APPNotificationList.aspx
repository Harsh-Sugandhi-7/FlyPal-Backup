<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPNotificationList.aspx.vb"
    Inherits="Flypal.APPNotificationList" %>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Notifications</a>--%>    
    ...
    <div class="container full">
        <div class="section">
            <ul class="collection notifications z-depth-1">
                <asp:GridView ID="grdNotificationList" runat="server" AutoGenerateColumns="False"
                    EmptyDataText="No unread notifications found." ShowHeader="false" GridLines="None"
                    Width="100%" AllowPaging="false" PagerSettings-Mode="NumericFirstLast">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <li class="collection-item avatar" style="margin-top: -15px; margin-left: -15px;
                                    margin-bottom: -15px;">
                                    <div class="notify" style="margin-left: -50px;">
                                        <p>
                                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("Message")%>'></asp:Label></p>
                                        <asp:LinkButton ID="lnkViewDetails" runat="server" CommandArgument='<%# Container.DataItemIndex %>'
                                            CommandName="ViewDetails"><span class="new badge bg-primary" data-badge-caption="">View <%#Eval("ModuleTypeName")%></span></asp:LinkButton>
                                        <span class="time" style="margin-right: -15px;">
                                            <asp:Label ID="Label2" runat="server" Text='<%#Eval("TimeBadge")%>'></asp:Label></span>
                                    </div>
                                    <div class="secondary-content" style="margin-right: -15px;">
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%# Container.DataItemIndex %>'
                                            CommandName="Delete" class=""><i class="mdi mdi-delete-sweep"></i></asp:LinkButton>
                                    </div>
                                </li>
                            </ItemTemplate>
                        </asp:TemplateField>
