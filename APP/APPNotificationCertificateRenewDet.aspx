<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPNotificationCertificateRenewDet.aspx.vb"
    Inherits="Flypal.APPNotificationCertificateRenewDet" %>
...
<head id="Head1" runat="server">
    ...
    <title>Certificate Renew Notification</title>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    ...
    <div class="container">
        <div class="section">
            <h5 class="pagetitle">
                Certificate Renew Notification</h5>
        </div>
    </div>
    <div class="container">
        <div class="section">
                            ...
                            <div class="col s12">
                                <div class="col s12">
                                    <div class="title">
                                        Certificate</div>
                                    <div class="time">
                                        <span id="spnCertName" runat="server"></span>
                                    </div>
                                </div>
                                <div>
                                    <div class="col s4">
                                        ...
                                        <div class="time">
                                            <span id="spnAircraft" runat="server"></span>
                                        </div>
                                    </div>
                                    <div class="col s4">
                                        <div class="title">
                                            Issue Date</div>
                                        <div class="time">
                                            <span id="spnIssueDate" runat="server"></span>
                                        </div>
                                    </div>
                                    <div class="col s4">
                                        <div class="title">
                                            Expiry Date</div>
                                        <div class="time">
                                            <span id="spnExpiryDate" runat="server"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
