<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPAircraftCurrentStatus.aspx.vb"
    Inherits="Flypal.APPAircraftCurrentStatus" %>
...
<head runat="server">
    ...
    <title>Aircraft Current Status List</title>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Aircraft Status</a>--%>    
                                    ...
                                    <ItemTemplate>
                                        <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="time">
                                                    <span class="title">Assembly:</span> <span class="time">
                                                        <%#Eval("Type")%></span>   
                                                </div>
                                                <div class="time">
                                                    <span class="title">Model:</span> <span class="time">
                                                        <%#Eval("ModelName")%></span>   
                                                </div>
                                                <div class="time">
                                                 <span class="title">Serial No.:</span>  <span class="time">
                                                        <%# Eval("SerialNoPosition")%></span> </div>
                                                <div class="title">
                                                    Current Values:
                                                </div>
                                                <div>
