<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPEmployeeDocumentStatus.aspx.vb"
    Inherits="Flypal.APPEmployeeDocumentStatus" %>
...
<head id="Head1" runat="server">
    ...
    <title>Employee Document Due</title>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Employee Document Due</a>--%>    
        ...
        <div class="section">
            ...
            <asp:UpdatePanel ID="upnlRosterList" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <br />
                    <ul class="events">
                        <asp:GridView ID="grdEmployeeDocumentDueList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <ItemTemplate>
                                        <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;
                                            ...
                                            <div class="info">
                                                ...
                                                <span id="Span4" class="new badge" data-badge-caption="" style="background: red;
                                                    color: red;" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"WarningDays")<0 %>'>
                                                </span><span id="Span1" class="new badge" data-badge-caption="" style="background: Yellow;
                                                    color: Yellow" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"WarningDays")>0 %>'>
                                                </span>
                                            </div>
                                        </li>
                                        <br />
