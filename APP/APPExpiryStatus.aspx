<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPExpiryStatus.aspx.vb"
    Inherits="Flypal.APPExpiryStatus" %>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Expiry Status</a>--%>    
            ...
            <ul class="collapsible">
                ...
                <li class="lvl1  header">
                    <div class="waves-effect appsettings active" data-type="header" data-value="light">
                        <a href="#!"><i class="mdi mdi-checkbox-intermediate"></i><span class="title">Light Header</span> </a>
                    </div>
                </li>
                <li class="lvl1  header">
                ...
                <ContentTemplate>
                    <div class="info">
                        ...
                        <div class="row settings-row right">
                            ...
                            <div class="col s6">
                                <div>
                                    <span id="Span8" class="new badge" data-badge-caption="" style="background: Blue;
                            ...
                            <div class="col s6">
                                <div>
                                    <span id="Span9" class="new badge" data-badge-caption="" style="background: red;
                    ...
                    <br />
                    <ul class="events">
                        <asp:GridView ID="grdExpiryStatus" runat="server" AutoGenerateColumns="False" EmptyDataText="No data found."
                            ShowHeader="false" GridLines="None" Width="100%" AllowPaging="false" PagerSettings-Mode="NumericFirstLast">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="time">
                                                    Store-Location:
                                                    <%#Eval("StoreNameLocation")%></div>
                                                <p>
                                                </p>
                                                <span class="new badge" data-badge-caption="" style="background: red; color: red;"
                                                    runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"DateDifference")<=0 %>'>
                                                </span><span id="Span1" class="new badge" data-badge-caption="" style="background: Yellow;
                                                    color: Yellow" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"DateDifference")>0 and DataBinder.Eval(Container.DataItem,"DateDifference")<=7 %>'>
                                                </span><span id="Span2" class="new badge" data-badge-caption="" style="background: Blue;
                                                    color: Blue" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"DateDifference")>7 and DataBinder.Eval(Container.DataItem,"DateDifference")<=15 %>'>
                                                </span><span id="Span3" class="new badge" data-badge-caption="" style="background: Green;
                                                    color: Green" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"DateDifference")>15 %>'>
                                                </span>
                                            </div>
                                        </li>
                                        <br />
