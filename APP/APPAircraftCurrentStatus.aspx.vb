...
Public Class APPAircraftCurrentStatus
...
#Region "Variable Declaration"
    ...
    Dim mAPPAircraftCurrentStatus As ListOfAircraftCurrentStatus
...
#Region "Data Bind"
    Private Sub BindGrid()
        Try
            ...
            mAPPAircraftCurrentStatus = ListOfAircraftCurrentStatus.GetListOfAircraftCurrentStatus(RegNo:=cmbAircraft.SelectedItem.ToString, CurrentDate:=Date.Today.ToString) ' APPPartAvailability.GetAPPPartAvailability(ItemName.Trim, ItemDescription.Trim, Date.Today.ToString("dd-MMM-yyyy"))

            grdAircraftCurrentStatusList.DataSource = mAPPAircraftCurrentStatus
            grdAircraftCurrentStatusList.DataBind()

            'Session("APPRosterList.App_CrewRosterList") = mApp_CrewRosterList

            lblTotalrecordCount.Text = "Total records found: " + mAPPAircraftCurrentStatus.Count.ToString
