<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPFlightLogList.aspx.vb" Inherits="Flypal.APPFlightLogList" %>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
   ...
   <a href="#" data-target="slide-nav" class="waves-effect waves-circle navicon sidenav-trigger show-on-large"><i class="mdi mdi-menu"></i></a>--%>
    ...
    <div style=" margin-left:20px; margin-top:-34px; border-radius: 50%; background: red;width: 20px;height: 20px;" ID="divNotificationCount" runat="server">
        ...
        <div class="container">
            <div class="section">
                <h5 class="pagetitle">Aircraft Status</h5>
            </div>
        </div>
        <div class="container">
            <div class="section">
                <div class="row">
                    <div class="input-field col s5">
                        ...
                        <asp:TextBox ID="txtFromDate" runat="server" class="datepicker datepicker2"></asp:TextBox>
                    ...
                    <div class="input-field col s10">
                        <div class="section ui-select" style="height: 40px;">
                            <div style="margin-top: -18px;">
                                <asp:DropDownList ID="cmbAircraft" runat="server" DataTextField="RegNo" DataValueField="ID" autopostback="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s5">
                        <div class="section ui-select" style="height: 40px;">
                            <div style="margin-top: -18px;">
                                <asp:DropDownList ID="cmbLogType" runat="server" DataTextField="Name"
                    ...
                    <div class="col s1" style="margin-top: 25px; margin-right: 3px;">

                        <asp:LinkButton runat="server" ID="btnAddNew" class="btn btn-link"><span class="fa fa-save" ></span> New</asp:LinkButton>
                ...
                <asp:UpdatePanel ID="upnlRosterList" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <br />
                        <ul class="events">
                            <asp:GridView ID="grdAircraftCurrentStatusList" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important; box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;">
                                                <div class="info">
                                                    <div class="row settings-row">
                                                        <div class="col s6">
                                                            ...
                                                            <div class="time">
                                                                <span id="spnRegNo" runat="server">
                                                                    <%# Eval("RegNo")%></span>
                                                            </div>
                                                            <div class="title">
                                                                Departure UTC (Date Time)
                                                            </div>
                                                            <div class="time">
                                                                <span id="spnSourceName" runat="server">
                                                                    <%# Eval("SouPlaceName")%></span>
                                                            </div>
                                                            <div class="time">
                                                                <span id="spnSouDate" runat="server">
                                                                    <%# Eval("SouUniverseDateTimeFormatted")%></span>
                                                            </div>
                                                        </div>
                                                        <div class="col s5">
                                                            <div class="title">
                                                            ...
                                                            <div class="time">
                                                                <span id="spnLogTextNo" runat="server">
                                                                    <%# Eval("LogTextNo")%></span>
                                                            </div>
                                                            <div class="title">
                                                                Arrival UTC (Date Time)
                                                            </div>
                                                            <div class="time">
                                                                <span id="spnDestinationName" runat="server">
                                                                    <%# Eval("DesPlaceName")%></span>
                                                            </div>
                                                            <div class="time">
                                                                <span id="spnDesDate" runat="server">
                                                                    <%# Eval("DesUniverseDateTimeFormatted")%></span>
                                                            </div>
                                                        </div>
                                                        <div class="col s1">
                                                            <asp:UpdatePanel ID="upnllnkEdit" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%# CType(Container,GridViewRow).RowIndex %>'  CommandName="EditRec"  class="waves-effect waves-light btn"><i class="mdi mdi-pencil center"></i></asp:LinkButton>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                        <%--<div class="col s4">
                                                        ...
                                                        <div class="time">
                                                            <span id="spnLogPageNo" runat="server"><%# Eval("LogPageNoFormatted")%></span>
                                                        </div>
                                                    </div>--%>
                                                    </div>
                                                    <div class="row settings-row">
                                                        <div class="col s6">
                                                            ...
                                                            <div class="time">
                                                                <span id="spnTimeInAir" runat="server">
                                                                    <%# Eval("TimeInAir")%></span>
                                                            </div>
                                                        </div>
                                                        <div class="col s6">
                                                            ...
                                                            <div class="time">
                                                                <span id="spnPilot1Name" runat="server">
                                                                    <%# Eval("LogPageNoFormatted")%></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
