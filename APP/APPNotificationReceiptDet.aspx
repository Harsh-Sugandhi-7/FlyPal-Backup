<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPNotificationReceiptDet.aspx.vb"
    Inherits="Flypal.APPNotificationReceiptDet" %>
  ...
  <div class="nav-wrapper container">
    ...
    <div class="container">
        <div class="section">
            ...
            <br />
            <ul class="events">
                <asp:GridView ID="grdReceiptList" runat="server" AutoGenerateColumns="False" EmptyDataText="No data found."
