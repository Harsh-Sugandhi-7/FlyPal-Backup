<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPNotificationOrderDet.aspx.vb"
    Inherits="Flypal.APPNotificationOrderDet" %>
                    ...
                    <div class="info">
                        <div class="row settings-row">
                            <div class="col s4">
                                ...
                                <div class="time">
                                    <span id="spnOrderNo" runat="server"></span>
                                </div>
                                <div class="title">
                                    Authorized By</div>
                                <div class="time">
                                    <span id="spnAuthorizedBy" runat="server"></span>
                                </div>
                            </div>
                            <div class="col s4">
                                <div class="title">
                                ...
                                <div class="title">
                                    Remark</div>
                                <div class="time">
                                    <span id="spnRemark" runat="server"></span>
                                </div>
                            </div>
                            <div class="col s4">
                                <div class="title">
                                ...
                                <div class="time">
                                    <span id="spnVendor" runat="server"></span>
                                </div>
                            </div>
                        </div>
                        <%--<div class="row settings-row">
                                    ...
                                    <ItemTemplate>
                                        <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="time">
                                                    Date:
                                                    <%#Eval("OrderDateFormatted")%></div>
                                                <div class="time">
                                                    Vendor:
                                                    <%#Eval("VendorName")%></div>
                                                <div class="time">
                                                    Authorized By:
                                                    <%#Eval("AuthorizedBy")%></div>
                                                <div class="time">
                                                    Remark:<%#Eval("Remark")%>
                                                </div>
