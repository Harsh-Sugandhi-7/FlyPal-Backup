<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="APPAircraftDueStatus.aspx.vb"
    Inherits="Flypal.APPAircraftDueStatus" %>
...
<body class="  html" data-header="light" data-footer="dark" data-header_align="center"
  ...
  <div class="nav-wrapper container">
    <%--<a id="logo-container" href="" class=" brand-logo " >Aircraft Due(s)</a>--%>    
                ...
                <div class="input-field col s10">
                    <div class="section ui-select" style="height: 40px;">
                        <div style="margin-top: -18px;">
                            <asp:DropDownList ID="cmbAircraft" runat="server" DataValueField="RegNo" DataTextField="RegNo"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </div>
                    </div>
                ...
                <ContentTemplate>
                            ...
                            <div class="col s6">
                                <div>
                                    <span id="Span2" class="new badge" data-badge-caption="" style="background: Green;
                                        color: Green" runat="server"></span><span style="font-size: xx-small">Forcasting</span>
                                </div>
                                <div class="time">
                            ...
                            <div class="col s6">
                                <div>
                                    <span id="Span1" class="new badge" data-badge-caption="" style="background: Yellow;
                                        color: Yellow" runat="server"></span><span style="font-size: xx-small">Approching</span>
                                </div>
                                <div class="time">
                                    <span class="title"></span>
                                </div>
                            ...
                            <div class="col s6">
                                <div>
                                    <span id="Span4" class="new badge" data-badge-caption="" style="background: red;
                                        color: red;" runat="server"></span><span style="font-size: xx-small">OverDue</span>
                                </div>
                                <div class="time">
                                    <span class="title"></span>
                                </div>
                    ...
                    <ul class="events">
                        <asp:GridView ID="grdAircraftCurrentStatusList" runat="server" AutoGenerateColumns="False"
                            ...
                            DataKeyNames="ID" AllowPaging="false" PagerSettings-Mode="NumericFirstLast">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <li class="event-item card" style="margin: -14px -14px -14px -14px; -webkit-box-shadow: 0 2px 2px 0 rgb(0 0 0 / 14%), 0 3px 1px -2px rgb(0 0 0 / 12%), 0 1px 5px 0 rgb(0 0 0 / 20%) !important;
                                            ...
                                            <div class="info">
                                                ...
                                                <span id="Span4" class="new badge" data-badge-caption="" style="background: red;
                                                    color: red;" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"DueStatus")=1 %>'>
                                                </span><span id="Span1" class="new badge" data-badge-caption="" style="background: Yellow;
                                                    color: Yellow" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"DueStatus")=2  %>'>
                                                </span><span id="Span2" class="new badge" data-badge-caption="" style="background: Green;
                                                    color: Green" runat="server" visible='<%#  DataBinder.Eval(Container.DataItem,"DueStatus")=3 %>'>
                                                </span>
                                            </div>
                                        </li>
                                        <div class="divider" style="width: 103% !important; margin-left: -13px;">
                                        </div>
                                        </li>
                                        <br />
                                    </ItemTemplate>
