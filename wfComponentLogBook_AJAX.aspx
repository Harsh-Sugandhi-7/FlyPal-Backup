<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfComponentLogBook_AJAX.aspx.vb"
    Inherits="Flypal.wfComponentLogBook_AJAX" %>
            ...
            <tr>
                <td colspan="3" class="clsFormHeader1Newstyle">
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:Label ID="lbltitle" runat="server" CssClass="clsFormHeader">Component Log Register</asp:Label>
                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button CssClass="clsbtnH clsinfoH" ID="btnClose" runat="server" Text="Close" CausesValidation="False"
                                                        ToolTip="Click to close the Component Log Register"></asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                    ...
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:CustomValidator ID="CustomValidator1" runat="server" CssClass="clsLabelAuto"
                                                Display="None" ControlToValidate="cmbAircraftAssembly" ErrorMessage="Please select the Component"
                                    ...
                                    <asp:UpdatePanel ID="upnlDetails" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <asp:Label ID="lblStep5" runat="server" CssClass="clsLabelHeader">Step IV. Selection of Component</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lblComponent" runat="server" CssClass="clsLabelAuto" Enabled="False">Component</asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbComponent" runat="server" DataTextField="PartNoSerialNo"
                                                            DataValueField="CompID">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        &nbsp;<asp:CheckBox ID="chkWithAssembly" runat="server" CssClass="clsCheckBox" Text="With Assembly Detail" />
                                                        &nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">
                                                        <asp:Label ID="lblStep6" runat="server" CssClass="clsLabelHeader">Step V. Selection of Activities</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td colspan="2">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:CheckBox ID="chkShowCompliance" runat="server" Checked="True" CssClass="clsCheckBox"
