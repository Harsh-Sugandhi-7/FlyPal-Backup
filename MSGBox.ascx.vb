...
#Region " Enums "
	...
	Public Enum Message_Text
		...
		RecordCannotBeDelete = 127
		ComponentRemovedSuccessFully = 128
		AttachmentRemovedSuccessFully = 129
	End Enum
	...
	Public Enum Message_Title
		...
		RejectWO = 125
		RejectedWOSuccessFully = 126
		ComponentRemovedSuccessFully = 127
	End Enum

#End Region

#Region " Variable Decclaration "
	...
	Public WriteOnly Property Message() As Integer
		Set(Value As Integer)
			...
			Select Case Value
				...
				Case 8
					_Message = "This record cannot be Deleted. It is used in other Transaction(s)"
				Case 9
				...
				Case 61
					_Message = "<strong>Modification is not applicable.</strong><p>" & mExtraMessage & "</p>"
				Case 62
					_Message = "<strong>Selected date is out of valid range.</strong><p>" & mExtraMessage & "</p>"
				Case 63
				...
				Case 127
					_Message = "<p> Record cannot be delete." & mExtraMessage & "</p>"
				Case 128
					_Message = "<p> Component Removed Successfully!!" & mExtraMessage & "</p>"
				Case 129
					_Message = $"<strong>Attachment Removed Successfully</strong> {mExtraMessage}"
				Case Else
			End Select
	...
	Public WriteOnly Property Title() As Integer
		Set(Value As Integer)
			...
			Select Case Value
				...
				Case 38
					_Title = "Assembly Inspection Status!"
				Case 39
					_Title = "Assembly Modification Status!"
				Case 40
					_Title = "Period Required!"
				Case 41
					_Title = "Period Unit Required!"
				Case 42
				...
				Case 113  'Added by Prashant 2-Jan-2014 
					_Title = "Confirmation!"
				Case 115
					_Title = "Remove Term Confirmation!"
				Case 114
					_Title = "Reference !"
				Case 116
					_Title = "Save !"
...
#Region " Events "
	...
	Private Sub DisplayButtons(Button As MsgBoxStyle,
							   Optional SetCausesValidation As Boolean = False)

		ButtonDiv.Controls.Clear()

		Dim btnOk, btnCancel, btnAbort, btnRetry, btnIgnore, btnYes, btnNo, btnInfoOk As Button
		Try
			...
			Select Case Button
				Case MsgBoxStyle.OkOnly             '0
					...
					AddHandler btnOk.Click, AddressOf Okay
				...
				Case MsgBoxStyle.AbortRetryIgnore   '2
					...
					Dim lblAbort As New Label With {
						.Width = 3
					}

					Dim lblRetry As New Label With {
						.Width = 3
					}

					ButtonDiv.Controls.Add(btnAbort)
					ButtonDiv.Controls.Add(lblAbort)

					ButtonDiv.Controls.Add(btnRetry)
					ButtonDiv.Controls.Add(lblRetry)

					ButtonDiv.Controls.Add(btnIgnore)

					AddHandler btnAbort.Click, AddressOf Abort
					AddHandler btnRetry.Click, AddressOf Retry
					AddHandler btnIgnore.Click, AddressOf Ignore
				...
				Case MsgBoxStyle.YesNoCancel        '3
					...
					btnYes.CausesValidation = SetCausesValidation
					...
					ButtonDiv.Controls.Add(lblYes)

					ButtonDiv.Controls.Add(btnNo)
					ButtonDiv.Controls.Add(lblNo)

					ButtonDiv.Controls.Add(btnCancel)

					AddHandler btnYes.Click, AddressOf Yes
					AddHandler btnNo.Click, AddressOf No
					AddHandler btnCancel.Click, AddressOf Cancel
	...
	Public Sub Show(MessageTitle As Message_Title,
					MessageText As Message_Text,
					ExtraMessage As String,
					ButtonToShow As MsgBoxStyle,
					Sender As String,
					Optional SetCausesValidation As Boolean = False)
		...
		Try
			...
			If mSender <> "" Then
				DisplayButtons(ButtonToShow, SetCausesValidation)
				mdlPopupBox.Show()
			Else
	...
	Public Sub Show(MessageTitle As String,
	...
	Public Function MessageBoxForAPI(MessageText As Message_Text,
									 Optional ExtraMessage As String = "") As String
	...
	Protected Sub Okay(sender As Object, e As EventArgs)
	...
	Protected Sub Abort(sender As Object, e As EventArgs)
	...
	Protected Sub Retry(sender As Object, e As EventArgs)
	...
	Protected Sub Ignore(sender As Object, e As EventArgs)
	...
	Protected Sub Yes(sender As Object, e As EventArgs)
	...
	Protected Sub No(sender As Object, e As EventArgs)
