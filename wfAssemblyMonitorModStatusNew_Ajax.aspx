<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAssemblyMonitorModStatusNew_Ajax.aspx.vb"
	Inherits="Flypal.wfAssemblyMonitorModStatusNew_Ajax" %>
...
<head id="Head1" runat="server">
	<title>Assembly Directives Status</title>
				...
				<td>
					<asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
						<table id="tblinner" class="clstablelistin">
							<tr>
								<td colspan="2">
									<asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
										<ContentTemplate>
											<asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Assembly Directives Status [New]</asp:Label>
										</ContentTemplate>
									</asp:UpdatePanel>
								</td>
							</tr>
								...
								<td colspan="2">
									<asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
										<ContentTemplate>
											...
											<asp:RequiredFieldValidator ID="rfvMonitorInspectionType" runat="server" ControlToValidate="txtModelMonitorModTypeName"
												ErrorMessage="Modification Type Required." Display="None" CssClass="clsLabelAuto"></asp:RequiredFieldValidator>
									...
									<fieldset id="fdsMonitoringDetails" class="clsFieldSet" style="border-width: 1px;">
										...
										<table width="100%">
											<tr>
												<td colspan="3">
													<asp:UpdatePanel runat="server" ID="upnlSelectMonitoringService" UpdateMode="Conditional">
														<ContentTemplate>
															<asp:Button ID="btnSelect" runat="server" CssClass="clsButtonVeryLong" ToolTip="Click to open Model Directives List screen"
																Text="Select Monitoring Directives" CausesValidation="False"></asp:Button>
														</ContentTemplate>
													</asp:UpdatePanel>
												</td>
											</tr>
											<tr>
												...
												<td>
													<asp:TextBox ID="txtModelMonitorModTypeName" runat="server" CssClass="clsTextBox_Ajax"
														ToolTip="Enter Directive Type" Text="<%# mAssemblyMonitorModStatus.ModelMonitorMod.ModelMonitorModTypeName %>"
											...
											<tr>
												...
												<td>
													<asp:TextBox ID="txtATAChapter" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter ATA Chapter"
											...
											<tr>
												...
												<td>
													<asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBox1_Ajax" ToolTip="Enter Reference"
														Width="250px" Text="<%# mAssemblyMonitorModStatus.ModelMonitorMod.Reference %>"
											...
											<tr>
												<td></td>
												<td>
													<span id="lblModNumber" class="clsLabelAuto">Directive Number</span>
												</td>
												<td>
													<asp:TextBox ID="txtModNumber" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
														Width="250px" BackColor="#E0E0E0" Text="<%# mAssemblyMonitorModStatus.ModelMonitorMod.Number %>"
														ReadOnly="True" ToolTip="Directive No." MaxLength="200" TextMode="MultiLine">
													</asp:TextBox>
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td></td>
												<td>
													<span id="lblDirNote" class="clsLabel">Note</span>
												</td>
												<td>
													<asp:TextBox ID="txtDirNote" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
														Width="250px" BackColor="#E0E0E0" Text="<%# mAssemblyMonitorModStatus.ModelMonitorMod.Note %>"
														ReadOnly="True" ToolTip="Note" MaxLength="200" TextMode="MultiLine">
													</asp:TextBox>
												</td>
											</tr>
										</table>
															...
															<asp:GridView ID="dgCurrentValue" runat="server" CssClass="clsGridLog" PageSize="3"
																...
																<Columns>
																	...
																	<asp:TemplateField HeaderText="Elapsed">
																		<ItemTemplate>
																			<asp:TextBox ID="txtElapsedValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ElapsedValueFormatted") %>'
																				AutoPostBack="true" OnTextChanged="txtElapsedValue_TextChanged" ToolTip="Enter the Elapsed Value."
																	...
																	<asp:TemplateField HeaderText="Remaining">
																		<ItemTemplate>
																			<asp:TextBox ID="txtRemainingValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "RemainingValueFormatted") %>'
																				AutoPostBack="true" OnTextChanged="txtRemainingValue_TextChanged" ToolTip="Enter the Remaining Value."
																				CssClass="clsTextBoxRightAlignSmall_Ajax">
																			</asp:TextBox>
							...
							<tr>
								<td valign="top">
									<asp:UpdatePanel ID="upnlDoneOnDetails" runat="server" UpdateMode="Conditional">
										<ContentTemplate>
											<fieldset id="fdsDoneOnDetails" class="clsFieldSet" style="border-width: 1px;">
												...
												<table width="100%">
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtWorkOrdNo" runat="server" CssClass="clsTextBox_Ajax" MaxLength="100"
																Text="<%# mAssemblyMonitorModStatus.DoneWONo %>" ToolTip="Enter Work Order Number">
															</asp:TextBox>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtPlace" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter Place"
																Text="<%# mAssemblyMonitorModStatus.Place %>" MaxLength="25">
															</asp:TextBox>
														</td>
													</tr>
													<tr>
														...
														<td>
															<asp:TextBox ID="txtRequiredManHours" runat="server" CssClass="clsTextBoxSmall_Ajax"
																MaxLength="8" ToolTip="Enter Actual Man Hours" Text="<%# mAssemblyMonitorModStatus.TotalReqManHrs1 %>"
																Enabled="<%# mAssemblyMonitorModStatus.MaintenanceDoneByEmployees.Count <= 1 %>"
																OnTextChanged="txtRequiredManHours_TextChanged" AutoPostBack="true">
															</asp:TextBox>
													...
													<tr>
														<td></td>
														<td>
															<span id="lblMethodOfCompliance" class="clsLabel">Method Of Compliance
															</span>
														</td>
														<td>
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" Width="250px"
																ToolTip="Enter Remark" Text="<%# mAssemblyMonitorModStatus.DoneRemark %>" ReadOnly="<%# mAssemblyMonitorModStatus.ModelMonitorMod.ID.Equals(Guid.Empty) %>"
																TextMode="MultiLine">
															</asp:TextBox>
														</td>
													</tr>
														...
														<td>
															<table>
																<tr>
																	...
																	<td>
																		<asp:TextBox runat="server" ID="txtEffectiveFromDate" CssClass="clsTextBox_Ajax"
																			Width="100px" AutoPostBack="true" onchange="ValidateDateText(this,'EffectiveFromDate_watermarkextender','true');"></asp:TextBox>
																		<cc2:CalendarExtender ID="txtEffectiveFromDate_CalendarExtender" runat="server" CssClass="cal_Theme1"
																			Enabled="true" Format="<%$AppSettings:DateFormat%>" TargetControlID="txtEffectiveFromDate"></cc2:CalendarExtender>
																		<cc2:TextBoxWatermarkExtender TargetControlID="txtEffectiveFromDate" ID="EffectiveFromDate_watermarkextender"
																			ClientIDMode="Static" runat="server" WatermarkText="<%$AppSettings:DateFormat%>"></cc2:TextBoxWatermarkExtender>
																	</td>
																</tr>
															</table>
													...
													<tr>
														<td colspan="3">
															<asp:CheckBox ID="chkIsLater" runat="server" CssClass="clsLabelAuto" Text="Calculate Due For Period Whichever Later"
																Enabled="False" Checked="<%# mAssemblyMonitorModStatus.IsLater %>"></asp:CheckBox>
														</td>
													</tr>
													<tr>
														<td colspan="3">
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txtSourceDoc" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
																Width="250px" MaxLength="500" Text="<%# mAssemblyMonitorModStatus.SourceDoc %>"
																	...
																	<fieldset id="fdsRevisedDetails" class="clsFieldSet" style="border-width: 1px;">
																		...
																		<table>
																			<tr>
																				<td colspan="2">
																					<asp:CheckBox ID="chkApplicable" runat="server" CssClass="clsLabelAuto" ToolTip="Check to apply applicable."
																						Text="Applicable" Enabled="<%# Not(mAssemblyMonitorModStatus.ModelMonitorMod.ReadOnlyFrequencyColumn) %>"
																						Checked="<%# mAssemblyMonitorModStatus.IsApplicable %>"></asp:CheckBox>
																			...
																			<tr>
																				...
																				<td>
																					<asp:Button ID="btnRevise" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Revise Assembly Directive"
																						Text="Yes"></asp:Button>
																				</td>
																			</tr>
																		</table>
								...
								<td align="left">
									<asp:UpdatePanel ID="upnlRedLabel" runat="server" UpdateMode="Conditional">
										<ContentTemplate>
											...
											<asp:Label ID="lblInfo" runat="server" Text="Complied one time directive status."
									...
									<asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
										<ContentTemplate>
											<table border="0" id="Table1" cellspacing="0">
												<tr>
													<td>
														<asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Assembly Directives"
															Text="Save"></asp:Button>
													</td>
													<td>
														<asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to print Assembly Directives"
