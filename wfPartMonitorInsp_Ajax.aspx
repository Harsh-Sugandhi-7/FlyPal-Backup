<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfPartMonitorInsp_Ajax.aspx.vb"
    Inherits="Flypal.wfPartMonitorInsp_Ajax" %>
...
<body>
                        ...
                        <tr>
                            <td valign="top">
                                <asp:UpdatePanel ID="upnlMonitorDetails" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <fieldset id="fdsMonitorInspingDetails" class="clsFieldSet" style="border-width: 1px;">
                                            <legend id="lblMonitorInspingDetails"><b>Inspection Details</b></legend>
                                            <table>
                                                <tr>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                            Text="<%# mPartMonitorInsp.Reference %>" ToolTip="Enter Reference" MaxLength="500"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:UpdatePanel ID="upnlMonitorInspType" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                            ...
                                            <asp:UpdatePanel ID="upnlPeriods" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <fieldset id="fdsTotWtAndCapacity" class="clsFieldSet" style="border-width: 1px;">
                                                        <legend id="lblTotWtAndCapacity"><b>Frequency of Insp</b></legend>
                                                        <table>
                                                            <tr>
                                                                <td valign="top">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:LinkButton ID="lnkTools" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                    Enabled="<%# Not mPartMonitorInsp.IsNew %>" ToolTip="Click to add Tools" Text="Tools (0 records)"></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:LinkButton ID="lnkSpares" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                    Enabled="<%# Not mPartMonitorInsp.IsNew %>" ToolTip="Click to add Spares" Text="Spares (0 records)"></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:LinkButton ID="lnkTaskCards" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                    Enabled="<%# Not mPartMonitorInsp.IsNew %>" ToolTip="Click to add Task Cards"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnSaveSelect" runat="server" CssClass="clsButton_Ajax" Text="Save &amp; Select"
                                                        ToolTip="Click to Save and Select Part Insp" Visible='<%# not Session("EditMasterRecord") = "True" %>'>
                                                    </asp:Button>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" Text="Save" ToolTip="Click to Save Part Insp">
                                                    </asp:Button>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" Text="Print" ToolTip="Click to Print Part Insp">
                                                    </asp:Button>
                                                </td>
                                                <td>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForInspMaster();
            return false;
        }
    </script>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
       ...
       SetPageLayout();
       if ($.browser.msie) {
             parent.IFrameInspMasterStateComplete();
         }
    });
