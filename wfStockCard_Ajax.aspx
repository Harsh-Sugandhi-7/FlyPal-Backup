<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfStockCard_Ajax.aspx.vb"
    EnableEventValidation="false" Inherits="Flypal.wfStockCard_Ajax" %>
        ...
        <tr>
            <td align="right">
                <table id="Table2" class="clsTablelistin" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left">
                            <span id="lblTitle" class="clstitle1">Stock Card</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                                        ...
                                        <tr>
                                            <td valign="top" align="left">
                                                <table id="Table4" border="0" cellspacing="1" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblTotalQty" runat="server" CssClass="clsLabelAuto">Total Qty. :</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lbltextTotalQty" runat="server" CssClass="clsLabelHeader"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span id="spCalibrationInterval" class="clsLabelAuto">Calibration Interval :</span>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblCalibrationInterval" runat="server" CssClass="clsLabelHeader"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span id="spCalibrationStandard" class="clsLabelAuto">Calibration Standard :</span>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblCalibrationStandard" runat="server" CssClass="clsLabelHeader"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span id="spWorkingRange" class="clsLabelAuto">Working Range :</span>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblWorkingRange" runat="server" CssClass="clsLabelHeader"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td valign="top" align="left">
                                                <table id="Table5" border="0" cellspacing="1" cellpadding="1">
                                                    <tr>
                                                        <td>
                                                            <span id="lblItemCategory" class="clsLabelAuto">Item Category :</span>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lbltextItemCategory" runat="server" CssClass="clsLabelHeader"></asp:Label>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span id="lblATA" class="clsLabelAuto" style="width: 96px;">ATA Chapter :</span>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lbltextATA" runat="server" CssClass="clsLabelHeader"></asp:Label>
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span id="lblApplicability" class="clsLabelAuto" style="width: 96px;">Applicability
                                                                :</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:UpdatePanel runat="server" ID="upnlAttachment" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" ImageUrl="~/icons/Attachment.png"
                                                                        Height="30px" Width="30px"></asp:ImageButton>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                                                    </tr>
                                            ...
                                            <td valign="top" align="left">
                                                <table id="Table3" border="0" cellspacing="1" cellpadding="1">
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblAlternateParts" runat="server" CssClass="clsLabelHeader"> Alternate Parts :</asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:GridView ShowHeaderWhenEmpty="True" ID="gdvAlternate" runat="server" CssClass="clsGrid"
                                                                EnableViewState="False" ToolTip="Stock Card Serviceable" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="PartDescription" HeaderText="Description"></asp:BoundField>
                    ...
                    <tr>
                        <td align="left">
                            <span id="lblServiceablePartList" class="clsLabelHeader">Serviceable Stock List</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="250px" Width="100%">
                                <asp:UpdatePanel runat="server" ID="upnlServiceableGrid" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:GridView ID="gdvPartHistoryServiceable" runat="server" ShowHeaderWhenEmpty="True"
                                            CssClass="clsGrid" ToolTip="Stock Card Serviceable" AutoGenerateColumns="False"
                                            AllowSorting="True">
                                            <AlternatingRowStyle CssClass="clsdgAltItem"></AlternatingRowStyle>
                                            <RowStyle CssClass="clsdgItem"></RowStyle>
                                            <HeaderStyle CssClass="clsdgHeader"></HeaderStyle>
                                            <Columns>
                                                ...
                                                <%--3--%>
                                                <asp:BoundField DataField="ReceiptQty" HeaderText="Receipt Qty." SortExpression="ReceiptQty">
                                                ...
                                                <%--8--%>
                                                <asp:BoundField DataField="CommercialRate" HeaderText="Purchase Price">
                                                    <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                    <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                                                </asp:BoundField>
                                                <%--9--%>
                                                <asp:BoundField DataField="Rate" HeaderText="OH/RPR Cost">
                                                    <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                    <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                                                </asp:BoundField>
                                                <%--10--%>
                                                ...
                                                <%--16--%>
                                                <asp:BoundField DataField="CalibrationNextDueDate" HeaderText="Calibration Next Due Date">
                                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <%--17--%>
                                                ...
                                                <%--19--%>
                                                <asp:BoundField DataField="OrderTransTypeID" HeaderText="OrderTransTypeID" HeaderStyle-CssClass="hideGridColumn"
                                                    ItemStyle-CssClass="hideGridColumn">
                                                    <HeaderStyle CssClass="hideGridColumn" HorizontalAlign="Left" />
                                                    <ItemStyle CssClass="hideGridColumn" HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <%--20--%>
                                                <asp:BoundField DataField="OrderItemEROQty" HeaderText="OrderItemEROQty" HeaderStyle-CssClass="hideGridColumn"
                                                    ItemStyle-CssClass="hideGridColumn">
                                                    <HeaderStyle CssClass="hideGridColumn" HorizontalAlign="Left" />
                                                    <ItemStyle CssClass="hideGridColumn" HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                ...
                                                <%--22--%>
                                                <asp:BoundField DataField="tabReceiptItemLoanQty" HeaderText="tabReceiptItemLoanQty"
                    ...
                    <tr>
                        <td align="left">
                            <span id="Label1" class="clsLabelHeader">Unserviceable Stock List</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Panel ID="Panel2" runat="server" ScrollBars="Vertical" Height="250px" Width="100%">
                                <asp:UpdatePanel runat="server" ID="upnlUnServiceableGrid" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:GridView ID="gdvPartHistoryUnserviceable" EnableViewState="False" ShowHeaderWhenEmpty="True"
                                            runat="server" CssClass="clsGrid" ToolTip="Stock Card Unserviceable" AutoGenerateColumns="False"
                                            AllowSorting="True">
                                            <AlternatingRowStyle CssClass="clsdgAltItem"></AlternatingRowStyle>
                                            <RowStyle CssClass="clsdgItem"></RowStyle>
                                            <HeaderStyle CssClass="clsdgHeader"></HeaderStyle>
                                            <Columns>
                                                ...
                                                <%-- 14--%>
                                                <asp:BoundField DataField="EROOrderNo" SortExpression="EROOrderNo" HeaderText="Order No.">
                                                    <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Left" />
                                                    <HeaderStyle ForeColor="#FFFFFF" HorizontalAlign="Left" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <%-- 15--%>
                                                <asp:BoundField DataField="CostCenter" SortExpression="CostCenter" HeaderText="Cost Center">
                    ...
                    <tr>
                        <td align="left">
                            <span id="Span9" class="clsLabelHeader">PPS(Part Purchase),MRN,Order,Open GRN Info.</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="dgOpenReceipt" EnableViewState="False" ShowHeaderWhenEmpty="True"
                                        ...
                                        <Columns>
                                            ...
                                            <%-- 13--%>
                                            <asp:BoundField DataField="IsOverhaul" HeaderText="IsOverhaul" HeaderStyle-CssClass="hideGridColumn"
                                                ItemStyle-CssClass="hideGridColumn">
                                                <HeaderStyle CssClass="hideGridColumn" HorizontalAlign="Left" />
                                                <ItemStyle CssClass="hideGridColumn" HorizontalAlign="Left" />
                                            </asp:BoundField>
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblOlive" runat="server" CssClass="clsColorLabel" BackColor="Olive"
                                ForeColor="Olive"></asp:Label>
                            <span id="lblNote" class="clsLabel" style="margin-top: 5px">Serviceable/Unserviceable
                                part pending to receipt against repair, overhaul order (Issue Date Column)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label2" runat="server" CssClass="clsColorLabel" BackColor="#FFC082"
                                ForeColor="#FFC082"></asp:Label>
                            <span id="Span1" class="clsLabel" style="margin-top: 5px">Pending To Issue For Exchange
                                (Core Unit Return) (Order No. Column)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label3" runat="server" CssClass="clsColorLabel" BackColor="#ffaad5"
                                ForeColor="#ffaad5"></asp:Label>
                            <span id="Span2" class="clsLabel" style="margin-top: 5px">Pending To Issue Rental/Lease
                                of Supplier (Order No. Column)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label4" runat="server" CssClass="clsColorLabel" BackColor="#8080ff"
                                ForeColor="#8080ff"></asp:Label>
                            <span id="Span3" class="clsLabel" style="margin-top: 5px">Pending To Receive From Aircraft
                                As Core Unit Return (Issue Date Column)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            ...
                            <span id="Span4" class="clsLabel" style="margin-top: 5px">Issue Status Is Open(Issue
                                Date Column)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            ...
                            <span id="Span5" class="clsLabel" style="margin-top: 5px">GRO Receipt To Outright(Order
                                No. Column)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label5" runat="server" CssClass="clsColorLabel" BackColor="#800000"
                                ForeColor="#800000"></asp:Label>
                            <span id="Span6" class="clsLabel" style="margin-top: 5px">Advance Core-return (Issue
                                Date Column)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            ...
                            <span id="Span7" class="clsLabel" style="margin-top: 5px">Pending to Issue to aircraft
                                against receipt from aircraft</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            ...
                            <span id="Span8" class="clsLabel" style="margin-top: 5px">Part Is Not In Use</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblCapitalizedIssueColor" runat="server" CssClass="clsColorLabel" BackColor="#008000"
                                ForeColor="#008000"></asp:Label>
                            <span id="lblCapitalizedIssueSpan" class="clsLabel" style="margin-top: 5px">Capitalized Issue (Issue Date Column) </span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            ...
                            <span id="lblDiscardIssueSpan" class="clsLabel" style="margin-top: 5px">Discard Issue(Issue Date Column) </span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblReceiptmarkedasassetColor" runat="server" CssClass="clsColorLabel" BackColor="#00ff80"
                                ForeColor="#00ff80"></asp:Label>
                            <span id="lblReceiptmarkedasassetSpan" class="clsLabel" style="margin-top: 5px">Receipt marked as asset(Receipt Date Column) </span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            ...
                            <span id="lblSalesIssueSpan" class="clsLabel" style="margin-top: 5px">Sales Issue(Issue Date Column) </span>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
