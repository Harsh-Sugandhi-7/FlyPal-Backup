<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfnWOCAMOUpdatList.aspx.vb"
    Inherits="Flypal.wfnWOCAMOUpdatList" %>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">List Of CAMO Update W.O.</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                                        ...
                                                        <asp:UpdatePanel runat="server" ID="upnlSearch" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <table id="Table2">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:CustomValidator ID="cvFromDate" runat="server" CssClass="clsLabelAuto" Display="None"
                                                                                ValidationGroup="a" ErrorMessage="From Date should not be greater than To Date "></asp:CustomValidator>
                                                                        </td>
                                                                        <td align="right">
                                                                            &nbsp;&nbsp;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <asp:UpdatePanel ID="upnlNo" runat="server" UpdateMode="Conditional">
                                                                                <ContentTemplate>
                                                                                    <asp:TextBox ID="txtNo" runat="server" CssClass="clsTextBox_Ajax" Width="100px" MaxLength="4"
                                                                    ...
                                                                    <tr>
                                                                        <asp:PlaceHolder ID="plhCAMOUpdateStatus" runat="server">
                                                                            <td>
                                                                                <asp:UpdatePanel ID="upnllblCAMOUpdateStatus" runat="server" UpdateMode="Conditional">
                                                                                    <ContentTemplate>
                                                                                        <asp:Label ID="lblCAMOUpdateStatus" runat="server" CssClass="clsLabel" Height="8px">CAMO Update Status</asp:Label>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                                            </td>
                                                                            <td colspan="2">
                                                                                <asp:UpdatePanel ID="upnlcmbCAMOUpdateStatus" runat="server" UpdateMode="Conditional">
                                                                                    <ContentTemplate>
                                                                                        <asp:DropDownList ID="cmbCAMOUpdateStatus" runat="server" CssClass="clsComboBox1_Ajax">
                                                                                            <asp:ListItem Value="-1">(ALL)</asp:ListItem>
                                                                                            <asp:ListItem Value="0" Selected="True">None</asp:ListItem>
                                                                                            <asp:ListItem Value="1">CAMO Updated</asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <asp:PlaceHolder ID="plhBillingStatus" runat="server">
                                                                            <td>
                                                                                <asp:UpdatePanel ID="upnllblBillingStatus" runat="server" UpdateMode="Conditional">
                                                                                    <ContentTemplate>
                                                                                        <asp:Label ID="lblBillingStatus" runat="server" CssClass="clsLabel" Height="8px">Billing Status</asp:Label>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                                            </td>
                                                                            <td colspan="2">
                                                                                <asp:UpdatePanel ID="upnlcmbBillingStatus" runat="server" UpdateMode="Conditional">
                                                                                    <ContentTemplate>
                                                                                        <asp:DropDownList ID="cmbBillingStatus" runat="server" CssClass="clsComboBox1_Ajax">
                                                                                            <asp:ListItem Value="-1">(ALL)</asp:ListItem>
                                                                                            <asp:ListItem Value="0" Selected="True">None</asp:ListItem>
                                                                                            <asp:ListItem Value="1">Billing Done</asp:ListItem>
                                                                                            <asp:ListItem Value="2">Billing Not Required</asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                                            </td>
                            ...
                            <tr>
                                <td>
                                    <asp:UpdatePanel ID="upnlResult" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblResult" runat="server" CssClass="clsLabelHeader">List of CAMO Update W.O. as per criteria :  Record(s) found.</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                                <td align="right">
                            ...
                            <tr>
                                <td align="left" colspan="2">
                                    <asp:UpdatePanel ID="upnlGridView" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgCAMOUpdateWOList" runat="server" CssClass="clsGrid" DataKeyNames="ID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="WOStatusOnCAMOUpdateList" SortExpression="WOStatusOnCAMOUpdateList"
                                                        HeaderText="WO. Status">
                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="WOStatusOnBillingList" SortExpression="WOStatusOnBillingList"
                                                        HeaderText="WO. Status">
                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="BillingStatus" SortExpression="BillingStatus" HeaderText="Billing Status">
                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="CAMOStatus" SortExpression="CAMOStatus" HeaderText="CAMO Update Status">
                                                        <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                                                    </asp:BoundField>
