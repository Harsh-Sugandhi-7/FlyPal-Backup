<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfConfigureSBADList_Ajax.aspx.vb"
    Inherits="Flypal.wfConfigureSBADList_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Configure ADs/SBs On Existing Assembly</title>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function autoResizeCompList() {
            ...
            document.getElementById('TbConfigAssemblyADSB').height = (newheight) + "px";
            document.getElementById('TbConfigAssemblyADSB').width = (newwidth) + "px";
...
<body leftmargin="0" rightmargin="0">
    ...
    <table class="clstablelistout" id="tblMain">
        <tr>
            <td>
                <span id="lblTitle" class="clstitle1">Configured ADs/SBs List</span>
            </td>
        </tr>
        <tr>
            <asp:Panel ID="pnlMain" runat="server" CssClass="clsPanel1">
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <cc2:TabContainer ID="TbConfigAssemblyADSB" runat="server" AutoPostBack="true">
                                                                    ...
                                                                    <td>
                                                                        <table id="Table1" width="100%">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtADSBNo" runat="server" CssClass="clsTextBox_Ajax" ToolTip="Enter ADSB No. to search"
    ...
    <div>
        <script type="text/javascript">
            function CallCompADSBConfigureList() {
                document.getElementById('IframeCompList').src = 'wfConfigureCompSBADList_Ajax.aspx'
            }
        </script>
    </div>
