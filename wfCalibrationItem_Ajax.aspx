<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCalibrationItem_Ajax.aspx.vb"
    Inherits="Flypal.wfCalibrationItem_Ajax" %>
...
<body>
                            ...
                            <td>
                                <asp:UpdatePanel runat="server" ID="upnlValidationSummary" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:CustomValidator ID="cvItem" runat="server" Display="None" ErrorMessage="Please select the Part No."
                                            ControlToValidate="cmbItemList" ClientValidationFunction="validateItem"></asp:CustomValidator>
                                        <asp:CustomValidator ID="cvSerialNo" runat="server" Display="None" ErrorMessage="Please select the Serial No."
                                            ControlToValidate="cmbSerialNo" ClientValidationFunction="validateSerialNo"></asp:CustomValidator>
                                        <asp:CustomValidator ID="CustomValidator21" runat="server" OnServerValidate="CustomValidate"
                                            ValidateEmptyText="true" Display="None" ControlToValidate="txtDoneOnDate"></asp:CustomValidator>
                                        <asp:CustomValidator ID="CustomValidator12" runat="server" ClientValidationFunction="validateName"
                                        ...
                                        <asp:CustomValidator ID="CustomValidator2" runat="server" ClientValidationFunction="validateName"
                                        ...
                                        <asp:CustomValidator ID="CustomValidator3" runat="server" ClientValidationFunction="validateName"
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvItem" runat="server" Display="None" ErrorMessage="Please Select Item."
                                            ControlToValidate="cmbItemList"></asp:RequiredFieldValidator>
                                        <script type="text/javascript">
                                            ...
                                            function validateSerialNo(source, args) {
                                                args.IsValid = false;

                                                var dd = $get("cmbSerialNo");
                                                if (dd.selectedIndex != 0) {
                                                    args.IsValid = true;
                                                    return;
                                                }
                                    ...
                                    <ContentTemplate>
                                        <fieldset class="clsFieldSet">
                                            ...
                                            <table>
                                                <tr>
                                                    <td colspan="3">
                                                        <span id="lblNote1" class="clsLabelAuto">Enter the Details of Item by selecting the
                                                            Part No. from list and select the Serial No.</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span id="lblItem" class="clsLabelAuto">Part No.</span>
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="cmbItemList" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle" AutoPostBack="True"
                                                            ClientIDMode="Static" DataTextField="Name" DataValueField="ID" SelectedValue="<%# mCalibrationItem.ItemID %>">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="cmbSerialNo" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle" DataTextField="SerialNo"
                                                            ClientIDMode="Static" AutoPostBack="true" DataValueField="ReceiptItemID" SelectedValue="<%# mCalibrationItem.ReceiptItemID %>">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxSearch_Ajax" ReadOnly="True"
                                                             BackColor="#E0E0E0" ToolTip="Item Description" Text="<%# mCalibrationItem.Description %>"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtLocation" runat="server" CssClass="clsTextBoxTagSearch" ReadOnly="True"
                                                            BackColor="#E0E0E0" ToolTip="Item Description" Text="<%# mCalibrationItem.Location %>"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                     <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TextBox1" runat="server" CssClass="clsTextBoxTagSearch" Text="<%# mCalibrationItemChild.ManufacturingDateFormatted %>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtFrequency" runat="server" CssClass="clsTextBoxTagSearchSmall"
                                                            ClientIDMode="Static" Text="<%# mCalibrationItem.Frequency %>" ToolTip="Item Frequency"
                                                            AutoPostBack="true" BackColor="#E0E0E0" ReadOnly="True">
                                                        </asp:TextBox>
                                                        <asp:Label ID="lblMonths" runat="server" CssClass="clsLabelAuto" Text="<%# mCalibrationItem.CalibrationPeriodIn %>"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtNo" runat="server" BackColor="White" CssClass="clsTextBoxTagSearch"
                                                            MaxLength="50" Text="<%# mCalibrationItemChild.CalibrationNo %>" ToolTip="Enter Calibration No."></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtNextDueDate" runat="server" CssClass="clsTextBoxTagSearchDate"  Text="<%# mCalibrationItemChild.NextDueDate %>"
                                                            MaxLength="50" BackColor="#E0E0E0" ReadOnly="True">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDoneByAgency" runat="server" CssClass="clsTextBoxSearch_Ajax" ToolTip="Enter Agency Name"
                                                            Text="<%# mCalibrationItemChild.DonebyAgency %>" MaxLength="150"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCertRef" runat="server" CssClass="clsTextBoxSearch_Ajax" ToolTip="Enter Certificate Reference"
                                                             Text="<%# mCalibrationItemChild.CertificateReference %>" MaxLength="100"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxSearch_Ajax" MaxLength="1000"
                                                             Text="<%# mCalibrationItemChild.Remark %>" TextMode="MultiLine"
                                    ...
                                    <ContentTemplate>
                                        <table id="Table1">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnSave" runat="server" Text="Save &amp; Close" ToolTip="Click to save Calibration Item"
                                                        CssClass="clsButton_Ajax" CausesValidation="true"></asp:Button>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnBack" runat="server" Text="Back" ToolTip="Click to go back to previous page"
                                                        CssClass="clsButton_Ajax" CausesValidation="False"></asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForNewCalibrationItem();
            return false;
        }
    </script>
    <%--End--%>
    ...
    <script type="text/javascript">
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            ...
            SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameNewCalibrationItemStateComplete();
                }
