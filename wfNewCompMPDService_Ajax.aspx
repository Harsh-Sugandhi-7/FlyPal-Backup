<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfNewCompMPDService_Ajax.aspx.vb" Inherits="Flypal.wfNewCompMPDService_Ajax" %>
...
<head runat="server">
    <title>Part Service Details</title>
                                        ...
                                        <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:CustomValidator ID="cvMonitorSerType" runat="server" Display="None" ControlToValidate="cmbMonitorServiceType"
                                                    ErrorMessage="Select Service Type from List" CssClass="clsLabelAuto" ClientValidationFunction="validateSelection"></asp:CustomValidator>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                                Text="<%# mPartMonitorService.Reference %>" ToolTip="Enter Reference" MaxLength="100"
                                        ...
                                        <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table id="Table1" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Part Service"
                                                                Text="Save"></asp:Button>
                                                        </td>
                                                        <td>
                                                            <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to print Part Service"
