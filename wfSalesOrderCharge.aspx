<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSalesOrderCharge.aspx.vb" Inherits="Flypal.wfSalesOrderCharge" %>
...
<head runat="server">
    <title>Sales Order Charge</title>
    ...
    <form id="form1" runat="server">
                                ...
                                <tr>
                                    <td class="clsFormHeader1Newstyle">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblTitle" CssClass="clsFormHeader" runat="server" Width="250px">
														Sales Order Charge
                                                    </asp:Label>
                                                </td>
                                                <td align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:ImageButton ID="imgbtnCharge" runat="server" ImageUrl="~/images/plus1.png" Height="22px"
                                                                Width="24px" ToolTip="Click to Add New Charge" CausesValidation="False" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPercentage" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax" Width="170px"
                                                                ToolTip="Enter Percentage" Text="<%# mSalesOrder.SalesOrderCharges.CurrentItem.Percentage %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtChargeAmount" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax" Width="170px"
                                                                ToolTip="Enter Charge Amount" Text="<%# mSalesOrder.SalesOrderCharges.CurrentItem.CChargeAmount %>"
                                                                MaxLength="12" BackColor="#E0E0E0" ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                        <td>&nbsp;
                                                        </td>
        ...
        <script type="text/javascript">
            function CallParentCallback() {
                parent.ParentCallBackFunctionForSalesCharge();
                return false;
            }
        </script>
        <%--End--%>
     ...
     <% Dim mopen As String = Request.QueryString("Type") %>
         <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
            $(document).ready(function () {
                SetPageLayout();
                if ($.browser.msie) {
                    parent.IFrameSalesChargeStateComplete();
                }
            });
     <% End if %>
