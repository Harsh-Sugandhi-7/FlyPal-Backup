Partial Class wfEmployeeApproachDuesAsPerStandards
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblServiceCriteria As System.Web.UI.WebControls.Label
...
#Region " Variable Declaration "
    ...
    Dim mEmployeeApproachDuesAsPerStandards As EmployeeApproachDuesAsPerStandard
...
#Region " Helper Method "
    Private Sub SetReport()
        ...
        Dim ds As New dsEmployeeApproachDuesAsPerStandard
        Dim AsPerCompanyStandard As Integer

        If rbCompanyStandard.Checked = True Then    'Company Standard
            myReport = New crEmployeeApproachDuesAsPerCompanyStandard
            AsPerCompanyStandard = 1
            SearchStr3 = "Pilot Approach Dues As Per Company Standard For FDTL"
        Else                                        'Govt. Standard
            myReport = New crEmployeeApproachDuesAsPerGovtStandard
            AsPerCompanyStandard = 2
            SearchStr3 = "Pilot Approach Dues As Per Govt. Standard For FDTL"
        End If
        ...
        mEmployeeApproachDuesAsPerStandards = EmployeeApproachDuesAsPerStandard.GetEmployeeApproachDuesAsPerStandards(ToDate, mEmployeeID, AsPerCompanyStandard)
        ...
        If mEmployeeApproachDuesAsPerStandards.Count <= 0 Then
            Dim msg1 As New SIMsgBox(Page, SIMsgBox.Message_title.NoRecocordFound, SIMsgBox.Message_text.NoRecordFound, "There is no record for this search criteria", MsgBoxStyle.OKOnly)
            msg1.ReplacePage = "wfEmployeeApproachDuesAsPerStandards.aspx?Backpage="
            msg1.Show()
            Exit Sub
        End If

        ds.Clear()
        da.Fill(ds, mEmployeeApproachDuesAsPerStandards)
...
#Region " Event "
    ...
    Private Sub btnCurrentSearchCriteria_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCurrentSearchCriteria.Click
        ...
        If rbCompanyStandard.Checked Then
            lblStandardCriteria.Visible = True
            lblStandardCriteria.Text = "Standard: " & rbCompanyStandard.Text
        ElseIf rbGovtStandard.Checked Then
            lblStandardCriteria.Visible = True
            lblStandardCriteria.Text = "Standard: " & rbGovtStandard.Text
        End If
    End Sub
