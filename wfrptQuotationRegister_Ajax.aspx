<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptQuotationRegister_Ajax.aspx.vb"
    Inherits="Flypal.wfrptQuotationRegister_Ajax" %>
...
<body>
                ...
                <td>
                    <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td class="clsFormHeader1Newstyle">
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lbltitle" CssClass="clsFormHeader" runat="server">Quotation Register</asp:Label>
                                            </td>
                                            <%--<td align="right">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblStep1" runat="server" CssClass="clsLabelHeader">Step I.Selection of Quotation Type</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblQuotationType" runat="server" CssClass="clsLabelAuto" Width="100px">Quotation Type</asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbQuotationType" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblStep3" runat="server" CssClass="clsLabelHeader">Step III. Selection of Quotation and It's No.</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblQuoNo" runat="server" CssClass="clsLabelAuto" Width="100px">Quotation No.</asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="clsTextBoxTagSearch" ID="txtQuotationText" runat="server" 
                            ...
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblSupplier" runat="server" CssClass="clsLabelAuto" Width="100px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="clsTextBoxSearch_Ajax" ID="txtSupplier" runat="server" 
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblStep5" runat="server" CssClass="clsLabelHeader">Step V. Selection of Status & Report Format</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td colspan="2" style="margin-left: 40px">
                                                        <asp:Label ID="lblQuotationType1" runat="server" CssClass="clsLabelAuto" Visible="False">Quotation Type :</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Label ID="lblQuotNo1" runat="server" CssClass="clsLabelAuto" Visible="False">Quotation No.  :</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lblStatus1" runat="server" CssClass="clsLabelAuto" Visible="False">Status :</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
    ...
    <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function () {
            ...
            $("#<%=txtQuotationText.ClientID%>").autocomplete('wfAutoInventoryList.aspx?Type=Text&TextType=<%=iif(mType=0,8,14)%>', {
                width: 187,
                autoFill: false,
                matchContains: true,
                mustMatch: true,
