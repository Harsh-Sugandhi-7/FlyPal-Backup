<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSendMail_Ajax.aspx.vb"
    Inherits="Flypal.wfSendMail_Ajax" %>
                                ...
                                <asp:UpdatePanel ID="upnlSendMailDetails" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table>
                                            <tr>
                                                <td colspan="2">
                                                    <span class="clsLabelHeader">Requisition will be sent to following Email-ID’s.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblToMailID" runat="server" CssClass="clsLabelAuto" >
                                                    </asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <span class="clsLabelHeader">Other than above Recipients, please enter comma separated
                                                        Email-ID's to sent the Requisition.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtMailIDs" runat="server" CssClass="clsTextBoxLong1_Ajax" Height="50px"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCCIDs" runat="server" CssClass="clsTextBoxLong1_Ajax" Height="50px"
                                                        ClientIDMode="Static"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
