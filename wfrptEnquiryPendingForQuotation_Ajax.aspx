<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptEnquiryPendingForQuotation_Ajax.aspx.vb"
    Inherits="Flypal.wfrptEnquiryPendingForQuotation_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Enquiry Pending For Quotation</title>
            ...
            <tr>
                <td>
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td>
                                <span id="lbltitle" class="clstitle1">Enquiry Pending For Quotation</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:UpdatePanel runat="server" ID="upnlCurrentSearchCriteria" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <span id="Span2" class="clsLabelHeader">Step III. Display Report</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnClose" TabIndex="0" runat="server" CssClass="clsButton_Ajax" Text="Close"
                                                        ToolTip="Click to close the screen" CausesValidation="False"></asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
