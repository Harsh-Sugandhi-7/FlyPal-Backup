<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfNewADSB_Ajax.aspx.vb"
    Inherits="Flypal.wfNewADSB_Ajax" %>
                                    ...
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:CustomValidator ID="cvMonitorSerType" runat="server" Display="None" ControlToValidate="cmbMonitorModType"
                                                ErrorMessage="Select Model Directive Type from List" CssClass="clsLabelAuto"
                                                OnServerValidate="CustomValidate"></asp:CustomValidator>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <asp:UpdatePanel ID="upnlMonitorDirectiveDetails" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <fieldset id="fdsMonitorDirectiveDetails" class="clsFieldSet" style="border-width: 1px;">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span id="lblMonitorDirectiveType" class="clsLabelAuto">Directive Type</span>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                            Text="<%# mModelMonitorMod.Reference %>" ToolTip="Enter Reference" MaxLength="100"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span id="lblEffectiveDate" class="clsLabel">Effective Date </span>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox runat="server" ID="calIssueDate" CssClass="clsTextBox_Ajax" Width="100px"
                                                                            ClientIDMode="Static" AutoPostBack="true" onchange="ValidateDateText(this,'DoneOnDate_watermarkextender','true');"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span id="lblComplianceRequirement" class="clsLabel">Method of Compliance</span>
                                                                    </td>
                                                                    <td>
                                                                            ...
                                                                            <tr>
                                                                                <td valign="middle">
                                                                                    <table cellspacing="0">
                                                                                        <tr>
                                                                                            <td>
                                                                                                <input id="Image2" type="image" src="images/LM2.png" disabled="disabled" style="height: 22px;
                                                                                                    width: 24px" />
                                                                                            </td>
                                                                                            <td>
                                    ...
                                    <asp:UpdatePanel ID="upnlAssemblyDetails" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblResultModList" CssClass="clsLabelHeader" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
