<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfUpdateInstalledCompHistory_Ajax.aspx.vb"
    Inherits="Flypal.wfUpdateInstalledCompHistory_Ajax" %>
...
<head runat="server">
    ...
    <title>Installed Component History</title>
            ...
            <td>
                <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                    <table class="clstablelistin" id="tblInner">
                        <tr>
                            <td>
                                <span id="lbltitle" class="clstitle1">History for Installed Component</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <fieldset id="Fieldset1" class="clsFieldSet" style="padding: 0px 4px 0px 0px; width: 780px;
                                    z-index: 10000; border-width: 1px">
                                    <legend id="Legend1" runat="server"><b>Component Installation Information</b></legend>
                                ...
                                <asp:UpdatePanel ID="upnlGrid" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table width="100%">
                                            <tr>
                                                <td align="left">
                                                    <asp:Label ID="lblInstalledCompList" runat="server" CssClass="clsLabelHeader"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="dgRemovedCompList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="InstalledOnFormatted" HeaderText="Installed On" HtmlEncode="false">
                                                                <HeaderStyle ForeColor="White" HorizontalAlign="Left"></HeaderStyle>
                        ...
                        <tr>
                            <td align="right">
                                <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Button ID="btnBack" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to close Installed Component History screen"
