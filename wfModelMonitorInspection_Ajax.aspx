<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfModelMonitorInspection_Ajax.aspx.vb"
    Inherits="Flypal.wfModelMonitorInspection_Ajax" %>
...
<head id="Head1" runat="server">
    <title>Model Inspection Details</title>
...
<body>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">Model Inspection [New]</asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                    ...
                                    <asp:UpdatePanel ID="upnlValidationSummary" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                           ...
                                           <%-- <asp:CustomValidator ID="cvMonitorSerType" runat="server" Display="None" ControlToValidate="cmbMonitorInspType"
                                                ErrorMessage="Select Inspection Type from List" CssClass="clsLabelAuto"
                                                OnServerValidate="CustomValidate"></asp:CustomValidator>--%>
                                            ...
                                            <fieldset id="fdsMonitorInspectioningDetails" class="clsFieldSet" style="border-width: 1px;">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCode" runat="server" CssClass="clsTextBox_Ajax" Text="<%# mModelMonitorInsp.Code %>"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:DropDownList ID="cmbATAChapter" runat="server" CssClass="clsComboBox2_Ajax"
                                                                                                SelectedValue="<%# mModelMonitorInsp.ATAID %>" DataTextField="ATAChapter" DataValueField="ID">
                                                                                            </asp:DropDownList>
                                                                                        </td>
                                                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtReference" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                Text="<%# mModelMonitorInsp.Reference %>" ToolTip="Enter Reference" MaxLength="500"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxMultiLine1_Ajax"
                                                                ClientIDMode="Static" Text="<%# mModelMonitorInsp.Description %>" ToolTip="Enter Description"
                                                            ...
                                                            <asp:UpdatePanel ID="upnlMonitorInspectionType" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="cmbMonitorInspType" runat="server" CssClass="clsComboBox2_Ajax"
                                                                        SelectedValue="<%# mModelMonitorInsp.ModelMonitorInspTypeID %>" DataTextField="CodeType"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtZone" runat="server" CssClass="clsTextBox_Ajax" MaxLength="50"
                                                                Text="<%# mModelMonitorInsp.Zone %>" ToolTip="Enter Zone" Width="250px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtArea" runat="server" CssClass="clsTextBox_Ajax" MaxLength="50"
                                                                Text="<%# mModelMonitorInsp.Area %>" ToolTip="Enter Area" Width="250px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="chkIsRII" runat="server" Checked="<%# mModelMonitorInsp.IsRII %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNote" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" MaxLength="1000"
                                                                ClientIDMode="Static" Width="250px" Text="<%# mModelMonitorInsp.Note %>" TextMode="MultiLine"
                                                                ToolTip="Enter Note">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="chkShowInCofA" runat="server" Checked="<%# mModelMonitorInsp.ShowInCofA %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRequiredManHours" runat="server" CssClass="clsTextBoxSmall_Ajax"
                                                                MaxLength="8" Text="<%# mModelMonitorInsp.RequiredManHours %>" ToolTip="Enter Required Man Hours">
                                                            </asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:UpdatePanel ID="upnlPeriods" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <fieldset id="fdsFrequencyofMonitorInspection" class="clsFieldSet" style="border-width: 1px;
                                                            width: auto">
                                                            <legend id="lgdFrequencyofMonitorInspection"><b>Frequency of Inspection</b></legend>
                                                            <table>
                                                                <tr>
                                                                    <td valign="top">
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Frequency">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtFrequencyValue" runat="server" CssClass="clsTextBoxRightAlignSmall_Ajax"
                                                                                            MaxLength="8" ReadOnly="<%# iif(mModelMonitorInsp.ReadOnlyFrequencyColumn=true,true,false) %>"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkTools" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                        Enabled="<%# Not mModelMonitorInsp.IsNew %>" ToolTip="Click to add Tools" Text="Tools (0 records)"></asp:LinkButton>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkSpares" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                        Enabled="<%# Not mModelMonitorInsp.IsNew %>" ToolTip="Click to add Spares" Text="Spares (0 records)"></asp:LinkButton>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td valign="middle">
                                                                        <table cellspacing="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <input id="imgTaskCard" type="image" src="images/TaskCard.png" disabled="disabled"   style="height: 22px; width: 24px"/>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkTaskCards" runat="server" CausesValidation="true" CssClass="clsLinkButton"
                                                                                        Enabled="<%# Not mModelMonitorInsp.IsNew %>" ToolTip="Click to add Task Cards"
                                    ...
                                    <asp:UpdatePanel ID="upnlLinkMaint" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:HyperLink ID="lnkLinkMaint1" onclick="PanelToggle()" runat="server" CssClass="clsHyperlink1"
                                                Visible='<%# iif(AppSettings("LinkMaintenance")="True",true,false) %>' Enabled="<%# Not mModelMonitorInsp.IsNew %>">Click to add Link Maintenance Activity</asp:HyperLink>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                                    ...
                                    <asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table id="Table1" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSaveSelect" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Save and Select Model Inspection"
                                                            Text="Save &amp; Select" Visible='<%# not Session("EditMasterRecord") = "True" %>'>
                                                        </asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnSave" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to save Model Inspection"
                                                            Text="Save"></asp:Button>
                                                    </td>
                                                      <td>
                                                        <asp:Button ID="btnSendMail" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Sendmail Model Inspection"
                                                            Text="Send Mail" CausesValidation="False"></asp:Button>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnPrint" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to print Model Inspection"
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForModelInspMaster();
            return false;
        }
    </script>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
       ...
       SetPageLayout();
       if ($.browser.msie) {
             parent.IFrameModelInspMasterStateComplete();
         }
    });
