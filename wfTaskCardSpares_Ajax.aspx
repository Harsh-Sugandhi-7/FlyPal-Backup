<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfTaskCardSpares_Ajax.aspx.vb"
    Inherits="Flypal.wfTaskCardSpares_Ajax" %>
    ...
    <form id="form1" runat="server" defaultfocus="txtItemList">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Button ID="btnOK" runat="server" CssClass="clsbtnH clsinfoH" CausesValidation="True"
                                                                        ValidationGroup="a" Text="OK" ToolTip="Click to Add Spare"></asp:Button>
                                                                </td>
                                                                <td>
                                            ...
                                            <fieldset id="fdswodetail" style="padding: 0px 4px 0px 0px; width: auto; z-index: 10000;">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%--<asp:DropDownList ID="cmbItemList" runat="server" CssClass="clsComboBox_Ajax" SelectedValue="<%# mTaskCard.TaskCardSpares.CurrentItem.ItemID %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="left">
                                                            <asp:TextBox ID="txtPartNo" runat="server" CssClass="clsTextBoxTagSearch" Text="<%# mTaskCard.TaskCardSpares.CurrentItem.PartNo %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxTagSearchMultilineNewStyleLong"
                                                                Text="<%# mTaskCard.TaskCardSpares.CurrentItem.Description %>" BackColor="White"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtReqQty" runat="server" CssClass="clsTextBoxTagSearchRightAlignQty_Ajax"
                                                                Text="<%# mTaskCard.TaskCardSpares.CurrentItem.RequiredQty %>" MaxLength="5"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtOffSerialNo" runat="server" CssClass="clsTextBoxTagSearch"
                                                                Text="<%# mTaskCard.TaskCardSpares.CurrentItem.OffSerialNo %>" BackColor="White"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtOnSerialNo" runat="server" CssClass="clsTextBoxTagSearch"
                                                                Text="<%# mTaskCard.TaskCardSpares.CurrentItem.OnSerialNo %>" BackColor="White"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxTagSearchMultilineNewStyleLong"
                                                                Text="<%# mTaskCard.TaskCardSpares.CurrentItem.Remark %>" TextMode="MultiLine"
        ...
        <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
                $(document).ready(function () {
                    SetPageLayout();
                    if ($.browser.msie) {
                        parent.IFrameTaskCardSpareStateComplete();
                    }
