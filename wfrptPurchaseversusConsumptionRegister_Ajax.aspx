<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptPurchaseversusConsumptionRegister_Ajax.aspx.vb"
    Inherits="Flypal.wfrptPurchaseversusConsumptionRegister_Ajax" %>
...
<head runat="server">
    <title>Purchase versus Consumption Register</title>
                                ...
                                <table id="tblInner" class="clstablelistin">
                                    <tr>
                                        <td class="clsFormHeader1Newstyle">
                                            <asp:Label ID="lbltitle" CssClass="clsFormHeader" runat="server">Purchase versus Consumption Register</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label2" runat="server" CssClass="clsLabelHeader">Step I. Selection of Order Type</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                ...
                                                <ContentTemplate>
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="cmbOrderType" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle" AutoPostBack="True">
                                                ...
                                                <ContentTemplate>
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtToDate" CssClass="clsTextBoxTagSearchDate" Style="margin-left: 3px;"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label1" runat="server" CssClass="clsLabelHeader">Step III. Selection of Supplier</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtSupplier" CssClass="clsTextBoxSearch_Ajax" runat="server" ></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label3" runat="server" CssClass="clsLabelHeader">Step V. Selection of Model</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtModelList" CssClass="clsTextBoxTagSearch" runat="server"  Width="275px"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblStep6" runat="server" CssClass="clsLabelHeader">Step VI. Selection of Part Number</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
