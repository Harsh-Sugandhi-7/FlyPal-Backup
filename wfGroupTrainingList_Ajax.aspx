<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfGroupTrainingList_Ajax.aspx.vb"
    Inherits="Flypal.wfGroupTrainingList_Ajax" %>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:UpdatePanel ID="upnlTitle" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:Label ID="lbltitle" CssClass="clsFormHeader" runat="server">Training List</asp:Label>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="bottom" align="right">
                                                        <asp:UpdatePanel ID="upnlClose" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:Button ID="btnBack" CssClass="clsbtnH clsinfoH" runat="server" ToolTip="Click to close Training list screen"
                                                ...
                                                <td>
                                                    <asp:GridView ID="dgTrainingList" runat="server" AllowSorting="True"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="TrainingTypeName" SortExpression="TrainingTypeName" HeaderText="Training Type" ItemStyle-Width="200px">
                                                                <HeaderStyle  HorizontalAlign="Left"></HeaderStyle>
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:ButtonField Text="Allocate" HeaderText="Allocate" CommandName="Allocate">
