<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAuditExecutionTaskFinding_Ajax.aspx.vb"
	Inherits="Flypal.wfAuditExecutionTaskFinding_Ajax" %>
...
<body bottommargin="5" leftmargin="5" topmargin="5" rightmargin="5" ms_positioning="GridLayout">
	<form id="form1" runat="server">
											...
											<asp:UpdatePanel ID="upnlActionBtn" runat="server" UpdateMode="Conditional">
												<ContentTemplate>
													<table>
														<tr>
															<td>
																<asp:Button ID="btnOk" runat="server" CssClass="clsbtnH clsinfoH" Text="Save" 
																	ToolTip="Click to Save Findings" ValidationGroup="1"></asp:Button>
															</td>
															<td>
																<asp:Button ID="btnPrint" runat="server" CssClass="clsbtnH clsinfoH" Text="Print" 
																	ToolTip="Click to Print Finding"></asp:Button>
															</td>
															<td>
																<asp:Button ID="btnBack" runat="server" CssClass="clsbtnH clsinfoH" 
																	ToolTip="Click to Close the Finding Details Screen"
						...
						<tr>
							<td>
								...
								<asp:CustomValidator ID="cvRemark" runat="server" CssClass="clslabelauto" ControlToValidate="txtRemark"
									ErrorMessage="Remark should not be greater than 500 characters." Display="None"
						...
						<tr>
							<td>
								<asp:UpdatePanel ID="upnlFindingDetails" runat="server" UpdateMode="Conditional">
									<ContentTemplate>
										<fieldset id="fdsFindingDetails" class="clsFieldSetNewStyle" style="border-width: 1px">
											...
											<table>
												<tr>
													...
													<td>
														<asp:TextBox CssClass="clsTextBoxTagSearch" ID="txtFindingNo" runat="server" ToolTip="Enter Finding No."
															MaxLength="100" BackColor="White" Text="<%# mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.FindingNo %>">
														</asp:TextBox>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<asp:TextBox CssClass="clsTextBoxTagSearchComboNewstyle" ID="txtFinding" runat="server"
													...
													<td>
														<table>
															<tr>
																...
																<td>
																	<asp:ImageButton ID="imgbtnRootCause" runat="server" ImageUrl="~/images/plus1.png"
																		Height="22px" Width="24px" ToolTip="Click to Add New Root Cause" CausesValidation="False"></asp:ImageButton>
																</td>
															</tr>
															<tr>
																<td colspan="2">
																	<asp:TextBox CssClass="clsTextBoxTagSearchMultilineNewstyle" ID="txtRootCause" runat="server"
																		Text="<%# mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.RootCause %>"
																		TextMode="MultiLine" ToolTip="Enter Root Cause"></asp:TextBox>
																</td>
															</tr>
														</table>
													</td>
												...
												<tr>
													...
													<td>
														<asp:DropDownList CssClass="clsTextBoxTagSearchComboSmall" ID="cmbPriority" runat="server" SelectedValue="<%# mAuditExecution.AuditExecutionTasks.CurrentItem.AuditExecutionTaskFindings.CurrentItem.PriorityID %>"
															DataValueField="ID" DataTextField="NameWithDays" AutoPostBack="true">
														</asp:DropDownList>
													</td>
													<td>
													...
													<td>
														<asp:DropDownList CssClass="clsTextBoxTagSearchComboSmall" ID="cmbFindingStatus" runat="server"
												...
												<tr>
													...
													<td>
														<asp:TextBox CssClass="clsTextBoxTagSearchDate" ID="txtDeadlineDate" runat="server" ClientIDMode="Static"
															onchange="ValidateDateText(this,'DeadlineDate_watermarkextender','false');"></asp:TextBox>
												...
												<tr>
													...
													<td></td>
													<td colspan="3">
														<span id="lblInfo" class="clsLabelHeader">
															Please enter valid comma separated Email ID's in To And CC.
														</span>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td>
														<asp:TextBox CssClass="clsTextBoxTagSearchDate" ID="txtCorrectionDate" runat="server" ClientIDMode="Static"
												...
												<tr>
													<td></td>
													<td>
														<span id="lblRemark" class="clsLabelAuto">Auditor's Remark</span>
													</td>
													<td>
						...
						<tr>
							<td>
								<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
									<ContentTemplate>
										<asp:Button ID="hdnimgBtnRootCause" runat="server" CausesValidation="false" ClientIDMode="Static"
		...
		<!-- RootCause Popup Window -->
		<div style="display: none">
			<asp:Button runat="server" ID="btnDummyRootCause" Text="Dummy RootCause" ClientIDMode="Static"
				CausesValidation="false" />
		</div>
		<asp:Panel runat="server" ID="pnlPopupRootCause" HorizontalAlign="Center" Style="height: 100%; width: 100%;">
			<iframe id="iPopupRootCause" frameborder="0" allowtransparency="true" height="100%"
				width="100%" src="JavaScript:''" scrolling="auto"></iframe>
		</asp:Panel>
		<cc2:ModalPopupExtender ID="mdlPopupRootCause" runat="server" TargetControlID="btnDummyRootCause"
			PopupControlID="pnlPopupRootCause" BackgroundCssClass="clsModalPopupBG">
		</cc2:ModalPopupExtender>
		<script type="text/javascript">

			function IFrameRootCauseStateComplete() {
				$("#btnDummyRootCause").click();
				$get("AjaxLoader").style.visibility = "hidden";
			}
			...
			function OpenRootCauseWindow() {
				try {
					...
					$get("AjaxLoader").style.visibility = 'visible';
					$("#iPopupRootCause").attr("src", "wfRootCause_Ajax.aspx?Type=pup");
		...
		<script type="text/javascript">
			...
			function ParentCallBackFunctionForRootCause() {

				var RootCausewindow = $find("<%=mdlPopupRootCause.ClientID %>");
				//close RootCause popup window
				RootCausewindow.hide();
				$("#iPopupRootCause").attr("src", "JavaScript:''");
				//call RootCause image button
				$("#hdnimgBtnRootCause").click();
