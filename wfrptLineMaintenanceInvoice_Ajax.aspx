<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptLineMaintenanceInvoice_Ajax.aspx.vb"
    Inherits="Flypal.wfrptLineMaintenanceInvoice_Ajax" %>
...
<html>
<head runat="server">
    <title>Service Invoice Register</title>
...
<body bottommargin="5" leftmargin="0" rightmargin="5" topmargin="5" ms_positioning="GridLayout">
            ...
            <td>
                <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td colspan="3">
                                <span id="lbltitle" class="clstitle1">Service Invoice Register</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                        ...
                        <tr>
                            <td colspan="3">
                                <span id="lblStep4" class="clsLabelHeader">Step III Selection of Invoice No.</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span id="lblOrderTextNo" class="clsLabelAuto">Invoice No.</span>
                            </td>
                            <td colspan="2">
                                <table cellspacing="0" cellpadding="0">
                                    <tr>
                                ...
                                <asp:UpdatePanel runat="server" ID="upnlSearchingCriteria" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblInvoiceNo" runat="server" CssClass="clsLabelAuto" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnCurrentSearchCriteria" runat="server" CssClass="clsButtonLong_Ajax"
                                                        TabIndex="0" Text="Current Criteria" ToolTip="Click to display Current Searching criterias" ValidationGroup="a" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnExport" runat="server" CssClass="clsButton_Ajax" TabIndex="0"
                                                        Text="Export to Excel" ToolTip="Click to Export report" Visible="False" ValidationGroup="a" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnClose" runat="server" CausesValidation="False" CssClass="clsButton_Ajax"
                                                        TabIndex="0" Text="Close" ToolTip="Click to close Service Invoice Register screen " />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
    ...
    <script type="text/javascript">
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function () {
            ...
            $("#<%=txtOrderTextList.ClientID%>").autocomplete('wfAutoInventoryList.aspx?Type=Text&TextType=20', {
                width: 185,
                autoFill: false,
                matchContains: true,
                mustMatch: true,
