<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptAssetValuation_Ajax.aspx.vb"
    Inherits="Flypal.wfrptAssetValuation_Ajax" %>
                ...
                <td>
                    <asp:Panel ID="pnlmain" CssClass="clspanel1" runat="server">
                        <table id="tblInner" class="clstablelistin">
                            <tr>
                                <td>
                                    <span id="lbltitle" class="clstitle1">Asset Valuation Analysis</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td align="right">
                                                        ...
                                                        <asp:Button ID="btnClose" TabIndex="0" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to close Asset Valuation screen"
