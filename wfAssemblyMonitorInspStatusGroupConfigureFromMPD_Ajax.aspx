<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAssemblyMonitorInspStatusGroupConfigureFromMPD_Ajax.aspx.vb"
    Inherits="Flypal.wfAssemblyMonitorInspStatusGroupConfigureFromMPD_Ajax" %>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <cc2:AutoCompleteExtender ClientIDMode="Static" ID="txtLicenceNo_Autocomplete" runat="server"
                                                                                ...
                                                                                CompletionInterval="1" ServicePath="wfAssemblyMonitorInspStatusGroupConfigureFromMPD_Ajax.aspx"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtRemark" runat="server" CssClass="clsTextBoxMultiLine1_Ajax" Width="250px"
                                                            ToolTip="Enter the Remark for the Assembly Inspection Status" MaxLength="500"
                                                            TextMode="MultiLine">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
