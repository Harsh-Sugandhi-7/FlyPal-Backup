<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptDateSearchCriteria_Ajax.aspx.vb" Inherits="Flypal.wfrptDateSearchCriteria_Ajax" %>
                    ...
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td class="clsFormHeader1">
                                <span id="lbltitle" class="clsFormHeader">Day Book</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                                ...
                                <asp:UpdatePanel runat="server" ID="upnlActionBtns" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table cellspacing="0">
                                            <tr>
                                                <td>
                                                   <asp:Button id="btnDisplay" runat="server" CssClass="clsbtnH" Text="Display" ToolTip="Click to display report"></asp:Button>
                                                </td>
                                                <td>
                                                    <asp:button id="btnCloseTop" runat="server" CssClass="clsbtnH" Text="Close" ToolTip="Click to Close Day Book screen"
