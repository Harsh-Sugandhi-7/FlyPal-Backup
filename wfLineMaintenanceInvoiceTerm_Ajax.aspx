<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfLineMaintenanceInvoiceTerm_Ajax.aspx.vb"
    Inherits="Flypal.wfLineMaintenanceInvoiceTerm_Ajax" %>
...
<html>
<head runat="server">
    <title>Service Invoice Terms</title>
                    ...
                    <td>
                        <asp:Panel ID="pnlMain" runat="server" CssClass="clsPanel1">
                            <table class="clstablelistin" id="tblLedgerList">
                                <tr>
                                    <td class="clsFormHeader1Newstyle">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <span id="lblListOrder" class="clsFormHeader">List of Service Invoice Terms</span>
                                                </td>
                                                <td align="right">
                                                    <table align="right">
                                                        <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:UpdatePanel runat="server" ID="upnlLineMaintInvTermDetails" UpdateMode="Conditional">
                                            <ContentTemplate>
            ...
            $(document).ready(function () {
                $("#imgbtnTerm").live("click", function () {
                    try {
                        ...
                        $("#iPopupTerm").attr("src", "wfTerm_Ajax.aspx?Type=pup&OpenFrom=8");
                        if (!$.browser.msie) {
                            $("#btnDummyTerm").click();
                            //                        $get("AjaxLoader").style.visibility = "hidden";
                        }
...
<script type="text/javascript">
    function CallParentCallback() {
        parent.ParentCallBackFunctionForLineMaintenanceInvoiceTerm();
        return false;
    }
</script>
<%--End--%>
