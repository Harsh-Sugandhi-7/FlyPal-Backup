<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCopyInspections_Ajax.aspx.vb"
	Inherits="Flypal.wfCopyInspections_Ajax" %>
				...
				<tr>
					<td>
						<asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
							<asp:UpdatePanel ID="upnlCopyInspections" runat="server" UpdateMode="Conditional">
								<ContentTemplate>
									<table class="clstablelistin" id="tblInner">
										<tr>
											<td colspan="6" class="clsFormHeader1Newstyle">
												<table width="100%">
													<tr>
														<td>
															<asp:Label ID="lblTitle" TabIndex="1" CssClass="clsFormHeader" runat="server">Copy Inspections</asp:Label>
														</td>
														<td align="right">
										...
										<tr>
											<td colspan="5">
												<asp:Label ID="Label1" runat="server" CssClass="clsLabelHeader">Copy Inspection Details</asp:Label>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											...
											<td>
												<asp:DropDownList ID="cmbSourceModel" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle"
													AutoPostBack="true" DataValueField="ID" DataTextField="ModelName">
												</asp:DropDownList>
											</td>
											<td>
										...
										<tr>
											<td></td>
											<td>
												<asp:Label ID="lblInspectionType" runat="server" CssClass="clsLabelAuto">Inspection Type</asp:Label>
											</td>
											<td colspan="4">
												<asp:DropDownList ID="cmbInspectionType" runat="server" CssClass="clsTextBoxTagSearchComboNewstyleLong" AutoPostBack="true"
										...
										<tr>
											<td colspan="6">
												<asp:Label ID="Label4" runat="server" CssClass="clsLabelHeader">List of Duplicate Inspections</asp:Label>
											</td>
										</tr>
										<tr>
											<td colspan="6">
										...
										<tr>
											<td colspan="3">
												<asp:Label ID="lblModelInspList" runat="server" CssClass="clsLabelHeader"></asp:Label>
											</td>
										</tr>
										<tr>
											<td colspan="6">
												<asp:GridView ID="dgModelInspList" runat="server" AutoGenerateColumns="False"
											...
											<td align="right" colspan="6">
												<table>
													<tr>
														...
														<td>
															<asp:Button ID="btnCopy" runat="server" CssClass="clsbtnH clsinfoH" Text="Copy" ToolTip="Click to Copy"
																Enabled="<%# cmbAssemblyType.SelectedIndex %>" Visible="False"></asp:Button>
														</td>
														<td>
															<asp:Button ID="btnClose" runat="server" CssClass="clsbtnH clsinfoH" Text="Close" ToolTip="Click to go back to the previous page"
