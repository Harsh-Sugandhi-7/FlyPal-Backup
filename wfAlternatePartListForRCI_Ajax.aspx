<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfAlternatePartListForRCI_Ajax.aspx.vb"
    Inherits="Flypal.wfAlternatePartListForRCI_Ajax" %>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="upnlAlternatePartList" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView ID="dgAlternatePartList" runat="server" CssClass="clsGridNewStyle" AllowPaging="True"
                                                EnableViewState="False" AutoGenerateColumns="False" AllowSorting="False" ShowHeaderWhenEmpty="True" PageSize="15" CellPadding="5"
