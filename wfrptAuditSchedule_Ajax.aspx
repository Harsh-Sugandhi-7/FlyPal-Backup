<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrptAuditSchedule_Ajax.aspx.vb"
    Inherits="Flypal.wfrptAuditSchedule_Ajax" %>
                                        ...
                                        <asp:UpdatePanel ID="upnlDetail" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table id="tblLedgerList" class="clstablelistin">
                                                    <tr>
                                                        ...
                                                        <td colspan="2" class="clsFormHeader1">
                                                            <table width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <span id="lblAuditScheduleList" class="clsFormHeader">Audit Schedule Report</span>
                                                                    </td>
                                                                    <%--<td align="right">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <table class="clstableButton" align="right">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:Button ID="btnDisplay" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to display Report "
                                                                                                Text="Display"></asp:Button>
                                                                                        </td>
                                                                                        <td align="right">
                                                                                            <asp:Button ID="btnClose" runat="server" CssClass="clsbtnH clsinfoH" ToolTip="Click to close Audit Schedule screen"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblAsOnDate" runat="server" CssClass="clsLabelAuto" Width="66px">As On Date</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtAsOnDate" CssClass="clsTextBoxTagDateSearch" ClientIDMode="Static"
                                                                AutoPostBack="true" runat="server" onchange="ValidateDateText(this,'AsOnDate_watermarkextender');"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbAuditNo" runat="server"   DataTextField="AuditNo"
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="Label2" runat="server" CssClass="clsLabelHeader">Step III. Selection of Audit Type</asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="clsTextBoxTagSearchComboNewstyle" ID="cmbAuditType" runat="server"   DataTextField="Name"
                                                                DataValueField="ID">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                            ...
                                                            <ContentTemplate>
                                                                <table class="clstableButton" align="right">
                                                                    <tr>
                                                                        ...
                                                                        <td align="right">
                                                                            <asp:Button ID="btnClose" runat="server" CssClass="clsbtnH" ToolTip="Click to close Audit Schedule screen"
                                                                                Text="Close"></asp:Button>
                                                                        </td>
                                                                    </tr>
                                                                </table>
