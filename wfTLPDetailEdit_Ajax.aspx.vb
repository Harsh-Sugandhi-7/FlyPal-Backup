...
Imports System.Linq
Partial Class wfTLPDetailEdit_Ajax
...
#Region "Business Methods"
    ...
    Private Sub EnableDisableButton(Optional ByVal IsLastTLPDetail As Boolean = True)
        ...
        'Commented on 16-Mar-2022
        Place1.ReadOnly = IIf((Session("LogDetailEdit") = "True"), True, False)
        Place2.ReadOnly = IIf((Session("LogDetailEdit") = "True"), True, False)

        Place1.BackColor = IIf((Session("LogDetailEdit") = "True"), Color.Gainsboro, Color.White)
        Place2.BackColor = IIf((Session("LogDetailEdit") = "True"), Color.Gainsboro, Color.White)
        '-------------
        ...
        'Time Boxes
        '--Commented on 16-Feb-2022
        '--Uncommented by Saylee on 22-Apr-2022
    ...
    Private Sub ControlVisibility(Optional ByVal IsLastTLPDetail As Boolean = True)
        ...
        btnAdd.Enabled = IIf((Not mLogDetail.IsNew Or Session("LogDetailEdit") = True) And IsLastTLPDetail = False, False, True) 'IIf(((mLogDetail.IsNew Or (Session("LogDetailEdit") = "True" And IsLastTLPDetail = True And mIsLastLog = True))), True, False)
    ...
    End Sub
    Private Function SetLogObject() As Boolean
        If Not mLog.LogDetails.Count = 0 Then
            ...
            mLog.RemarkEdit = "<NewRemark><Update> Update Due to Log Edit</Update><UserName>" + User.Identity.Name + "</UserName><LogDet>" + mLog.LogTextNo + "</LogDet><UpdateDateTime>" + New SmartDate(Now.ToString("yyyy/MM/dd HH:mm")).FormattedTextTime + "</UpdateDateTime></NewRemark>"
            mLog.IsLogEdited = True
            '*************************
            If Not mLog.IsNew Then
                Try
                    mLog = CType(mLog.Save(), Log)
    ...
    Private Function IsLogValid() As Boolean
        ...
        If mLog.LastLogExist Then
            ...
            If mLog.LogDetails.Count = 0 Then
                'Both Dates required
                If (Not mPrevLogDetail.DesUniverseDateTime Is System.DBNull.Value) And (Not mLogDetail.SouUniverseDateTime Is System.DBNull.Value) Then
            ...
            Else 'Log Detail Child already exists
                ...
                If (Not mLogDetail.DesUniverseDateTime Is System.DBNull.Value) And (Not mLogDetail.SouUniverseDateTime Is System.DBNull.Value) Then
    ...
    Private Sub addAttributes()
        ...
        txtPax.Attributes.Add("onKeyPress", "validateText(('D'),document.getElementById('txtLogPageNo').value,event)")
...
#Region "Data Binding"
    ...
    Private Sub DataFieldBind()
        ...
        If Not mLogDetail.SouLocalDateTime Is System.DBNull.Value Then
        ...
        If Not mLogDetail.DesLocalDateTime Is System.DBNull.Value Then
        ...
        If Not mLogDetail.SouUniverseDateTime Is System.DBNull.Value Then
        ...
        If Not mLogDetail.DesUniverseDateTime Is System.DBNull.Value Then
        ...
        If Not mLogDetail.TakeOffLocalDateTime Is System.DBNull.Value Then
        ...
        If Not mLogDetail.TakeOffUniverseDateTime Is System.DBNull.Value Then
        ...
        If Not mLogDetail.TouchDownLocalDateTime Is System.DBNull.Value Then
        ...
        If Not mLogDetail.TouchDownUniverseDateTime Is System.DBNull.Value Then
...
#Region "Events"
    ...
    Protected Sub btnAddPlaces_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnAddPlaces.Click
        SetObject()
        Response.Redirect("wfPlace_Ajax.aspx?BackPage=" & Request.QueryString("BackPage") & "&BackPage1=wfTLPDetailEdit_Ajax.aspx")
    End Sub
    Private Sub btnBack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBack.Click
        If Not CustomValidatePFIDoneBy() Then
            ...
            Exit Sub
        End If
        If mLogDetail.IsDirty And mLog.IsLogEdited = False Then
    ...
    Private Sub dgLogDetails_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgLogDetails.ItemCommand
        ...
        End Select
    End Sub
    Private Sub dgLogDetails_SortCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridSortCommandEventArgs) Handles dgLogDetails.SortCommand
