<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfHSNACSRenew_Ajax.aspx.vb"
    Inherits="Flypal.wfHSNACSRenew_Ajax" %>
...
<body>
                        ...
                        <tr>
                            <td>
                                <asp:UpdatePanel runat="server" ID="upnlTitle" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Label ID="lblTitle" runat="server" CssClass="clstitle1">HSN/ACS</asp:Label>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                                ...
                                <asp:UpdatePanel runat="server" ID="upnlHSNACSInformation" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <fieldset class="clsFieldSet" style="border-width: 1px">
                                            <legend><b>HSN/ACS Information</b></legend>
                                            <table>
                                                <tr>
                                                    <td>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCode" runat="server" CssClass="clsTextBox_Ajax" BackColor="#E0E0E0"
                                                            ReadOnly="True" Text="<%# mHSNACS.Code %>" ToolTip="Code" MaxLength="50"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxMultilineTask_Ajax"
                                                            BackColor="#E0E0E0" ReadOnly="True" ToolTip="Description" TextMode="MultiLine"
                                                            Text="<%# mHSNACS.Description %>" Width="500px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPercentage" runat="server" CssClass="clsTextBoxRightAlign1_Ajax"
                                                            MaxLength="4" ToolTip="Enter Percentage" Width="150px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForHSNACSRenew();
            return false;
        }
    </script>
    <%--End--%>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
       ...
       SetPageLayout();
       if ($.browser.msie) {
             parent.IFrameHSNACSRenewStateComplete();
       }
    });
