Public Class wfFlypalVideoHelpInGridView
...
#Region "Events"
    ...
    '            Dim mVideoPath As String = CType(e.CommandSource, System.Web.UI.WebControls.GridView).DataKeys(CInt(e.CommandArgument)).Values("VideoPath").ToString
    '            Vediosource.Attributes.Add("src", mVideoPath)
    '            upnlVideo.Update()
    '    End Select
    'End Sub
