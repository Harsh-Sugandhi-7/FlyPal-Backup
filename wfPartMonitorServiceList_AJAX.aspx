<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfPartMonitorServiceList_AJAX.aspx.vb"
    Inherits="Flypal.wfPartMonitorServiceList_AJAX" %>
...
<body bottommargin="5" leftmargin="5" topmargin="5" rightmargin="5" ms_positioning="GridLayout">
            ...
            <td>
                <asp:Panel ID="pnlMain" CssClass="clsPanel1" runat="server">
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td>
                                <asp:Label ID="lblList" runat="server" CssClass="clstitle1">Part Service List</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                                <asp:UpdatePanel ID="upnlActionBtnTop" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnAddNewTop" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Add New"
                                        ...
                                        <td align="left">
                                            <asp:UpdatePanel ID="upnldgGrid" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:GridView ID="dgPartMonitorService" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Show In C of A" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"
                                                            ...
                                                            <asp:BoundField DataField="RequiredManHours" HeaderText="Estd. Man Hours" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"></asp:BoundField >
                                            ...
                                            <asp:UpdatePanel ID="upnlButtons" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <table cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="btnAddNew" runat="server" CssClass="clsButton_Ajax" ToolTip="Click to Add New"
                                                                    CausesValidation="False" Text="Add New"></asp:Button>
                                                            </td>
                                                            <td>
    ...
    <script type="text/javascript">
        function CallParentCallback() {
            parent.ParentCallBackFunctionForSeriviceMasterList();
            return false;
        }
    </script>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
       ...
       SetPageLayout();
       if ($.browser.msie) {
             parent.IFrameSeriviceMasterListStateComplete();
         }
    });
