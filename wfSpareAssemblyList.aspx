<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfSpareAssemblyList.aspx.vb"
    Inherits="Flypal.wfSpareAssemblyList" %>
            ...
            <td>
                <asp:Panel ID="pnlmain" runat="server" CssClass="clspanel1">
                    <table id="tblInner" class="clstablelistin">
                        <tr>
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <span id="lbltitle" class="clstitle1">Assembly Building</span>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:DropDownList ID="cmbAssembly" runat="server" CssClass="clsComboBox_Ajax"
                                                                                    AutoPostBack="true" DataValueField="AssemblyID" DataTextField="ModelSerialNo">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                        ...
                        <tr>
                            <td align="right">
                                <asp:UpdatePanel ID="upnlAddBuiltSpareAssembly" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <table id="Table3">
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnAdd" runat="server" CssClass="clsButtonLong_Ajax" TabIndex="0" Text="Build Stock Assembly"
                                                        ToolTip="Click to Build Stock Assembly" />
                                                </td>
                                            </tr>
                                        </table>
                                        <%--</fieldset>--%>
                                                    ...
                                                    <asp:GridView ID="dgBuiltSpareList" runat="server" AllowSorting="True" CssClass="clsGrid"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="EditRec" runat="server" CommandArgument='<%# Eval("AssemblyStatusID") %>'
                                                            ...
                                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Delete" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="Delete" runat="server" CommandArgument='<%# Eval("AssemblyStatusID") %>' CommandName="DeleteRec"
