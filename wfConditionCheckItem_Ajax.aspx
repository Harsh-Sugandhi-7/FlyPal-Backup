<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfConditionCheckItem_Ajax.aspx.vb"
    Inherits="Flypal.wfConditionCheckItem_Ajax" %>
...
<body>
                                ...
                                <asp:UpdatePanel runat="server" ID="upnlValidations" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="clslabelAuto"
                                            ValidationGroup="1" Display="None" ErrorMessage="Part No. Required" ControlToValidate="txtPart"></asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="rfvSerialNo" runat="server" CssClass="clslabelAuto"
                                            ValidationGroup="1" Display="None" ErrorMessage="Serial No. Required" ControlToValidate="txtSerialNo"></asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="cvFromDate" runat="server" CssClass="clsLabelAuto" Display="None"
                                            ClientValidationFunction="BetweenDatesValidation" ValidationGroup="1" ErrorMessage="Scrap Date should be greater than Manufacturing Date "></asp:CustomValidator>
                                        ...
                                        <asp:CustomValidator ID="cvAssembly" runat="server" ControlToValidate="txtPart" ValidationGroup="1"
                                            ValidateEmptyText="true" Display="None" ErrorMessage="Please select the Model"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="cmbItemList" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle" AutoPostBack="true"
                                                            DataTextField="Name" DataValueField="ID" SelectedValue="<%# mConditionCheckItem.ItemID %>">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="cmbSerialNo" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle" SelectedValue="<%# mConditionCheckItem.ReceiptItemID %>"
                                                            DataValueField="ReceiptItemID" DataTextField="SerialNo" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="clsTextBoxSearch_Ajax" ReadOnly="True"
                                                            BackColor="#E0E0E0" ToolTip="Item Description" Text="<%# mConditionCheckItem.Description %>"
                                                            ></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtLocation" runat="server" CssClass="clsTextBoxTagSearch" ReadOnly="True"
                                                            BackColor="#E0E0E0" ToolTip="Item Location" Text="<%# mConditionCheckItem.Location %>"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span id="lblConditionCheckServicedInspected" class="clsLabelAuto" runat="server" Visible="false">Condition Check/Serviced
                                                            Inspected</span>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtConditionCheckServicedInspected" runat="server" CssClass="clsTextBox_Ajax"
                                                            ReadOnly="True" BackColor="#E0E0E0" Text="<%# mConditionCheckItem.ConditionCheckServicedInspected %>" Visible="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <span   class="clsLabelStar" runat="server" id="lblListOfItemServiceInspectionsStar">*</span>
                                                    </td>
                                                    <td>
                                                        <span   class="clsLabelAuto" runat="server" id="lblListOfItemServiceInspections">Service Inspections</span>
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="cmbListOfItemServiceInspections" runat="server" CssClass="clsTextBoxTagSearchComboNewstyle"
                                                            SelectedValue="<%# mConditionCheckItem.ItemServiceInspectionsID %>" DataValueField="ID"
                                                            DataTextField="ServiceInspectionName" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtFrequency" runat="server" CssClass="clsTextBoxTagSearchSmall"
                                                            Text="<%# mConditionCheckItem.Frequency %>" ToolTip="Item Interval" AutoPostBack="True"
                                                            Width="40px" BackColor="#E0E0E0" ReadOnly="True">
                                                        </asp:TextBox>
                                                        <asp:Label ID="lblMonths" runat="server" CssClass="clsLabel" Text="<%# mConditionCheckItem.ConditionCheckItemInterval %>"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <cc2:CalendarExtender ID="CalendarExtender2" runat="server" CssClass="cal_Theme1"
                                                            Enabled="True" Format="<%$AppSettings:DateFormat%>" TargetControlID="txtNextDueDate">
                                                        </cc2:CalendarExtender>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCertRef" runat="server" CssClass="clsTextBoxSearch_Ajax" MaxLength="100"
                                                             Text="<%# mConditionCheckItemChild.CertificateReference %>" ToolTip="Enter Certificate Reference"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
    ...
    <% Dim mopen As String = Request.QueryString("Type") %>
     <% If Not mopen Is Nothing AndAlso mopen = "pup" Then %>  
       ...
       SetPageLayout();
       if ($.browser.msie) {
             parent.IFrameConditionCheckItemStateComplete();
       }
    });
