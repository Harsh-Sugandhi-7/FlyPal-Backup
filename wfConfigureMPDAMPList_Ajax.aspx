<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfConfigureMPDAMPList_Ajax.aspx.vb" Inherits="Flypal.wfConfigureMPDAMPList_Ajax" %>
...
<body leftmargin="0" rightmargin="0">
                                                    ...
                                                    <td>
                                                        <table id="Table1" width="100%">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtMPDNo" runat="server" CssClass="clsTextBoxTagSearch" ToolTip="Enter Task No. to search"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span id="lblMonitorType" runat="server" class="clsLabelAuto">Service Type</span>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtFrequency" runat="server" CssClass="clsTextBoxTagSearch" ToolTip="Enter Frequency. to search"
                                                                        AutoPostBack="true" Width="175px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                            ...
                                                                            <asp:UpdatePanel ID="upnlNonConfig" runat="server" UpdateMode="Conditional">
                                                                                <ContentTemplate>
                                                                                    <table id="Table2" border="0" class="clstablelistin">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="2">
                                                                                                <asp:GridView ID="dgNonConfigList" runat="server" CssClass="clsGridNewStyle" GridLines="Horizontal" CellPadding="5" AutoGenerateColumns="False" ClientIDMode="Static"
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:GridView ID="dgConfigList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:BoundField DataField="ModelMonitorServiceCode_Desc" HeaderText="Code/Form No./Description" SortExpression="ModelMonitorServiceCode_Desc"
                                                                                                            HtmlEncode="false">
                                                                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" />
                                                                                                        </asp:BoundField>
                                                                                                        <asp:BoundField DataField="ServiceTypeCode" HeaderText="Task Type" SortExpression="ServiceTypeCode">
                                                                                                            <HeaderStyle ForeColor="Black" HorizontalAlign="Left" />
                                                                                                        </asp:BoundField>
    ...
    <script type="text/javascript">
        function CallParentFunction() {
            window.parent.autoResizeMPDAMPList();
        }
    ...
    <script type="text/javascript" language="javascript">
        function CallParentFunctionForIntTab() {
            window.parent.autoResizeListMPDAMP();
        }
